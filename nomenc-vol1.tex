...
\multicolumn{4}{c}{\nomencsubsectionname{Generic poset names}}\\ 
 ...
 $a \join b$ &  Join of two elements $a$, $b$ & $\to$\cref{def:lattice} & \pageref{def:lattice}\\ 
 $a \meet b$ &  Meet of two elements $a$, $b$ & $\to$\cref{def:lattice} & \pageref{def:lattice}\\ 
 \multicolumn{4}{c}{\nomencsubsectionname{Constructors}}\\ 
...
\multicolumn{4}{c}{\nomencsubsectionname{Basic}}\\ 
 ...
 $\fthen$ &  Composition for functors &  & \\ 
...
\multicolumn{4}{c}{\nomencsubsectionname{Formalization}}\\ 
 ...
 $\funa \adjunction \funb$ &  $\funa$ and $\funb$ are adjoint functors. & $\to$\cref{def:cat-adjunction-v1} & \pageref{def:cat-adjunction-v1}\\ 
 $\dprob$ &  &  & \\ 
 $\dpseries$ &  &  & \\ 
 $\dppar$ &  &  & \\ 
 $\dploop$ &  &  & \\ 
