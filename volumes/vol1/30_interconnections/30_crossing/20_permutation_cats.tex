...
\begin{proof}
    ...
    Then, in general permuting after the stacking of $\funa_1 \mtimescat \funa_2$ is not equal to applying the permutation before the stacking of $\funa_2 \mtimescat \funa_1$.
