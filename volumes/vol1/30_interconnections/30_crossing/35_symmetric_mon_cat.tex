...
\begin{remark}
    In the presence of the symmetry condition \cref{eq:braiding-symmetry}, the two hexagon identities are actually redundant and only one of them is needed. However, if one drops the condition \cref{eq:braiding-symmetry}, then the above (with both hexagon identities) gives the definition of a \emph{braided monoidal category}. 
\end{remark}
