...
\begin{example}
The cartesian product of sets and functions defines a stacking operation on the category $\Set$.
\end{example}

\begin{example}
The sum of sets and functions defines a stacking operation on the category $\Set$. 
\end{example}
