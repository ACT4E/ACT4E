...
\begin{example}
The following defines a stacking operation for the category \LTI of LTI systems. On objects the stacking is just addition on the natural numbers (which represent dimensions of input and output spaces):
