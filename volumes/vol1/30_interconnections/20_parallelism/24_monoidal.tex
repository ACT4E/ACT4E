...
\section{Monoidal stacking categories}\label{sec:moinoidal-stacking}
...
\begin{ctdefinition}[Strict monoidal stacking category]
    ...
    A \maindef{strict monoidal stacking category} is a \SY{stacking category} $\tup{\CatC, \mtimescatob, \mtimescatmor}$ with
