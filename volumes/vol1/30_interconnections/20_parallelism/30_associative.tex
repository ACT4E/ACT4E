...
\subsection{The \SY{category} \Effects}

We now construct a non-trivial \SY{category} that will serve as an example of a stacking \SY{category} that is associative but, as we will show later, is not functorial.
