...
There is a concept of ``duality'' for objects in a \SY{monoidal category} which we will introduce with an illustrative example.
...
\begin{ctdefinition}[Dual object]
    ...
    \begin{enumerate}
        \item
              ...
              \end{equation}
        \item
              \begin{equation}\label{eq:snake-eq-2}
