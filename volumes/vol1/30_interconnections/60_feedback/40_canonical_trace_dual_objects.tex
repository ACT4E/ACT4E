...
With these symbols added to string diagrams, we will be able to `build' a trace in a canonical way from smaller building blocks:
...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}[scale=0.7, every node/.style={transform shape},
        ...
        % --- Right-hand side: the canonical construction ---

        % Shaded boxes (drawn first, behind everything)
        % Consistent coordinates:
        %   top row (id_X, id_Y): y = 0.3 to 0.75
        %   middle row (coev, f, braiding, eval): y = -0.6 to 0.2 for top; full: -0.6 to -2.2
        %   bottom row (id Z-dual): y = -2.2 to -1.75
        %
        % 1) id_X — aligned with coev (x: 5.8 to 7.0)
        \fill[graphcolor, rounded corners=1pt] (5.8,0.3) rectangle (7.0,0.75);
        \draw[graphcolorbord, dashed, thin, rounded corners=1pt] (5.8,0.3) rectangle (7.0,0.75);
        % 2) Coevaluation (x: 5.8 to 7.0)
        \fill[graphcolor, rounded corners=1pt] (5.8,-2.2) rectangle (7.0,-0.6);
        \draw[graphcolorbord, dashed, thin, rounded corners=1pt] (5.8,-2.2) rectangle (7.0,-0.6);
        % 3) f box shading — extended for breathing room (x: 7.4 to 9.4)
        \fill[graphcolor, rounded corners=1pt] (7.4,-1.2) rectangle (9.4,1.0);
        \draw[graphcolorbord, dashed, thin, rounded corners=1pt] (7.4,-1.2) rectangle (9.4,1.0);
        % 4) id Z-dual — aligned with f (x: 7.4 to 9.4)
        \fill[graphcolor, rounded corners=1pt] (7.4,-2.2) rectangle (9.4,-1.75);
        \draw[graphcolorbord, dashed, thin, rounded corners=1pt] (7.4,-2.2) rectangle (9.4,-1.75);
        % 5) Braiding (x: 10.0 to 11.2) — same top/bottom as coev and eval
        \fill[graphcolor, rounded corners=1pt] (10.0,-2.2) rectangle (11.2,-0.6);
        \draw[graphcolorbord, dashed, thin, rounded corners=1pt] (10.0,-2.2) rectangle (11.2,-0.6);
        % 6) Evaluation (x: 11.3 to 12.5) — same top/bottom as coev and braiding
        \fill[graphcolor, rounded corners=1pt] (11.3,-2.2) rectangle (12.5,-0.6);
        \draw[graphcolorbord, dashed, thin, rounded corners=1pt] (11.3,-2.2) rectangle (12.5,-0.6);
        % 7) id_Y — spans braiding to evaluation (x: 10.0 to 12.5)
        \fill[graphcolor, rounded corners=1pt] (10.0,0.3) rectangle (12.5,0.75);
        \draw[graphcolorbord, dashed, thin, rounded corners=1pt] (10.0,0.3) rectangle (12.5,0.75);

        % X wire straight through
        \draw[wire] (5.8, 0.5) -- (7.6, 0.5);
        \draw[wire] (9.2, 0.5) -- (13.5, 0.5);
        \node[wirelabel, above] at (6.1, 0.5) {$\Obja$};
        \node[wirelabel, above] at (13.2, 0.5) {$\Objb$};

        % Coevaluation C-shape
        \draw[wire] (6.3, -0.85) -- (7.6, -0.85);
        \draw[wire] (6.3, -0.85) -- (6.3, -1.9);
        \draw[wire] (6.3, -1.9) -- (10.0, -1.9);
        \node[wirelabel, left] at (6.2, -1.5) {\scriptsize coev};

        % Morphism box f
        \node[morbox] (fR) at (8.4, 0) {};
        \node[morphisms, font=\itshape] at (8.4,0) {$f$};

        % Z labels near f
        \node[wirelabel] at (7.3, -0.75) {$\Objc$};
        \node[wirelabel] at (9.5, -0.75) {$\Objc$};

        % Z out of f to braiding
        \draw[wire] (9.2, -0.85) -- (10.0, -0.85);

        % Braiding: straight X-crossing, no gap (symmetric case)
        \draw[wire] (10.0, -0.85) -- (11.2, -1.9);
        \draw[wire] (10.0, -1.9) -- (11.2, -0.85);

        % Evaluation reversed-C
        \draw[wire] (11.2, -0.85) -- (11.9, -0.85);
        \draw[wire] (11.9, -0.85) -- (11.9, -1.9);
        \draw[wire] (11.2, -1.9) -- (11.9, -1.9);
        \node[wirelabel, right] at (12.0, -1.5) {\scriptsize ev};
