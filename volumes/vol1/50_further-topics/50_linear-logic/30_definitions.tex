...
\begin{ctdefinition}[Polycategory]
    ...
    \condit
    \begin{enumerate}
        \item \emph{Associativity:} for any triple of morphisms $\mora,\morb,\morc$ where
              \begin{equation}
        ...
        \item \emph{Partial commutativity}:
              For any triple of morphisms $\mora,\morb,\morc$ where
              \begin{equation}
              ...
              Symmetrically, for any triple of morphisms $\mora,\morb,\morc$ where
              \begin{equation}
