...
\todotextjira{420}{@J: Seems like that here string diagrams would help.}
...
Let $\{e_1, \dots , e_n \}$ be a basis of $\styleobj{V}$, and let $\{e_1^*, \dots, e_n^* \}$ be the corresponding dual basis of $\styleobj{V}^*$.
Then
\begin{equation}
