...
The coevaluation map $\coev_\styleobj{V} $ associated to $\styleobj{V} $ is slightly trickier to describe. Let $\{e_1, ...., e_n \}$ be a basis of $\vecspB$, and let $\{e_1^*, ...., e_n^* \}$ be the corresponding dual basis of $\vecspB^*$. Then
