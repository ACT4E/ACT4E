...
\begin{marginfigure}
    ...
    \subfloat[\label{fig:effects1}
        A morphism $\mora: \Obja \mto_{\Effects} \Objb$ in \Effects.]{
        \includegraphics[width=4.5cm]{effects1}
    }\\
    \subfloat[\label{fig:effects2} Its representation in \SetL as a morphism 
...
\begin{marginfigure}
    ...
    \subfloat[\label{fig:effects3b} Its representation in \SetStar.]{
...
\begin{ctdefinition}[Functorial stacking semi-category]
...
\begin{figure*}[b]
    \centering
    \subfloat[\label{fig:effects8}$(\mora \mtimescat \morb )
            \mthen (\morc \mtimescat \mord )$]{
...
\begin{ctdefinition}
    ...
    Let $\Obja = \{\Obja_i\}_{i=1}^n$ and 
    $\Objb = \{\Objb_i\}_{i=1}^n$ be sequences of $n$ objects.
    Let
    $\stylemorph{F} = \{\mora_i : \Obja_i \mto  \Objb_i   \}_{i=1}^n$ be a sequence of $n$ morphisms.
    ...
    and that it holds 
    \begin{equation}
        \stylemorph{S}_{\perm_1 \perm_2}^{\Obja}
        = 
        \stylemorph{S}_{\perm_1}^{\Obja}
        \stylemorph{S}_{\perm_2}^{\perm_1 \Obja} .
    \end{equation}
    Then we ask that 
    \begin{equation}
        \mtimescat \stylemorph{F}  =  
        \stylemorph{S}^{\perm\Obja}_{\perm^{-1}}
        \mthen
         (\mtimescat 
            \perm \stylemorph{F} ) 
        \mthen
            \stylemorph{S}^{\Objb}_{\perm}.
    \end{equation}
...
\todographics{Add figure for this lemma, in the same style as \cref{fig:effects-not-functorial} }