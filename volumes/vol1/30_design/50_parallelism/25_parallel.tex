...
\begin{ctdefinition}[Symmetric stacking category]
    ...
    Let $\Obja = \makeset{\Obja_i}_{i=1}^n$ and $\Objb = \makeset{\Objb_i}_{i=1}^n$ be sequences of $n$ objects.
    Let $\stylemorph{F} = \makeset{\mora_i : \Obja_i \mto  \Objb_i   }_{i=1}^n$ be a sequence of $n$ morphisms.
    Let $\mtimescat \stylemorph{F}: \Obja \mto \Objb$ denote the stacking of the morphisms.
    Let $\perm\setin\Perms(n)$ be any permutation of $n$ elements.
