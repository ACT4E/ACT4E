...
\begin{ctdefinition}[\iindex{Symmetric monoidal poset}]
    ...
    A \emph{symmetric monoidal poset} is a monoidal poset~$\tup{\posA, \posAleq, \mtimescat, \idmoncat}$ such that, for all~$\posela, \poselb \in \posA$,
    \begin{equation}
...
\todojira{188}{Review/revisit example..}
\begin{example}
    \label{ex:robot}
