...
\begin{proof}
  ...
  \begin{equation}
    \begin{aligned}
      ...
      &=\left( \F{a_1}\posleq_A \R{a_2}\right)\wedge \left( \F{b_1}\posleq_B \R{b_2}\right)\\
...
\begin{proof}
  ...
  \begin{compactitem}
    ...
    \begin{equation}
      \leftunitor_A\left( \disunionA{\F{a_1}}^*,\R{a_2}\right)\definedas \F{a_1}\posleq_A \R{a_2}.
    \end{equation}
    ...
    \begin{equation}
      \begin{aligned}
        ...
        &= \bigvee_{\disunionA{a}\in  \{1\}\times A}(\F{a_1}\posleq \R{a}) \wedge \F{a}\posleq \R{a_2}\\
        &=\F{a_1}\posleq \R{a_2}\\
        &=\id_A(\tup{\F{a_1}^*,\R{a_2}}).
      \end{aligned}
    \end{equation}
    ...
    \begin{equation}
      \rightunitor\left( \tup{\F{a_1},1}^*,\R{a_2}\right)\definedas \F{a_1}\posleq_A \R{a_2}.
    \end{equation}
    ...
    \begin{equation}
      \associator_{A,B,C}(\tup{\tup{\F{a_1},\F{b_1}},\F{c_1}}^*,\tup{\R{a_2},\tup{\R{b_2},\R{c_2}}})\definedas (\F{a_1}\posleq_A \R{a_2}) \wedge (\F{b_1} \posleq_B \R{b_2})\wedge (\F{c_1}\posleq_C \R{c_2}).
    \end{equation}
    ...
    \begin{equation}
      \begin{aligned}
        ...
        &=\bigvee_{\tup{\tup{a,b},c}\in (A\times B)\times C}\left( (\F{a_1}\posleq \R{a}) \wedge (\F{b_1}\leq \R{b}) \wedge (\F{c_1}\posleq \R{c})\right)\wedge \\
...
\begin{lemma}
  ...
  \begin{equation}
    \sigma_{A,B}(\tup{\F{a_1},\F{b_1}}^*,\tup{\R{b_2},\R{a_2}})\definedas \left(\F{a_1}\posleq_A \R{a_2}\right)\wedge \left(\F{b_1}\posleq_B \R{b_2}\right)
  \end{equation}
...
\begin{proof}
  In this proof, given two elements~$a_1,a_2$ of a poset~$A$, we denote for brevity~$a_1 \posleq_A a_2$ by~$a_1 \posleq a_2$.
  ...
  \begin{equation}
    \begin{aligned}
      \sigma' \left(\tup{\tup{\F{a_1},\F{b_1}},\F{c_1}}^*,\tup{\R{b_2},\tup{\R{a_2},\R{c_2}}} \right)&=\left( (\F{a_1}\posleq \R{a_2})  \wedge (\F{b_1}\posleq \R{b_2})\right)\wedge (\F{c_1}\posleq \R{c_2})\\
      &= (\F{a_1}\posleq \R{a_2})  \wedge (\F{b_1}\posleq \R{b_2}) \wedge (\F{c_1}\posleq \R{c_2})
    \end{aligned}
  \end{equation}
  One has
