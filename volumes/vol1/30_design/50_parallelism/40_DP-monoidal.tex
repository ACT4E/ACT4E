...
\begin{proof}
    ...
    \begin{compactitem}
        ...
        \item $\rightunitor_\posgenA\colon \F{A} \cartprod \R{\singleton} \profto \R{A}$, for all~$\posgenA\in \Ob_\DP$, is the right unitor.
        This is given by
        \begin{equation}
        ...
        \item $\associator_{\posgenA,\posgenB,\posgenC}\colon (\F{A}\cartprod \F{B})\cartprod \F{C} \profto \R{A} \cartprod (\R{B}\cartprod \R{C})$ for all~$A,B,C \in \Ob_\DP$, is the associator.
        It is given by
        \begin{equation}
