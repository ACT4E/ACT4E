...
\begin{proof}
  ...
  \begin{compactitem}
    ...
    \begin{equation}
      \lambda_A\left( \disunionA{\F{a_1}}^*,\R{a_2}\right)\definedas \F{a_1}\ordleq_A \R{a_2}.
    \end{equation}
    ...
    \begin{equation}
      \begin{aligned}
        \left( \lambda_A^{-1}\then \lambda_A\right)(\tup{\F{a_1}^*,\R{a_2}})&= \bigvee_{\disunionA{a}\in  \{1\}\times A} \lambda_A^{-1}(\F{a_1}^*,\disunionA{\R{a}})\wedge \lambda_A(\disunionA{\F{a}}^*,\R{a_2})\\
