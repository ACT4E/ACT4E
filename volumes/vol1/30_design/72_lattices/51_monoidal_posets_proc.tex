...
\begin{definition}
    ...
    \label{def:ProcMod}
    For a given \SY{monoidal poset} $\tupp{\TimeMonoidal, \mtimescatof{\TimeMonoidal}}$, the \SY{semicategory}~$\ProcMod$ consists of the following constituents:
    \begin{enumerate}
...
\iflabelexists{subsec:monoidal-space-time}{
    \begin{remark}[Spoilers]
        This example will be extended in \vref{subsec:monoidal-space-time}, where we will add a notion of memory and parallel computation.
    \end{remark}
}
