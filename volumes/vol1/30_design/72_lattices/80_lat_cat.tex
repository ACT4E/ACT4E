...
\begin{ctdefinition}[Category \Lat]
    ...
    \begin{enumerate}
        ...
        \item \emph{Identity morphism}: The \SY{identity morphism} for the lattice~$\Obja$
...
\begin{ctdefinition}[Category \BoundedLat]
    ...
    \begin{enumerate}
        ...
        \item \emph{Identity morphism}: The \SY{identity morphism} for the bounded lattice~$\Obja$
              is the identity map~$\catidat\Obja$.
        \item \emph{Composition operation}: The composition operation is composition of maps.
    \end{enumerate}
\end{ctdefinition}
