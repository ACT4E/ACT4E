...
\begin{gradedexercise}[\exname{HwkInternalLeastUpperBounds}]
    ...
    \begin{enumerate}
        \item
              Let $\posgenA = \tup{\posAset, \posleq}$ be a poset, and consider a subset $\subA \subseteq \posAset$.
        ...
        \item
              ...
              Furthermore, assume that $\posgenA$ has all joins, meaning that for any subset $\subA \subseteq \posAset$, the least upper bound $\bigvee \subA$ exists and is an element of $\posAset$.
