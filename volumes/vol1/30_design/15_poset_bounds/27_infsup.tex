...
\begin{ctdefinition}[Upper bounds in a poset]
    ...
    \begin{equation*}
        \upperb \subA\definedas \{ \elb \setin \posAset \mid \forall \ela \setin \subA  \colon \ela \posAleq \elb \}.
    \end{equation*}
\end{ctdefinition}

\begin{ctdefinition}[Least upper bound / join / supremum]
    A \emph{least upper bound} of~$\subA \setsubseteq \posAset$, if it exists, is a least element among the upper bounds of~$\subA$.
...
If a least upper bound of a subset~$\subA \setsubseteq \posAset$ exists, it is unique (can you prove this?
...
\begin{example}
    ...
    \begin{equation*}
        \posReals = \{x\setin \reals \colon x>0\}
    \end{equation*}
...
\begin{ctdefinition}[Lower bounds in a poset]
    ...
    \begin{equation*}
        \lowerb \subA\definedas \{ \elb \setin \posAset \mid \forall \ela \setin \subA  \colon \elb \posAleq \ela \}.
    \end{equation*}
\end{ctdefinition}
