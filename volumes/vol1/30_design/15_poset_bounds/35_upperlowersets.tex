...
%  \begin{equation}
%    I(A)=\{x\colon x\posAleq y, y\setin A\}
%  \end{equation}
...
%  The booleans~$\{\false, \true \}$ form a poset with~$\false \leq \true\colon(\Bool,\posleq)$ . The subset~$\{\false\} \setsubseteq \Bool$ is not an upper set, since~$\false \leq \true$ and~$\true \notsetin \{\false \}$.
%\end{example}
