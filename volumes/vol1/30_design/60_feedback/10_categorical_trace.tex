...
\todojira{200}{@Marius: you could write a solution for this exercise.}
...
\begin{ctdefinition}[Traced monoidal category]\label{def:traced-monoidal-cat}
...
\begin{lemma}\label{lem:general-superposing-law}
...
\begin{proof}
\todotext{Jira ACT4EBOOK-165: Do the proof. Also, this could be made into a graded exercise.}
\end{proof}
