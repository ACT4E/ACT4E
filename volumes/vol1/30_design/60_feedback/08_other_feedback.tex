...
Such an arrow is given by a continuous time LTI system of the form
    \begin{equation}
        ...
        \end{aligned}
    \end{equation}
    where $A\in \reals^{n\times n}$, $B\in \reals^{n\times l}$, $C\in \reals^{m\times n}$, $D\in \reals^{m\times l}$, $x_t\in \reals^n$, $u_t\in \reals^l$, and $y_t\in \reals^m$.
...
\end{equation}
\todojira{197}{Explain notation and show the simple case of sum of diagonals.
Follow JL's lecture}
