...
\linkvideo{spring2021-functorial-comp-a:solving-queries:solving-loop} % Loop composition
...
The connection between the two is more apparent if one decomposes the trace of a square matrix as a set of properties that any linear map from a space to itself should satisfy. One can find the trace axioms in any standard text on category theory \todotext{I don't think this is true!!}, for instance  \cite{mac2013categories} ;
