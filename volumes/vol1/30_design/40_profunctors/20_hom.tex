...
\todographics{Create the diagrams in the slides}
...
We now need to check that this indeeds forms a profunctor. First of all, we want to check
...
\begin{equation}\label{eq:hom1b}
    \morb = \tup{\morb_1\op,\morb_2}
\end{equation}

\begin{equation}\label{eq:hom2b}
    \CatC\op \Ctimes\CatC
\end{equation}
...
\begin{equation}\label{eq:CatC}
    \CatC 
\end{equation}
\begin{equation}\label{eq:hom-X}
    \Obja
\end{equation}

\begin{equation}\label{eq:hom-X-op}
    \Obja^\ast
\end{equation}
  
\begin{equation}\label{eq:hom-Y}
    \Objb
\end{equation}
\begin{equation}\label{eq:hom-Y-op}
    \Objb^\ast
\end{equation}

\begin{equation}\label{eq:hom-Z}
    \Objc
\end{equation}

\begin{equation}\label{eq:hom-Z-op}
    \Objc^\ast
\end{equation}

\begin{equation}\label{eq:hom-W}
    \Objd
\end{equation}

\begin{equation}\label{eq:hom-W-op}
    \Objd^\ast
\end{equation}
