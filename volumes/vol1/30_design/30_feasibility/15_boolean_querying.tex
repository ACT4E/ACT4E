...
\begin{equation}
    ...
    \defmapperiod{\hat \phi_{\relA}}{\setA}{\sto}{\powerset(\setB)}{\ela}{\{ \elb \in \setB \mid \inrel{\ela}{\relA}{\elb} \}}
\end{equation}
or a function
\begin{equation}
    \label{eq:co-curried-relation-again}
    \defmapperiod{\check \phi_{\relA}}{\setB}{\sto}{\powerset (\setA)}{\elb}{\{ \ela \in \setA \mid \inrel{\ela}{\relA}{\elb}\}}
