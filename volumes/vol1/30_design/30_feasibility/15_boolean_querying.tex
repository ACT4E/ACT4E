...
\end{equation}
%
There are analogous transformations for a \SY{design problem}~$\adp\colon \funsp\op \Ctimes \ressp\toinPos \Bool$.
...
And from \cref{ex:UpperSetsViaFunctors} we know that \SY{monotone maps}.$\posA \mto \Bool$ correspond to \emph{upper} subsets of~\posA.
