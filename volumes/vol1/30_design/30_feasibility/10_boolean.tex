...
\begin{remark}
    ...
    \begin{equation}
        ...
        \defmapperiod{\adp}{\funsp\op \cartprod \ressp}{\toinPos}{\Bool}{\tup{\fun\Fop,\res}}{\exists \imp \in \impsp \colon (\fun \posleqof\funsp \prov(\imp)) \booland (\req(\imp)\posleqof\ressp \res)}
