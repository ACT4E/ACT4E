...
\begin{remark}
    ...
    \begin{equation}
        ...
        \begin{aligned}
            ...
            \tup{\fun^\F{*},\res}                 & \mapsto \exists \imp \in \impsp \colon (\fun \posleqof\funsp \prov(\imp)) \booland (\req(\imp)\posleqof\ressp \res).
        \end{aligned}
    \end{equation}
...
\todotextjira{413}{@Andrea: JL: move the above paragraph somewhere else?
    \eg to the place where we introduce Set-enriched design problems.}
