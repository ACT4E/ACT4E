...
\iflabelexists{def:profunctor}{
    \begin{remark}[Spoilers]
        The map $\adp$ has the color of \SY{functors}, because it will be shown to be a particular type of \SY{functors}- a profunctor~(\cref{def:profunctor}).
    \end{remark}
}
...
\toexclude{
    \begin{example}
        ...
        We will come back to \SY{antichains}  when discussing how to compute optimal solutions of design problems.
