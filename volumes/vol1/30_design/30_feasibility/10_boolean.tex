...
\todotext{JL: maybe move the below bit on diagrammatic notation to the section on series composition of DPs, to motivate the notation and to not create confusion with the graphical visualization of DPs introduced above using arrrows between Hasse diagrams?}
