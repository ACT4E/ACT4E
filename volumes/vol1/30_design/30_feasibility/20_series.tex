...
\begin{remark}
    ...
    \begin{equation*}
        \resposB_\adpa = \Min \{\resposBel\setin \resposB \mid \adpa(\funposAopel,\resposBel)=\true\} \setin \antichains \resposB.
    \end{equation*}
    ...
    \begin{equation*}
        \funposB_\adpb = \Max \{\funposBel\setin \funposB \mid \adpb(\funposBopel,\resposCel)=\true\} \setin \antichains \funposB,
    \end{equation*}
