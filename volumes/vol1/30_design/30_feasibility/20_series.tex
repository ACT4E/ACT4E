...
\begin{definition}[Identity design problem]
    ...
    \begin{equation}
        \begin{aligned}
            ...
            \tupp{\funposAel_\F{1}\Fop\!
            ,\resposAel_\R{2}}                                              & \mapsto \funposAel_\F{1} \posleqof{\posA} \resposAel_\R{2}.
        \end{aligned}
    \end{equation}
\end{definition}
...
\end{figure}
\todotextjira{475}{@Gioele: Around here identities should be colored.}
\begin{proof}
