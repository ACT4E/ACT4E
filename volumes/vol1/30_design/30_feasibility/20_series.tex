...
\todotextjira{757}{\alphubel:  J: @Gioele: there is, I think, a mistake in the above diagram -- shouldn't there be a dashed arrow also from b1 to c4?}
...
\begin{gradedexercise}[\exname{DPComposition}]
    ...
    \begin{center}
        \begin{tikzpicture}[DP, dp port sep=3pt]
            \node[dp={1}{1}, dp port sep=6pt] (save) {\quad \mora \quad \ };
            \draw[funconn, funame={\textbf{Task complexity}}] (save_fun1){};
            \draw[runconn, runame={\textbf{Tech complexity}}] (save_res1){};
        \end{tikzpicture}
    \end{center}
    with
    \begin{align*}
    ...
    \begin{center}
        \begin{tikzpicture}[DP, dp port sep=3pt]
            \node[dp={1}{2}, dp port sep=6pt] (car) {\quad \morb \quad \ };
            \draw[funconn, funame={\textbf{Tech complexity}}] (car_fun1){};
            \draw[runconn, runame={\textbf{\ttime}}] (car_res1){};
