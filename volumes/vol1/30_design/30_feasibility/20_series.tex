...
\todographics{@Gioele: put these 4 figures together. First row: example-dp-composition-xy, example-dp-composition-yz. 
...
\begin{definition}[Identity design problem]
    ...
    %    \end{equation}
\end{definition}
\todotext{Describe why this function is monotone. not obvious.}
