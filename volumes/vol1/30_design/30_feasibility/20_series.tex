...
\
 ...
 \begin{figure}[h!]
        ...
        \end{center}
        \caption{CAPTION \label{fig:example_dp_graph_yz}}
    \end{figure}
...
\
 ...
 \begin{figure}[h!]
        ...
        \end{center}
        \caption{CAPTION \label{fig:example_dp_graph_xyz}}
    \end{figure}
...
\begin{marginfigure}
  ...
  \end{marginfigure}
We can calculate the series composition $\adp \then \bdp$ by tracing paths in the ``composite'' visualization given in \cref{fig:example_dp_graph_xyz}. 
 \begin{figure}[h!]
        \begin{center}
            \includesag{example_dp_composition_xyz}
        \end{center}
    ...
    \end{figure}
Namely, a pair $\tup{\setAel, \setCel}$ is in the feasibility set of $\adp \then \bdp$ if and only if we can trace a path from $\setAel$ to $\setCel$ by only moving upwards in the posets $\posA$, $\posB$, and $\posC$, or crossing from one poset to another following dashed arrows (in the direction they are pointing). Thus the visualization of the composite $\adp \then \bdp$ is as in \cref{fig:example_dp_graph_xz}. 
 \begin{figure}[h!]
        \begin{center}
            \includesag{example_dp_composition_xz}
        \end{center}
...
\todotext{Implement material explaining and illustrating the perspective on design problems in terms of matrices and matrix multiplication.}
