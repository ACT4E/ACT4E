...
\begin{definition}[Series composition]
    ...
    \begin{equation}
        ...
        \end{aligned}
    \end{equation}
\todotext{@Gioele: below "b" is not macroed}
...
\todotextjira{359}{Implement material explaining and illustrating the perspective on composing design problems in terms of matrices and matrix multiplication.}
