...
\todotextjira{359}{\bernina: @Andrea: Implement material explaining and illustrating the perspective on composing design problems in terms of matrices and matrix multiplication.
}
    ...
    \begin{equation}
        ...
        \begin{aligned}
            \adpa(\funposAopel,\resposBel) & =\true \booland \adpa(\funposAopel,\resposBel) \\
                                           & = \dpid_\posA(\funposAopel,\resposAel) \booland \adpa(\funposAopel,\resposBel) \\
                                           & \posleq \bigvee_{\posAel\elprime \setin \posA}\dpid_\posA(\funposAopel,\R{\posgenAel'})\booland \adpa(\funposAel\F{'}\F{\opel},\resposBel) \\
