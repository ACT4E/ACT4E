...
\begin{definition}[Category of design problems \DP]
    \index{\DP|textbf}
    \label{def:DP}
    The \emph{\iindex{category of \SY{design problems} } \DP} consists of the following constituents:
    \begin{enumerate}
...
We have already shown that the composition operator ``$\dpthen$'' is \SY{associative} and unital, and that the composition of two \SY{design problems} is a \SY{design problem} (closure).
