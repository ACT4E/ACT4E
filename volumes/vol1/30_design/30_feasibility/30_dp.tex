...
\begin{proof}
    ...
    \begin{equation*}
        \begin{aligned}
            \impsp & =\makeset{\tup{\funposAel,\resposCel}\setin \funposA \cartprod \resposC \colon (\adpa \fthen_\DP \adpb)(\funposAel,\resposCel)=\true}, \\
            ...
            \prov  & \colon \tup{\funposAel,\resposCel}\mapsto \funposAel, \\
            \req   & \colon \tup{\funposAel,\resposCel}\mapsto \resposCel.
        \end{aligned}
    \end{equation*}
    ...
    \begin{equation*}
        \begin{aligned}
            ...
            \impspn{1}     & =\makeset{\tup{\funposAel,\resposBel}\setin \funposA \cartprod \resposB \colon \adpa(\funposAel,\resposBel)=\true}, \\
            \impspn{2}     & =\makeset{\tup{\funposBel,\resposCel}\setin \funposB \cartprod \resposC \colon \adpb(\funposBel,\resposCel)=\true}, \\
            \prov          & \colon \tup{\funposAel,\resposBel}\tupconcat \tup{\funposBel,\resposCel}\mapsto \provn{1}(\tup{\funposAel,\resposBel})=\funposAel, \\
            \req           & \colon \tup{\funposAel,\resposBel}\tupconcat \tup{\funposBel,\resposCel}\mapsto \reqn{2}(\tup{\funposBel,\resposCel})=\resposCel.
        \end{aligned}
    \end{equation*}
\end{proof}