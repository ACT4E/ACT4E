...
We can make this more formal and say that there exists a \emph{forgetful \SY{semifunctor}} from \DPI to \DP.

\begin{definition}
    \label{def:dpitodpsemi}
    The \SY{forgetful \SY{semifunctor}}~$\dpitodp\colon \DPI\fto \DP$ is given by:
    \begin{enumerate}
