...
\begin{example}
    A gearbox (\cref{fig:gearbox}) provides a certain \textF{output torque} $\F{\tau_o}$ and \textF{speed} $\F{\tau_o}$, given a certain
...
\showslides{
    ...
    \begin{forslides}
        ...
        \begin{lemma}
            \label{lem:cont_V_W}
            The solution of  \cref{eq:ciscont_ric_2} is monotonic in $\mat{V}$ and $\mat{W}$, i.e., $\tup{\mat{V},\mat{W}}\preceq \tup{\mat{V}',\mat{W}'} \Rightarrow \mat{\Sigma}(\mat{V},\mat{W})\preceq \mat{\Sigma}(\mat{V}',\mat{W}')$.
        \end{lemma}
