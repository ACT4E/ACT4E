...
\begin{example}
    ...
    \todotextjira{295}{Let's use the notation $\reals^{[g]}$ for units. This trick of using products is not elegant in this context.}
...
\todographics{Add $\dpinumf$, $\dpinumr$ to the figure (counting the wires).}
\begin{figure}[h]
    \centering
...
\end{example}
\todotextjira{296}{Add equation that relate all.}
\todotextjira{296}{What are the implementations?}
