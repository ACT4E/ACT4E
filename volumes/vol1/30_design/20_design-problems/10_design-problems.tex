...
\showslides{
    \begin{forslides}
        ...
        \begin{equation*}
            \label{eq:opt_1}
            \res_k\in \tup{\ressp_k,\posleqof{\ressp_k}}
        \end{equation*}
        \begin{equation*}
            \label{eq:opt_2}
            \fun_k\in \tup{\funsp_k,\posleqof{\funsp_k}}
        \end{equation*}
        \begin{equation*}
            \label{eq:opt_3}
        ...
        \begin{equation*}
            ...
            \begin{aligned}
                ...
                \R{S}                                   & \mapsto \Min_{\posleqof\ressp} \bigcup_{\res \in \R{S}}\ftor(\fun_1,\res)\cap \upit \res
            \end{aligned}
        \end{equation*}
        \begin{equation*}
            \label{eq:genfun_11}
...
\todotextjira{437}{@Gioele: Yet another different model of a motor.
