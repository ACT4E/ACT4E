...
\begin{definition}[Co-design problem with implementation]
    ...
    \devel{
    \todographicsjira{}{The tikz is not reproducing the original picture faithfully,
    the two DPs are not connected to the outside. They are supposed to be 
    two DPs inside the graph. Maybe it would also help to draw a couple of other boxes.}
