...
\todojira{161}{Re-do a concrete example like this}
...
\captionsideleft{\todographicsjira{162}{redo in tikz}\label{fig:exampleq}}{ \includegraphics[scale=0.33]{unc_atoms_g_v_graph}}
...
%\captionsideleft{\label{fig:total_cost}}{\includegraphics[scale=0.33]{gmcdp_weightsum.pdf}}
    ...
    \devel{
        ...
        \end{center}
        \todographicsjira{163}{finish dp_chassis_motor_loop}
    }
