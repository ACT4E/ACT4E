...
\todotext{Use the notation $\adp$ rather than $\cdpin$.}
...
\devel{ % Devel because the figure is wrong.
    ...
    \begin{marginfigure}
        ...
        \label{fig:exampleq}
    \end{marginfigure}
    \todographicsjira{162}{redo \cref{fig:exampleq} in tikz. Urgent because the current figure is wrong.
    Also feel free to rename the resources in a more consistent way. E.g. $\res_\adpa &= \req(\imp_\adpa)$.}
    ...
    \begin{example}
        ...
        \begin{enumerate}
            ...
            \begin{align}
                ...
                \fun_4 = \prov(\imp_\adpb), \\
                \fun_5 = \prov(\imp_\adpc).
            \end{align}
            \item Wiring constraints:
            \begin{align}
                \tupp{\fun_1, \fun_2}  = \fun_\adpa, \\
                \res_4=\tup{\res_2,\res_3}, \\
                \fun_3=\tup{\fun_4,\fun_5}.
            \end{eqnarray}
