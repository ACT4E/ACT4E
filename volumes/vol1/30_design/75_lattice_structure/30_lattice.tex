...
\begin{definition}[Complete Lattice]
    ...
    A poset~$\posAdefinition$ is a \maindef{complete lattice} if every subset~\subA of~\posAset has both a \emph{greatest lower bound} (often referred to as the \emph{infimum, meet}) and a \emph{least upper bound} (often referred to as the \emph{supremum, join}) in~$\tup{\posAset, \posleq}$.
\end{definition}
