...
\section{\statusdraft{Basic concepts of formal engineering design}}
...
\begin{figure}[h!]
  ...
  \label{fig:impspace}
\end{figure}
\todo{Decide whether we want the usual set color or implementation space}
...
\devel{\JL{I think here we might want to be careful... people (and in particular mathematicians) maybe mean lots of different things by `abstraction' and here it is being used in a very specific sense... perhaps we don't say `one usually means'... or perhaps there is a different word which fits?}}
...
\devel{\JL{Would be nice to also give an example of something that is *not* compositional}}
