...
\devel{
    ...
    \begin{lemma}
        Given~$\adpa, \adpb\colon \funposA \profto \resposB$, we have:
        \begin{equation}
            \adpa \meet \adpb = \comp{\codiag_\posgenA} \dpthen(\adpa + \adpb) \dpthen \conj{\codiag_\posgenB}.
        \end{equation}
    \end{lemma}
    \missingproof
    \devel{
        \begin{proof}
            ...
            \begin{equation}
                \begin{aligned}
                    \left(\comp{\codiag_\posgenA}\dpthen (\adpa+\adpb)\right)\left(\tup{\funposAel^*,\resposBel}\right) & =\bigvee_{} \XXX
                \end{aligned}
            \end{equation}
