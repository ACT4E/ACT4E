...
\begin{definition}[Diagonal function]
    ...
    Define the \emph{diagonal function}~$\diag_\posA\colon \posA \to \posA \cartprod \posA$:
    \begin{equation}
        \begin{aligned}
            \diag_\posA \colon \posA & \to \posA \cartprod \posA, \\
...
\begin{definition}[Codiagonal function]
    ...
    Define the \emph{codiagonal function}~$\codiag_\posA\colon \posA+\posA \to \posA $:
    \begin{equation}
        \begin{aligned}
            \codiag_\posA \colon \posA + \posA & \to \posA, \\
...
\begin{proof}
    ...
    \begin{equation}
        \begin{aligned}
             &
            \star (\tup{\funposAel\Fop,\resposBel}) \\& =\bigvee_{\posAel\styleelements{'}\setin \posA+\posA} \conj{\diag_\posA}(\tupp{\funposAel\Fop,\resposAel\F{'}})\booland (\adpa+\adpb)(\tupp{\funposAel\F{'^*},\resposBel}) \\
