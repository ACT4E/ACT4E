...
\begin{definition}[Diagonal function]
    ...
    Define the \emph{\index{diagonal function}}~$\diag_\posA\colon \posA \to {\posA \Ctimes \posA}$:
    \begin{equation}
        \begin{aligned}
...
\begin{definition}[Codiagonal function]
    ...
    Define the \emph{\index{codiagonal function}}~$\codiag_\posA\colon \posA \Cplus \posA \to \posA $:
    \begin{equation}
        \begin{aligned}
