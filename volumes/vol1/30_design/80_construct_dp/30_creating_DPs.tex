...
\begin{definition}[Sum of resources]
    ...
    If the poset~$\posgenA$ is monoidal with monoidal product $\mtimescat$, then the ``\emph{sum}'' of~$n$ copies of \posA is a \SY{design problem} given by
    \begin{equation}
        \defmapperiodpos{
            \dpsigma{n}{}
        }{
...
\begin{definition}[Sum of functionalities for monoidal posets]
    ...
    If the poset~\posA is monoidal with monoidal product~$\mtimescat$, then the ``\emph{sum}'' of~$m$ copies of \posA is a \SY{design problem} given by
    \begin{equation}
        \defmapperiodpos{
            \dpsigma{}{m}
        }{
