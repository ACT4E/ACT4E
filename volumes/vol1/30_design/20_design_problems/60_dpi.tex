...
\todotext{@Andrea: Write intro.
    Also let's define composition before we define the semicategory.
}
...
\showslides{
    \begin{forslides}
        ...
        \begin{equation}
            \label{eq:adp1pf}
            \adpa: \FB{A}\op \cartprod  \RB{B}  \mtoinPos \Bool
        \end{equation}
        %
        \begin{equation}
            \label{eq:adp1us}
        ...
        \begin{equation}
            \label{eq:adp2pf}
            \adpb: \FB{B}\op \cartprod  \RB{C}  \mtoinPos  \Bool
        \end{equation}
        %
        \begin{equation}
            \label{eq:adp2us}
        ...
        \begin{equation}
            \label{eq:adp12pf}
            (\adpa\dpithen\adpb): \FB{A}\op \cartprod  \RB{C}  \mtoinPos  \Bool
        \end{equation}
        %
        \begin{equation}
            \label{eq:adp12us}
