...
\end{align}
where each value of the index $i$ is for a control point of the program, and~$\varphi_{i}$ are \SY{Scott continuous} functions on the abstract lattice that represents the properties of the program.
