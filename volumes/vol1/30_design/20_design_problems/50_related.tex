...
\todotext{@AC: note here we use the other notation with antichains}
...
In particular, in a CDP we deal with multi-valued maps, and there is more than one solution.
