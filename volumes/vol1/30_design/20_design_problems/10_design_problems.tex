...
\showslides{
    \begin{forslides}
        ...
        \begin{equation}
            ...
            \adp \colon \funsp \op \Ptimes \ressp \toinPos \Bool
        \end{equation}
        \begin{equation}
            \label{eq:decl_dp_2}
        ...
        \begin{equation}
            \label{eq:decl_dp_3}
            (\adpa\dpthen \adpb) \colon \funspa \profto \resspc
        \end{equation}
        \begin{equation}
            \label{eq:opt_1}
...
\showslides{
    ...
    \begin{forslides}
        ...
        \begin{equation}
            ...
            J=\lim_{T\to \infty} \frac{1}{T}\mathbb{E}\makeset{\int_{0}^{T} \pars{\pars{ \mat{x}_t^\intercal \mat{Q} \mat{x}_t}+\pars{ \mat{u}_t^\intercal \mat{R}\mat{u}_t}} \text{d} t},
        \end{equation}
        ...
        \begin{lemma}
            ...
            \begin{equation}
                \begin{aligned}
                    \lim_{t\to \infty}\mathbb{E}\makeset{ \mat{x}_t^\intercal \mat{Q}_0\mat{x}_t} & =\trace(\mat{Q}_0\pars{ \mat{\Sigma} +\mat{F}}), \\
