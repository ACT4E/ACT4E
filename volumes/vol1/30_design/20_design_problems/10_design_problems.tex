...
\begin{example}
    ...
    \begin{equation}
        \funsp =\F{\reals^{\unit[]{kg\cdot cm}}},\quad \ressp=\R{\reals^{\unit[]{g}}\cartprod \reals^{\unit[]{W}}\cartprod \reals^{\unit[]{USD}}},
    \end{equation}
...
\begin{equation}
    \funsp=\prod_{i=1}^{\dpinumf}\proj_i\funsp_{i},\quad \ressp=\prod_{j=1}^{\dpinumr}\proj_{j}\ressp_{j},
\end{equation}
where ``$\proj_{i}$'' represents the projection to the~$i$-th component.
