...
\begin{example}
    ...
    Resources can be summed together using a trivial DP corresponding to the map~$\ftor\colon\tup{\funan{1},\funan{2}} \mapsto\makeset{\funan{1}+\funan{2}}$~(\cref{fig:total_cost}).
