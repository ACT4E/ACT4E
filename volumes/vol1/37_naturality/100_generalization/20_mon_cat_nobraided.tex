...
\end{equation}
 ...
 \item Guess what the definitions of the monoidal unit, associator, and the unitors are for this monoidal product. Are the components of the associator and unitors really isomorphisms in $\CatC$? Justify, briefly, why. 
 \item Check that the left-unitor is indeed a natural transformation. What are the functors that it maps between?
