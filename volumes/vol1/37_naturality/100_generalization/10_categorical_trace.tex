...
\begin{gradedexercise}[\exname{LinearAlgebraTrace}]
    ...
    \todotextjira{516}{@J: Didn't we call this already something different?}
...
\todojira{361}{@J: The above needs to be fixed to account for coherence morphisms in the non-strict case, and also for the definition of trace below}
...
\begin{ctdefinition}[Traced monoidal category]
    ...
    \begin{enumerate}
        ...
        \item \emph{Vanishing I:} For any morphisms~$\mora \colon \Obja\mto \Objb$ in \CatC,
              \begin{equation}
