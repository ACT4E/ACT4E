...
\begin{ctdefinition}[\iindex{Symmetric monoidal category}]
    ...
    A \emph{\SY{symmetric monoidal category}} is a braided monoidal category~$\tupp{\CatC,\mtimescat, \idmoncat, \associator, \leftunitor, \rightunitor, \braiding}$ for which the braiding satisfies the symmetry condition
    \begin{equation}
