...
\begin{ctdefinition}[Symmetric monoidal category]
    ...
    A \maindef{symmetric monoidal category} is a \SY{braided monoidal category} $\tup{\CatC,\mtimescat, \idmoncat, \associator, \leftunitor, \rightunitor, \braiding}$ for which the braiding satisfies the symmetry condition
    \begin{equation}
