...
\begin{ctdefinition}[\iindex{Symmetric monoidal category}]
    ...
    A \emph{symmetric monoidal category} is a braided monoidal category~$\tupp{\CatC,\mtimescat, \idmoncat, \associator, \leftunitor, \rightunitor, \braiding}$ for which the braiding satisifies the symmetry condition
    \begin{equation}
