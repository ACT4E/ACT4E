...
\begin{proof}
    ...
    To prove that~$\braiding_{\posA,\posB}$ is an isomorphism, we use \cref{def:monoidal-cat} and show~$\braiding_{\posA,\posB}\mthen \braiding_{\posB,\posA}=\catidat{\posA\cartprod \posB}$.
    We have
    \begin{equation}
        \begin{aligned}
             ...
             & =\catidat{\posA\cartprod \posB}(\tup{\F{\posgenAel_1},\F{\posgenBel_1}}\Fop,\tup{\R{\posgenAel_2},\R{\posgenBel_2}}).
        \end{aligned}
    \end{equation}
