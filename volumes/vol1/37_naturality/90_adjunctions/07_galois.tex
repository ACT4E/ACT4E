...
\begin{equation}
\setA \supseteq \setA' \quad \implies \quad \incidence_*(\setA) \subseteq \incidence_*(\setA').
\end{equation}
Another way of saying this is to say that $\incidence_*$ is a monotone map of posets 
\begin{equation}
\incidence_* \colon \tup{\powerset \things, \supseteq} \mto \tup{\powerset \attributes, \subseteq}. 
\end{equation}
Or, equivalently, we can view $\incidence_*$ as a monotone map
\begin{equation}
\incidence_* \colon \tup{\powerset \things, \subseteq}\op \mto \tup{\powerset \attributes, \subseteq}. 
\end{equation}
