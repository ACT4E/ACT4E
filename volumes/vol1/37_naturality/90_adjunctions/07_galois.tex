...
\begin{ctdefinition}[Monotone Galois Connection]\label{def:monotone-galois-connection}
    A \maindef{monotone Galois connection} between \SY{posets}~\posA and~\posB is a pair of \SY{monotone maps}.$\mapa\colon \posA\to \posB$ and~$\mapb\colon \posB\to \posA$ such that for all~$\posAel\setin \posA$,~$\posBel\setin \posB$:
    \begin{equation}
...
\begin{ctdefinition}[Antitone Galois Connection]\label{def:antitone-galois-connection}
    An \maindef{antitone Galois connection} between~\posA and~\posB is a pair of antitone maps $\mapa\colon \posA\to \posB$ and $\mapb \colon \posB\to \posA$ such that for all~$\posAel\setin \posA$, $\posBel\setin \posB$:
    \begin{equation}
...
Consider a boolean map~$d\colon \posA\op \Ctimes \posB \toinPos \Bool$.
