    ...
    \begin{equation}
        \begin{aligned}
            \alpha(A) & =\{ \posBel\setin \posB \colon \exists \posAel\setin A\colon d(\posAel,\posBel)\} \\
                      & \subseteq \{\posBel\setin \posB \colon \exists \posAel\setin B\colon d(\posAel,\posBel)\} \\
                      & =\alpha(B),
        \end{aligned}
    \end{equation}
    ...
    \begin{equation}
        \begin{aligned}
            \beta(C) & =\{\posAel\setin \posA\colon \exists \posBel\setin C\colon d(\posAel,\posBel)\} \\
                     & \supseteq \{\posAel\setin \posA\colon \exists \posBel\setin D \colon d(\posAel,\posBel)\} \\
                     & =\beta(D),
        \end{aligned}
    \end{equation}
...
\begin{proof}
    ...
    \begin{equation}
        \begin{aligned}
            L \subseteq \gamma(U) & \equiv L\subseteq \{\posAel \setin \posA\colon \forall \posBel\setin U\colon d(\posAel,\posBel)\} \\
                                  ...
                                  & \equiv U\subseteq \{\posBel\setin \posB\colon \forall \posAel\setin L\colon d(\posAel,\posBel)=\true \} \\
