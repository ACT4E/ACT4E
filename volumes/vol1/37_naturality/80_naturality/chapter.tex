...
\chaptersecond{Naturality}{chapter-cows}{chap:naturality}{
    ...
    We have seen that \SY{functors} a re ``morphisms between categories''.
    ...
    \end{figure}
    %
    points represent categories, single arrows represent \SY{functors}, and double arrows represent natural transformations.
}
