...
We now establish a stronger connection between hom-functors and representable functors.   

\begin{ctheorem}[Yoneda Embedding]
Let $\CatC$ be a category, and $\Obja, \Objb \setin \Ob_\CatC$. Then there is a natural bijection of sets between the hom-set of $\Obja,\Objb$ and the set of morphisms in the category of functors $[\CatC, \Set]$.
\end{ctheorem}
