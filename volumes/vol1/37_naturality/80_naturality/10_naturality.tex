...
Since we could compare have a natural transformation between $\funa_1;\funb_1$ and $\funa_2;\funb_2$,
...
\begin{proof}
    ...
    $\funa_1, \funb_1\colon\CatC \fto \CatD$ and $\funa_2, \funb_2\colon\CatD \fto \CatE$ relating them.
