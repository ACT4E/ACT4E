...
\end{equation}
\todojira{630}{@JL: ideally say more here to motivate or explain this.
...
\end{ctdefinition}
\todotextjira{473}{@JL: seems like a lot of things are missing here.}
\clearpage

\section{Examples}
\linkvideo{spring2021-nat-trafos:natural-trafos:double-dual} % Double dual

\todojira{631}{@JL: write up example here involving monoid actions / state machines}

\todojira{632}{@JL: write up example here about natural trafos between monotone maps}
