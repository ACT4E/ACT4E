...
Let $\CatD$ be the category of pairs of real numbers under element-wise addition, and $\funa, \funb:\CatC\fto\CatD$ be functors between them.
...
If we write out our categories in typical diarams, we notice that they \SY{commute} (see \cref{def:commutative-diagram}).
...
$\funaA,\funaB\colon\CatC \fto \CatD$ and~$\funbA,\funbB\colon \CatD \fto \CatE$ and finally two natural transformations
$\ntrafoa\colon \funaA \nto \funaB$ and~$\ntrafob\colon \funbA \nto \funbB$.
...
\begin{proof}
    ...
    $\funaA, \funbA\colon\CatC \fto \CatD$ and $\funaB, \funbB\colon\CatD \fto \CatE$ relating them.
    ...
    \begin{equation}
        \begin{tikzcd}[every arrow/.append style={arrowfunctorstyle}]
            \CatA \ar[r, bend left=40, "\funaA"]\ar[r, bend right=40, "\funcA"'] &
            \CatB \ar[l, phantom, "\stylenat{\Downarrow} \ntrafoaA \nthen \ntrafobA"]
        \end{tikzcd}
        \begin{tikzcd}[every arrow/.append style={arrowfunctorstyle}]
            \CatB \ar[r, bend left=40, "\funaB"]\ar[r, bend right=40, "\funcB"'] &
    ...
    \begin{equation}
        \begin{tikzcd}[every arrow/.append style={arrowfunctorstyle}]
            \CatA \ar[rrrrr, bend left=40, "\funaA \fthen \funaB"] \ar[rrrrr, bend right=40, "\funcA \fthen \funcB"'] &                                                                                                                  &  &  &
    ...
    \begin{equation}
        \begin{tikzcd}[every arrow/.append style={arrowfunctorstyle}]
            \CatC &  &  &  & \CatD
            \arrow[""{name=0, anchor=center, inner sep=0}, "\funaA\fthen\funaB" shift left=1, bend left=60, from=1-1, to=1-5]
            \arrow[""{name=1, anchor=center, inner sep=0}, "\funcA\fthen\funcB"', shift right=1, bend right=60, from=1-1, to=1-5]
            \arrow[""{name=2, anchor=center, inner sep=0}, "\funbA\fthen\funbB"{description}, from=1-1, to=1-5]
