...
Now, we can create a mapping $\ntrafoa$ mapping the distances to gas prices. Thinking about it, it relates \SY{the elements of the category of distances to those of the category of prices}. If we write out our categories in typical diarams, we notice that they \SY{commute} (see \cref{def:commutative-diagram}).
...
%}
=======
>>>>>>> e7ac0601f058ea7d33e72a144656b4de24124786
...
Let $\CatC$ be a category, and $\Obja \setin \Ob_\CatC$. We define the \SY{hom-functor} of $\Obja$ as $\Hom_\CatC(\Obja, -)\colon\CatC\fto\Set$. It maps $\Objd \setin \Ob_\CatC$ to the hom-set $\Hom_\CatC(\Obja, \Objd)$.
\end{ctdefinition}
