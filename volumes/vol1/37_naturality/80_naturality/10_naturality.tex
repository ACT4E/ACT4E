...
On morphisms, $\funa$ acts as follows. Given a morphism $\tup{\mora\op, \morb} \colon \tup{\setA, \setB} \mto \tup{\setAprime, \setBprime}$ in $\Set\op \Ctimes \Set$, the function 
...
Let us also define the action of $\funb$ on morphisms. Given again a morphism $\tup{\mora\op, \morb} \colon \tup{\setA, \setB} \mto \tup{\setAprime, \setBprime}$ in $\Set\op \Ctimes \Set$, the function 
