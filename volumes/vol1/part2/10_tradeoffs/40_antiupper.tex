...
\newcommand{\posAAleq}{\ordleq_{\posAA}}
...
\begin{figure}[h!]
  ...
  \end{center}
  \caption{The upper closure of a singleton set of pizza recipes. \todographics{left is redundant. Add
...
\begin{figure}[h!]
  ...
  \end{center}
  \caption{The upper closure of a set of pizza recipes. \todographics{left is redundant. Add
  example of a continuous curve.} }
...
\begin{definition}[Min]
  \label{def:Min}
  $\Min \colon \posPA \to \posAA$ is the map that sends a subset~$S$ of a poset to the minimal elements of that subset, i.e., those elements~$a \in S$ such that~$a \posAleq b$ for all~$b \in S$. In formulas:
  \begin{equation*}
    \begin{aligned}
...
\begin{definition}[Max]
  \label{def:Max}
  $\Max \colon \posPA \to \posAA$ is the map that sends a subset~$S$ of a poset to the maximal elements of that subset, i.e., those elements~$a \in S$ such that~$a \ordgeq b$ for all~$b \in S$. In formulas:
  \begin{equation*}
    \begin{aligned}
