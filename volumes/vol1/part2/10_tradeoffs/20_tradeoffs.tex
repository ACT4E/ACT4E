...
\begin{example}[Discrete partially ordered sets]
  ...
  \begin{figure}[tbh]
    ...
    \caption{Example of a discrete poset. \todographics{add points}}
  ...
  \begin{example}
    ...
    Composition is given by composition of inclusions, \ie , if~$X\subseteq Y \subseteq Z$, then~$X\subseteq Z$.
  \end{example}
\end{example}
