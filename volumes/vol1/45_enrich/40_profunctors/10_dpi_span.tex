...
\begin{example}
    ...
    \begin{figure}[h!]
        ...
        \todographics{@Gioele: note that the 130mountains.tikz uses \str{linewidth} which means that it will change based on the context of where the figure is placed. Use absolute value.}
    \end{figure}
