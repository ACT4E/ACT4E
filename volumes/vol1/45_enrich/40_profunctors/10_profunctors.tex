...
\begin{ctdefinition}[Boolean profunctors]
    ...
    Given two \SY{posets}~$\posgenA$ and~$\posgenB$, a \emph{boolean \SY{profunctor}} from~$\posgenA$ to~$\posgenB$ is a \SY{monotone function} of the form
    \begin{equation}
...
\begin{ctdefinition}[Profunctors]
    ...
    Given two categories \CatC and \CatD, a \emph{\iindex{profunctor}} from \CatC to \CatD is a \SY{functor} of the form
    \begin{equation}
...
\showslides{
    \begin{forslides}
        \begin{definition}[\CatV-profunctor]
            ...
            \begin{equation}
                \funa\colon \CatA\op \Ctimes \CatB \fto \CatV.
            \end{equation}
        \end{definition}
