...
\begin{example}[Adjunctions in a one-object bicategory]
    ...
    This is the notion of a \emph{dual pair} (or \emph{duality}) in a monoidal category.
    In the monoidal category of vector spaces with the tensor product, for instance, a dual pair is precisely a pair of finite-dimensional vector spaces~$V$ and~$V^*$ related by the evaluation and coevaluation maps.
\end{example}
