...
\begin{remark}
    Among the examples above, the bicategories of spans, cospans, and Mealy machines all illustrate the same phenomenon: a natural composition operation (pullback, pushout, or cartesian product of state spaces) that is associative only up to isomorphism.
    The bicategorical viewpoint gives us a principled way to work with such structures without needing to quotient or to introduce artificial strict replacements.
\end{remark}
...
Firstly, many of the structures we have studied --- relations, spans, cospans, and dynamical systems such as Mealy machines --- naturally live in bicategories.
