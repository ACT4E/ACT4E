...
\begin{ctdefinition}
    ...
    \begin{enumerate}
        ...
        \item For two objects~$\tup{\Obja,\Objb}$ and~$\tup{\Obja',\Objb'}$ in~$\Obof{\CatA\Ctimes \CatB}$,
        \begin{equation}
\HomSet{\CatA\Ctimes \CatB}{\tup{\Obja,\Objb}}{\tup{\Obja',\Objb'}}\definedas \HomSet{\CatA}{\Obja}{\Obja'}\mtimescat \HomSet{\CatB}{\Objb}{\Objb'}.
\end{equation}
\end{enumerate}
\end{ctdefinition}
...
\begin{ctdefinition}[$\CatV$-Enriched functor]
    ...
    \begin{enumerate}
        \item A function~$\funa\colon \ObC \sto \ObD$ that maps objects of~\CatC to objects of~\CatD.
