    ...
    \begin{solution}
        ...
        \begin{compactitem}
            ...
            \item For each $\Obja,\Objb,\Objc \setin \ObC$, we know a function
                  \begin{equation}
                      \enmof{\Obja}{\Objb}{\Objc}:\HomSet{\CatC}{\Obja}{\Objb}\mtimescat \HomSet{\CatC}{\Objb}{\Objc}\mtoin{\Set} \HomSet{\CatC}{\Obja}{\Objc}.
                  \end{equation}

                  The diagrams constraints imply that this function is associative.
                  \\Therefore, we use it to define morphism composition in $\CatC$, setting $\mthen_{\Obja,\Objb,\Objc}\definedas \enmof{\Obja}{\Objb}{\Objc}$.
