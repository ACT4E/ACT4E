...
\devel{
    ...
    \begin{proof}
        ...
        \begin{equation}
            \dpid_{a} \mthen f_{a,a} (\ast) = \dpid_{f(a) = \true}.
        \end{equation}
    ...
    \begin{definition}[Identity design problem with implementation]
        ...
        The \emph{identity design problem with implementation}~$\tup{\impsp_{\dpid_A},\prov,\req} \colon \F{A} \profto \R{A}$ is given by implementation set $\impsp_{\dpid_A} = A$ and $\prov=\req$ being the identity on $A$.
        The profunctor is defined as
        \begin{align}
            \tup{\impsp_{\dpid_A},\prov,\req} \colon \F{A}\op \cartprod \R{A} & \toinPos \powerset(A) \\
    ...
    \begin{remark}
        ...
        \begin{align}
            \tup{\impsp_{\dpid_A},\prov,\req}\colon \F{A}\op \Ctimes \ressp & \toinPos \powerset{A} \\
            \tup{\F{a}^*,\R{a'}}                                            & \mapsto
            \begin{cases}
