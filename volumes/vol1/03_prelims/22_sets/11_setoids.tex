...
We want to define a \SY{setoid} for which the element~$\tup{2, \shortminus 4}$ is equal to~$\tup{\shortminus  1, 2}$.
...
\begin{itemize}
    ...
    \item \emph{Composition over inheritance}: An example use of inheritance would be saying: ``a \SY{poset} is a set which also has an order relation''; composition would be saying ``a \SY{poset} is a tuple of a set and an order relation''.
