...
The name``$\curry$'' stands for ``Curry'', which is the last name of the mathematician and logician Haskell Curry (\cref{fig:haskell-curry}). It is after his first name that the well know functional programming language is named. 
...
\todotext{JL: move Curry blurb to here}
