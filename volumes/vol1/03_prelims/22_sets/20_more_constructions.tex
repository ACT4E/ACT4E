...
What about if we start with a family~$\makeset{ \setA_i }_{i \setin\stylesets{I}}$ of sets -- can we still take their \SY{cartesian product} or disjoint union?
The answer is yes.
...
We define the \SY{cartesian product} of a family~$\makeset{ \setAn{i} }_{i \setin\stylesets{I}}$ as
\begin{equation}
...
And for the \SY{disjoint union} of a family~$\makeset{ \setAn{i} }_{i \setin\stylesets{I}}$ we set
\begin{equation}
