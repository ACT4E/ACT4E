...
We will use the concept \emph{list} when we want to talk about a tuple of things which are all elements of a single specified set or are all of the same type. Although one might think of them as special kinds of tuples, it is useful to make the concept of list distinct. Our notation for lists is $\makelist{\sgrapes, \sapple, \scarrot, \sapple}$, where here all the entries of this list are elements of the set  $\makeset{\sapple, \sbanana, \scarrot, \sbretzel, \sgrapes}$. Or, as another example, we can use $\makelist{3, 7, 8}$ to denote a triple of natural numbers -- elements of the set~$\natnumbers$. 
