...
\begin{remark}
    Later we will see that the \SY{cartesian product} of sets is a special case of a very general construction in category theory, called the categorical product, and that the \SY{disjoint union} of sets is a special case of a ``dual'' construction, called coproduct.
\end{remark}
