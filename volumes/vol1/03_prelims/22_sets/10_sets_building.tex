...
\end{equation*}
\todotext{In the above, put parenthesis to make $ \ela \in \setA \cup \setB $ more readable.}
...
\end{equation*}
\todotext{
    Change everywhere to use the macros $\setunion$ and $\setintersection$.
}
...
\end{equation}
\todotext{\AC{is $\powerset \powerset$ intentional?}}
...
\end{equation*}
\todographics{@Gioele: It looks like this section is the place where to have the nice figures for set disjoint union etc.}
