...
\todotext{@Andrea: think about the implications of this idea.}
...
\codeboilerplate{MakeSetUnion}{
    (For advanced students) Implement the interface in \cref{lst:MakeSetUnion}.
}
