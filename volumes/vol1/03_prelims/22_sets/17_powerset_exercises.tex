...
Again, you can either do this in \files{act4e_solutions/sets_power.py} or create a seperate file (called \files{act4d_solutions/my_power_sets.py} for instance).
