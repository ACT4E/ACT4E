...
\todotextjira{722}{@JL: include a simple example to illustrate (the one at Wikipedia is quite good, for example)}
...
\todotextjira{263}{@JL: Include set-theory references in the bibliography and link to them}
