...
For sets of infinite size, it turns our that there are different, distinct possible cardinalities; however we wait with getting into the details of how such cardinalities are defined.
...
It is useful to define a \maindef{singleton set} $\singleton$, which is a set containing only one element:
\begin{equation}
