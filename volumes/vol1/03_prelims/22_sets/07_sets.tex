...
\phantomsection\label{sec:booleans}
...
It is useful to define a singleton set $\singleton$, which is a set containing only one element:
\begin{equation}
    \singleton = \makeset{\singletonel}.
\end{equation}
