...
\codeboilerplate{MakeSetProduct}{

    Given two sets, compute their product.
}
\classlisting{MakeSetProduct}{}
...
\margindatafilefig{set_product}{$\{a,b\} \times \{1,2\}$}{fig:set_product}

\margindatafilefig{set_product111}{$\{1\} \times \{1\} \times \{1\}$}{fig:set_product11}%

\margindatafilefig{set_product10}{$\{1\} \times\emptyset$}{fig:set_product10}%

\codeboilerplate{FiniteSetRepresentationProduct}{
