...
To begin to illustrate what we mean, consider the property that a function may or may not have of being \SY{bijective}.
...
In other words, there is a \SY{bijection} between the set~$\stylesets{2}^\setB$ and the set~$\powerset \setB$.
