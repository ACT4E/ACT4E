...
Functions are familiar to all of us, to some degree, from our school days. In this section we present some basic terminology and our way of defining functions formally, and we will discuss various ways to \emph{think} about functions. 
...
We will often take the point of view that a function~$\mapa\colon \setA \to \setB$ defines a certain kind of \emph{relation} between the elements of~$\setA$ and~$\setB$.
...
\todotext{J: maybe delete the paragraph below?}
