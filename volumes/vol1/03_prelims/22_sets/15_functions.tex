...
\end{equation*}
An alternative way of phrasing injectivity of~$\mapa$ is to say that for every singleton subset~$\{ \elb \} \setsubseteq \setB$, its preimage under~$\mapa$ is either a singleton set or the empty set.
...
\begin{equation*}
    \setA_\mapa = \{ \elb \setin\setB \mid \mapa(\elb) = 1 \} \setsubseteq \setB.
\end{equation*}
