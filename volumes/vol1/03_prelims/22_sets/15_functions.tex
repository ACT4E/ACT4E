...
\end{equation}
holds.
A function which is both \SY{injective} and \SY{surjective} is called \emph{bijective}.
...
In our notation for \SY{cartesian product}, disjoint union, and function sets we have used notation inspired by basic operations in arithmetic, motivated in part by the following formulas for sizes of finite sets:
\begin{equation}
