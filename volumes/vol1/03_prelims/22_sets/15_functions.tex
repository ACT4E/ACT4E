...
Given a function~$\mapa$ from a set~$\setA$ to a set~$\setB$ we sometimes speak of ``plugging in'' an element~$\ela \in \setA$ into the function~$\mapa$, and then it will ``output'' an element~$\mapa(\ela) \in \setB$.
