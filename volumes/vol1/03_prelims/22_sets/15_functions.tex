...
\todotext{Write out the exponential function definition on two lines }
...
\todo{J: add figure of an injective function}
...
\todotext{Here we are using \str{\stylesets{1}} to refer to \str{\singletonel}}
