...
Functions are familiar to all of us, to some degree, from our school days. In this section we will present some basic terminology and our way of defining functions formally, and we will discuss various ways to \emph{think} about functions. 

When speaking about functions, we will also use the words ``map'' or ``mapping'' as synonyms. 
...
Sometimes they are defined using a table.

\todotext{@J: make table example}
...
\todotextjira{499}{@J: Say we also call functions ``maps''. }
\todotextjira{374}{@J: Add some subsections to this section to make it easy to navigate.}
...
This is a situation where we lack ``mathematical determinism'', so to speak.
\footnote{One thing we \emph{could} do in this situation is, for any given name, consider the \emph{set} of phone numbers to which that name is associated.
...
\todotextjira{374}{@J: Shouldn't we call them domain and codomain?}
...
\todotextjira{374}{@J: We never explained the meaning of $\backslash$ in  $\reals \backslash \{ 0 \}$}
