...
To illustrate composition of relations, let us consider a simple example, involving sets~\setA,~\setB, and~\setC, and relations~$\relA \colon \setA \sto \setB$ and~$\relB \colon \setB \sto \setC$, as depicted graphically below in \cref{fig:example_rel_composable}.
...
\begin{ctdefinition}
    \label{def:composition_of_relations}
