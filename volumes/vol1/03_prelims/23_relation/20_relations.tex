...
\end{exercise}
\todomistake{\alphubel: @JL: re the SOLUTION of this question: the question is only about relations, not functions.
}
\begin{solution}
...
\end{exercise}
\todomistake{\alphubel: @JL: re the SOLUTION of this question:  first, the question is only about relations, not functions.
