...
\end{exercise}
\begin{solution}
    \todotext{\alphubel: @JL: the question is only about relations, not functions.}
...
\end{exercise}
\begin{solution}
    \todotext{\alphubel: @JL: first, the question is only about relations, not functions. Second, the answer is that yes, there exists exactly one relation from any $\setA$ to $\Emptyset$.}
