...
\begin{ctdefinition}[Transitive closure]
    ...
    The \maindef{transitive closure} of an endorelation~\relA on a set~\setA is the smallest relation on~\setA that contains~\relA and is \SY{transitive}.
    We denote it by~$\traclos{\relA}$.
\end{ctdefinition}
\todomistake{\alphubel: We have not define what is ``the smallest relation''.}
