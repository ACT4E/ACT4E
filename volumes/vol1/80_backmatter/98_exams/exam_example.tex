...
That is, the signals are closed intervals of values. Call this category $\Cat{UMoore}$.
\begin{enumerate}
...
\begin{enumerate}
    ...
    Assume that the computer on which to run everything has~$N\geq 1$ processors. Think of each processor as a ``lane'' in which the operations of each machine are cars that must run sequentially.
