...
\begin{proposition}\label{prop:computable-compositions}
...
\begin{lemma}\label{lem:downward-closed-dp}
...
\begin{proposition}\label{prop:pointed-dcpo}
...
\begin{proof}
    ...
    Then the colimit $\gamma$ of the \SY{chain} \begin{equation}
        0 \overset{i}{\to}
        F(0) \overset{F(i)}{\to} \ldots \to F^{(n)}(0) \overset{F^{(n)}(i)}{\to} F^{(n+1)}(0) \to \ldots
    \end{equation}
