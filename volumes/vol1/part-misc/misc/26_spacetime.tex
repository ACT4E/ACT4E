...
\todographicsjira{535}{@Andrea: Simple graphics to accompany explanation.}
...
\begin{lemma}
    ...
    \begin{equation}
        \Obja \mtimescatob \Objb = \tupp{
            \makeTupcat {\setA ,\setB},
            \makeTupcat {\Sigma_{\setA}, \Sigma_{\setA}},
            \sizefun_{\setA\setB}
        },
    \end{equation}
    where
    ...
    \begin{equation}
        \defmapperiodset{
            ...
            \makeTupcat {\Sigma_{\setA}, \Sigma_{\setB}}
        }{
            \TimeMonoidal
        }{
