...
We require both time and space to be monoidal \SY{lattices}~$\tupp{\TimeMonoidal, \mtimescat_{\TimeMonoidal}, \join_{\TimeMonoidal}}$ and~$\tupp{\SpaceMonoidal, \mtimescat_{\SpaceMonoidal}, \join_{\SpaceMonoidal}}$.
%
...
\begin{definition}
    ...
    \label{def:ProcSTMod}
    For given monoidal \SY{lattices}~$\tupp{\TimeMonoidal, \mtimescat_{\TimeMonoidal}, \join_{\TimeMonoidal}}$ and~$\tupp{\SpaceMonoidal, \mtimescat_{\SpaceMonoidal}, \join_{\SpaceMonoidal}}$, the \SY{semicategory} $\ProcSTMod$ consists of the following constituents:
    \begin{enumerate}
...
\begin{lemma}
    For generic monoidal \SY{lattices}~$\tupp{\TimeMonoidal, \mtimescat_{\TimeMonoidal}, \join_{\TimeMonoidal}}$ and $\tupp{\SpaceMonoidal, \mtimescat_{\SpaceMonoidal}, \join_{\SpaceMonoidal}}$, the \SY{semicategory} $\ProcSTMod$  is \emph{not} a \SY{functorial stacking semicategory}.
\end{lemma}
