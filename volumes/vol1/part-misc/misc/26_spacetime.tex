...
We require both time and space to be monoidal \SY{lattices}~$\tupp{\TimeMonoidal, \mtimescatof{\TimeMonoidal}, \join_{\TimeMonoidal}}$ and~$\tupp{\SpaceMonoidal, \mtimescatof{\SpaceMonoidal}, \join_{\SpaceMonoidal}}$.
%
We will define series and parallel composition as follows:
\begin{equation}
    \begin{aligned}
        \tupp{t_1,m_1} \mthenof {\SpaceTime}  \tupp{t_2,m_2}    & = \tupp{t_1 \mtimescatof{\TimeMonoidal} t_2, m_1 \join_{\SpaceMonoidal} m_2}, \\
        \tupp{t_1,m_1} \mtimescatof{\SpaceTime}  \tupp{t_2,m_2} & = \tupp{t_1 \join_{\TimeMonoidal} t_2, m_1 \mtimescatof{\SpaceMonoidal} m_2}.
    \end{aligned}
\end{equation}
...
\begin{definition}
    ...
    \label{def:ProcSTMod}
    For given monoidal \SY{lattices}~$\tupp{\TimeMonoidal, \mtimescatof{\TimeMonoidal}, \join_{\TimeMonoidal}}$ and~$\tupp{\SpaceMonoidal, \mtimescatof{\SpaceMonoidal}, \join_{\SpaceMonoidal}}$, the \SY{semicategory} $\ProcSTMod$ consists of the following constituents:
    \begin{enumerate}
...
\begin{lemma}
    For generic monoidal \SY{lattices}~$\tupp{\TimeMonoidal, \mtimescatof{\TimeMonoidal}, \join_{\TimeMonoidal}}$ and $\tupp{\SpaceMonoidal, \mtimescatof{\SpaceMonoidal}, \join_{\SpaceMonoidal}}$, the \SY{semicategory} $\ProcSTMod$  is \emph{not} a \SY{functorial stacking semicategory}.
\end{lemma}
