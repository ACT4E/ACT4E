...
\begin{itemize}
    ...
    \item Solved theoretical exercises, such as \cref{ex:solved1} below.
          These are solved at the end of the part.
    \item Graded theoretical exercises, such as \cref{ex:graded1} below.
          You will not find the solutions in the book.
    \item Graded code exercises, such as \cref{ex:coded1} below. These are autograded and the solution is not publicly available.
\end{itemize}

\begin{remark}
    \textbf{Instructors}: if you want to teach from this book, we are happy to provide the solutions to you.
\end{remark}
