...
The interfaces are defined in the package \str{act4e_interfaces} which is in the repository \str{ACT4E/ACT4E-interfaces}. This package can be installed using
