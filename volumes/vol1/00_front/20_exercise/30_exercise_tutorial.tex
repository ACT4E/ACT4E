...
Let's define two interfaces: \classname{Setoid}, for a generic set, \classname{EnumarableSet}, and \classname{FiniteSet}, for a setoid that has a finite set of elements.
