...
\margindatafilefig{set1}{Example shown in YAML format.}{fig:set1}
...
\begin{gradedexercise}[\exname{TestFiniteSetRepresentation}]
  ...
  You have to implement the  interface \classname{FiniteSetRepresentation}
...
To load just take the \str{elements} field of the data structure and give it to \classname{MyFiniteSet}.
