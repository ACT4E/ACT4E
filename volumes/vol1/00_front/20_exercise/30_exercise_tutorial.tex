...
This is correct because it is using the method \funcname{elements} that all implementations of \FiniteSet need to have. What could be wrong is using code like the following:
