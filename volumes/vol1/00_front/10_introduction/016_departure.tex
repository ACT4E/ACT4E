...
Instead, here we first build up the examples as something that is interesting per se, and then we show how they can all be instances of the same general concept.
...
We also noticed several examples of interest (\eg proper LTI system) that are only \SY{semicategories}, but they still have a notion of trace.
...
\iflabelexists{chap:generalization}{
