...
\todotextjira{716}{@AC: Mark this as ``for experts only'' section.
...
They role they play there is associated to very technical checks.
Nothing exciting!
We made the decision to provide a version of monoidal categories that are strict--not need for natural transformations.
...
\todotextjira{718}{Cite the particular book}
