...
If you are using TexShop on a Mac: there is an issue with Pygmentize not working properly with the minted package. The following should resolve the issue: 
