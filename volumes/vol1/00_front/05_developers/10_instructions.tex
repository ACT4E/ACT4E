...
%
\begin{console}
    docker pull reg-z7-prod.zuper.ai/act4e/act4e-build:alphubel
\end{console}
%
Stop if any error.
...
\todotextjira{286}{@Andrea: document nomenclature }

\subsubsection{Python snippets from source code}

\todotextjira{286}{@Andrea: document snippets }

\subsubsection{Prerender of figures}

\todotextjira{286}{@Andrea: document prerender }
...
\end{console}
%
Should be \str{/usr/local/bin/latexindent}
