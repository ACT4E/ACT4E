...
If you are compiling the LaTeX files without Docker, you may run into issues if you are not using the latest distribution of LaTeX, because some commands that are used are not supported by older LaTeX distributions.
...
To compile entire parts, you can use \str{make part-once} or \str{make part-continuous} from any folder containing \files{part-standalone.tex}.
