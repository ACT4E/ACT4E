...
\end{minted}
%
Latex will produce ``\dots and so on. fig 3.2 shows that \dots''.
...
Therefore, you should not use \str{\mtimes_X}. Rather, use the macros \str{mthenof}, \str{mtimesof}, etc.
...
Use \str{\makeset} to write a list of elements. This includes magic that allows latex to break at commas - which is not allowed by default.
