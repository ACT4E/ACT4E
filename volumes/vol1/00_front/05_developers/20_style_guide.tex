...
\begin{quote}
    \centering
    \str{[r]{,}} \qquad or \qquad \str{[r]{.}} % FIXME: latexindent messes this up
\end{quote}
%
...
We have a command \str{\pars} that is equivalent to \str{\left( contents \right)}.
...
The command \str{\makecartprod} makes the \SY{cartesian product}.
\begin{minted}{latex}
