...
\subsubsection*{Spacing for operators}

\str{\mtimes} and relatives are defined as \str{\mathrel}.
Therefore, you should not use \str{\mtimes_X}. Rather, use the macro \str{\mthenof}\str{\mtimesof}.
