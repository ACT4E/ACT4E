...
\begin{tabular}{rc}
    \str{1 + 2}                     & $1 + 2$ \\
    \str{\setA \setdisunion \setA}  & $\setA \setdisunion \setA$ \\
    \str{\mapa \funcsum \mapa}      & $\mapa \funcsum \mapa$ \\
    \str{\coprodMapob \Obja \Obja}  & $\coprodMapob \Obja \Obja$ \\
    \str{\coprodMapmor \mora \mora} & $\coprodMapmor \mora \mora$ \\
    \str{\posA \Pplus \posA}        & $\posA \Pplus \posA$ \\
    \str{\CatC \Cplus \CatC}        & $\CatC \Cplus \CatC$
\end{tabular}
...
\begin{tabular}{rcl}
    \str{\posela \monpostimes \poselb} & $\posela \monpostimes \poselb$ \\
    \str{\Obja\mtimescatob\Objb}       & $\Obja\mtimescatob\Objb$ \\
    \str{\mora\mtimescatmor\morb}      & $\mora\mtimescatmor\morb$ \\
\end{tabular}

\begin{tabular}{rcl}
    \str{x \mtimes y}         & $x  \mtimes y$        & monoid multication \\
...
\subsection{Checking various spacing issues }
