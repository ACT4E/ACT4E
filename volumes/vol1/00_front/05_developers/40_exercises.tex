...
%
\begin{enumerate}
    \item The instructors have generated a certain Docker image \evalrepo and published to DockerHub (explained later in  \cref{{subsub:developers}}).
    ...
    \item The \files{Dockerfile} inside \str{ACT-exercises-template} build from \evalrepo.
          It adds more dependendencies that the user might have declared in \files{requirements.txt}.
