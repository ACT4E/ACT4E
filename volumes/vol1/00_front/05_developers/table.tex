% symbol \mapd not used
% symbol \mape not used
\begin{longtable}{lll}
 &  & \\ 
...
{\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash setA}} & $\setA$ & \\ 
 ...
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash mapd}} & $\mapd$ & \unused \\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash mape}} & $\mape$ & \unused \\ 
