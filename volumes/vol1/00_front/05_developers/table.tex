...
{\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash setA}} & $\setA$ & \\ 
 ...
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash mapd}} & $\mapd$ & \\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash mape}} & $\mape$ & \\ 
...
{\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash mapid}} & $\mapid$ &  Identity map\\ 
 ...
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash funceil}} & $\funceil$ &  ceiling function\\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash funfloor}} & $\funfloor$ &  floor function\\ 
...
{\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash idmat}} & $\idmat$ &  identity matrix\\ 
 ...
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash posdef}} & $\posdef$ &  Positive-definite matrices\\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash possemidef}} & $\possemidef$ &  Positive-semidefinite matrices\\ 
...
{\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash posA}} & $\posA$ & \\ 
 ...
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash posAleq}} & $\posAleq$ &  Order on poset $\posA$\\ 
 ...
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash posUA}} & $\posUA$ &  Upper sets of poset $\posA$\\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash posUB}} & $\posUB$ & \\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash posLA}} & $\posLA$ &  Lower sets of poset $\posA$\\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash posLB}} & $\posLB$ & \\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash posAAleq}} & $\posAAleq$ & \\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash Int}} & $\Int$ &  Interval monad\\ 
...
{\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash sgrpA}} & $\sgrpA$ &  Generic semigroup names\\ 
 ...
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash mlog}} & $\mlog$ &  Matrix logarithm\\ 
...
{\color[rgb]{0.5,0.5,0.5}\texttt{\$\textbackslash tup\{\textbackslash posA, \textbackslash posAleq\}\$}} & $\tup{\posA, \posAleq}$ & \\ 
 ...
 \hline
\hline
{\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash true}} & $\true$ &  True\\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash false}} & $\false$ &  False\\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash booland}} & $\booland$ &  Boolean and\\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash boolor}} & $\boolor$ &  Boolean or\\ 
  &  & \\ 
 \multicolumn{3}{l}{{\color[rgb]{0.5,0.5,0.5}\texttt{arrows}} \emph{Arrows}}\\ 
 \hline
\hline
{\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash sto}} & $\sto$ &  Set arrow\\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash from}} & $\from$ & \\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash mto}} & $\mto$ &  Morphism arrow\\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash mfrom}} & $\mfrom$ &  Morphism arrow \\ 
...
{\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash mst\{a\}}} & $\mst{a}$ &  Formatting for morse code table\\ 
 ...
 \hline
{\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash alphanums}} & $\alphanums$ &  Alphabet\\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash asciienc}} & $\asciienc$ &  ASCII encoding functor\\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash asciifunc}} & $\asciifunc$ &  ASCII function\\ 
...
{\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash mgOn}} & $\mgOn$ &  Orthogonal group\\ 
 ...
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash effort}} & $\effort$ &  effort \\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash track}} & $\track$ &  tracking\\ 
  &  & \\ 
 \multicolumn{3}{l}{{\color[rgb]{0.5,0.5,0.5}\texttt{exam2021}} \emph{Exam 2021}}\\ 
 \hline
\hline
{\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash fast}} & $\fast$ & \\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash slow}} & $\slow$ & \\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash llarge}} & $\llarge$ & \\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash ssmall}} & $\ssmall$ & \\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash llong}} & $\llong$ & \\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash sshort}} & $\sshort$ & \\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash speed}} & $\speed$ & \\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash size}} & $\size$ & \\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash money}} & $\money$ & \\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash ttime}} & $\ttime$ & \\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash cheap}} & $\cheap$ & \\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash midprice}} & $\midprice$ & \\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash expensive}} & $\expensive$ & \\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash energy}} & $\energy$ & \\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash mass}} & $\mass$ & \\ 
  &  & \\ 
 \multicolumn{3}{l}{{\color[rgb]{0.5,0.5,0.5}\texttt{operads}} \emph{Operads}}\\ 
 \hline
\hline
