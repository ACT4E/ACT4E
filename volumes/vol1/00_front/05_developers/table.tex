...
{\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash twisted\{a\}}} & $\twisted{a}$ & \\ 
 ...
 \hline
{\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash semigroupA}} & $\semigroupA$ &  Generic monoid\\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash semigroupB}} & $\semigroupB$ &  Generic monoid\\ 
  &  & \\ 
