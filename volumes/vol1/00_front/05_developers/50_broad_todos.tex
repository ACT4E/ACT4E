...
\item Each chapter should have a more-or-less consistent 'register'  -- here are three distinct types: 1) some chapters are mathematical (but with applications too), 2) a few chapters throughout the book will be a more cartoonish, informal discussion of certain general concepts (such as 'series composition') using more everyday, non-mathematical examples, and 3) a few chapter will be a high-level commentary on how others and we think about category theory and various broad topics within it. 
\end{enumerate}
