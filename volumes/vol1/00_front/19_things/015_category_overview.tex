...
\begin{equation}
    ...
    % \rule{0pt}{2cm}
    \middlesag{colors-additive} % XXX: ugly hack
\end{equation}
...
\todotext{
    Move section to different file.
}

We can think at a higher level, by having recipes as ingredients.

\todotextjira{733}{@Gioele: use better color names: not many know what colors are "windsor" and "rob roy".}
...
\todotext{Move section to own file}
...
\todotextjira{262}{@Andrea: POST-ALPHUBEL Describe annihilating better.}
...
\todographicsjira{524}{POST-ALPHUBEL:There was a picture from an old rope trick magic book that was in the slides.}
\begin{exercise}
