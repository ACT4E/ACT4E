...
\begin{definition}[Monoid]
  \label{def:monoid}
  A \index{\emph{monoid}} is a set~$\monoidA$ with a binary operation~$\mtimes \colon \monoidA \cartprod \monoidA \sto \monoidA$, and a \emph{neutral element}~$\idmon\in \monoidA$, which satisfy:
  \begin{enumerate}
