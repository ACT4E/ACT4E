...
\begin{definition}[Monoid]
  \label{def:monoid}
  A \index{\emph{monoid}} is a set~$\monA$ with a binary operation~$\mtimes \colon \monA \cartprod \monA \sto \monA$, and a \emph{neutral element}~$\idmon\in \monA$, which satisfy:
  \begin{enumerate}
