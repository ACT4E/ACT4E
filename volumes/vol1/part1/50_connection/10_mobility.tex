...
\begin{example}
  ...
  \begin{equation*}
    V_\mathrm{c}=\{\textsf{SFO}_\mathrm{c}, \textsf{S. Mateo},\textsf{H. M. Bay},\textsf{SBP}_\mathrm{c},\textsf{Balboa},\textsf{LAX}_\mathrm{c}\},
  \end{equation*}
