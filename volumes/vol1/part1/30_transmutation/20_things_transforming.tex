...
\begin{figure}[h!]
  ...
  \caption{Resources in the electric car example.  \todographics{Make a macro instead of using bullet so we
...
\begin{equation}
  \label{eq:arrow1}
  \transmuted{X} \stackrel{\transmuter{transmuter}}{\cto} \transmuted{Y}
\end{equation}
...
\begin{equation}
  \transmuter{transmuter} \colon \transmuted{X} \cto \transmuted{Y}.
\end{equation}
...
%
\begin{align}
  \motor&:  \rotationalmotion \cto \electricpower, \\
  \wheels&: \translationalmotion \cto \rotationalmotion.
\end{align}
%
...
\begin{equation*}
  \transmuted{X} \stackrel{\transmuter{a}}{\cto} \transmuted{Y}
  \qquad \text{and} \qquad
  \transmuted{Y} \stackrel{\transmuter{b}}{\cto} \transmuted{Z},
\end{equation*}
