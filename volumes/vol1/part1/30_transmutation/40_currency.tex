...
In this section, we introduce a kind of category for describing currency exchangers. Our idea is to model currencies as objects of a category, and morphisms will describe ways of exchanging between those currencies, \text{\eg }, as offered by a currency exchange service.
...
To build our category, we also need to specify how currency exchangers compose. Given currencies~$\transmuted{c}_1, \transmuted{c}_2, \transmuted{c}_3$, and given currency exchangers
\begin{equation*}
...
\todographics{Actualy, ExchATM etc. should not be transmuters. }
