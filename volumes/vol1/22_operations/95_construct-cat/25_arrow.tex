...
\begin{ctdefinition}[Arrow category]
    ...
    Given any category~$\CatC$, its \emph{\iindex{arrow category}}~$\Arrow \CatC$ is the category in whichap:
    \begin{enumerate}
...
\todographicsjira{407}{@Gioele: Add diagram that shows composition of commutative diagrams}
