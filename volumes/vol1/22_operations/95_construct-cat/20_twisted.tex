...
\begin{ctdefinition}[Twisted arrow category]
    ...
    \begin{enumerate}
        ...
        \item \emph{Morphisms:}
              A morphism between two arrows~$\mora\colon \Obja \mto \Objb $,~$\morb\colon \Objc \mto \Objd$ is given by a pair of arrows~$\tup{\morc,\mord}$ such that the following diagram commutes:
              \begin{center}
        ...
        \item \emph{Composition:} Composition in~$\TwistedArrow \CatC$ is given by placing commutative squares side by side.
              \todotextjira{402}{More details about composition in twisted-arrow.
                  Show diagram?
              }
    \end{enumerate}
\end{ctdefinition}
