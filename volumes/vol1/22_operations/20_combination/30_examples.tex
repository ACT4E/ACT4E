...
The diagram reported in \cref{fig:prod_coprod_prop} illustrates the structure of the propositions lattice for three elements~$\posAel,\posBel,\posCel\in \posA$.
