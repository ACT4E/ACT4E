...
\devel{
    \todotextjira{400}{@Gioele: finish \cref{exa:meet-as-prod}}
    \begin{example}
...
\devel{
    \begin{example}
        ...
        We considered \XXX \todotextjira{398}{@Gioele: Finish \cref{exa:meet-as-prod-cont} } and we drew an arrow~$\ela \to \elb$ iff~$\ela \leq \elb$.
