...
\todojira{87}{Cartesian product appearing before somewhere else.
    Let's not duplicate definitions.
    (in intro to sets and functions, but also somewhere else, find, and add references).}
...
\devel{
    ...
    \begin{example}
        ...
        Let $\dots$ \XXX be a lattice.
        For any element $\ela, \elb \in \dots$, \XXX let us draw an arrow $\ela \to \elb$ iff $\ela \leq \elb$.
