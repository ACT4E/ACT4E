...
\begin{example}
    ...
    \begin{equation}
        \pi_1(\tup{x,y}) =  x  \qqand \pi_2(\tup{x,y}) = y.
    \end{equation}
...
\begin{figure}[h!]
    ...
    \todographics{The arrows should be the color of morphisms.
        And shouldn't the background be light brown for consistency?
    }
    \label{fig:snacks_1}
\end{figure}
...
\begin{equation}
    ...
    \eats =\phi_{\eats,\drinks}\then \pi_1 \qqand \drinks=\phi_{\eats,\drinks}\then \pi_2.
\end{equation}
...
\begin{equation}
    \eats\colon \Participants \to \Snacks
\end{equation}
and
\begin{equation}
    \drinks\colon \Participants \to \Drinks
\end{equation}
...
\todotext{@Gioele: use macro for projection morphisms $\pi_1$.
    The macro will also color it appropriately.
}
