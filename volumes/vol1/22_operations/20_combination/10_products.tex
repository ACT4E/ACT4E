...
Let~$\Participants$ denote the set of participants. \todotext{\JL{Since the water emoji is hard to see, perhaps we could use the "apple juice box" emoji in its place?}}
...
We considered \XXX \todotext{FINISH} and we drew an arrow~$\ela \to \elb$ iff~$\ela \leq \elb$.
