...
\begin{equation}\label{eq:prod-slides-1}
\setA = \{1, 2, 3, 4\}
\end{equation}

\begin{equation}\label{eq:prod-slides-2}
\setB = \{ \ast, \dagger \}
\end{equation}

\begin{equation}\label{eq:prod-slides-3}
\Snacks=\{\sapple,\sbanana,\scarrot\}
\end{equation}

\begin{equation}\label{eq:prod-slides-4}
\Drinks=\{\swater,\stea\}
\end{equation}

\begin{equation}\label{eq:prod-slides-5}
\Participants
\end{equation}

\begin{equation}\label{eq:prod-slides-6}
\eats \colon \Participants \sto \Snacks
\end{equation}

\begin{equation}\label{eq:prod-slides-7}
\drinks \colon  \Participants \sto \Drinks
\end{equation}

\begin{equation}\label{eq:prod-slides-8}
\meal \colon \Participants\sto \Snacks \times \Drinks
\end{equation}

\begin{equation}\label{eq:prod-slides-9}
\Snacks \times \Drinks
\end{equation}

\begin{equation}\label{eq:prod-slides-10}
\eats
\end{equation}

\begin{equation}\label{eq:prod-slides-11}
\drinks
\end{equation}

\begin{equation}\label{eq:prod-slides-12}
\meal
\end{equation}


\begin{equation}\label{eq:prod-slides-13}
\setA
\end{equation}
...
\begin{ctdefinition}[Categorical Product]\label{def:categorical-product}
...
\begin{gradedexercise}[\exname{CatProductPowerset}]\label{ex:CatProductPowerset}
...
\begin{example}\label{exa:conjunction-as-prod-cont}
...
\begin{example}\label{exa:meet-as-prod-cont}
...
\book{
  ...
  \begin{gradedexercise}[\exname{ProductPosetCatProduct}]
 Prove that the product poset~$\posA \times \posB$ ``is'' the categorical product of~$\posA$ and~$\posB$ within the category of posets.
  \end{gradedexercise}

  \todotextjira{89}{Write the solution}

   \begin{gradedexercise}[\exname{ProductCatCatProduct}]
 Prove that the product category~$\CatC \times \CatD$ of two small categories ``is'' the categorical product of~$\CatC$ and~$\CatD$ within the category of small categories.
  ...
  \todotextjira{90}{Write the solution}
