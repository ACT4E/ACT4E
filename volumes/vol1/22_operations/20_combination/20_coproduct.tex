...
\showslides{
    \begin{forslides}
        ...
        \begin{definition}[Union of sets]
            ...
            \begin{equation}
                \setA \setunion \setB=\{\ela \colon \ela \in \setA \text{ or }\ela \in \setB\}.
            \end{equation}
        \end{definition}
        \begin{equation*}
            \label{eq:divides_1}
        ...
        \begin{equation}
            ...
            \begin{aligned}
                ...
                \stylesets{x}                          & \mapsto
                \begin{cases}
                    \mapa(\stylesets{x}), & \text{if } \stylesets{x}=\inj_\setA(\setAel),\quad \setAel \in \setA, \\
                    \mapb(\stylesets{x}), & \text{if } \stylesets{x}=\inj_\setB(\setBel),\quad \setBel \in \setB.
                \end{cases}
            \end{aligned}
        \end{equation}
        \begin{equation*}
...
\begin{example}
    ...
    This example is ``dual'' to \cref{exa:intersection-as-prod-cont}.
    Again consider the set~$\setA = \{ \true, \false \}$ of logical symbols and for any~$\ela, \elb  \in \setA$, we drew an arrow~$\ela \to \elb$ iff
    \begin{equation*}
        \prfperiod{\ela}{\elb}
    \end{equation*}
