...
\begin{example}
    ...
    So~$\subA_1 \setunion \subA_2 = \{1,2, 3,4\}$.
    If we choose~$\setC = \{ 2 \}$, we see that~$\setC \subseteq \subA_1$ and~$\setC \subseteq \subA_2$, and that also~$\setC \subseteq \subA_1 \setunion \subA_2$ (as it must, according to the universal property).
