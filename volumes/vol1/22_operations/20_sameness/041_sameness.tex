...
To formulate this version, all we need are morphisms, their composition, the notion of \SY{identity morphism}s, and the notion of equality of morphisms (for equations such as~``$\mapa \mthen \mapb= \catid_\ela$'').
