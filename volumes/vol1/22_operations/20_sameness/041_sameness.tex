...
\begin{exercise}\label{ex:isoinverse}
...
\end{exercise}
\begin{solution}
  \todotextjira{96}{Solution of \cref{ex:isoinverse}.}
\end{solution}
...
\todotextjira{98}{We cannot do this using \texttt{stdcurr}. Let's do it with Bitcoins and Satoshis }
\begin{example}
