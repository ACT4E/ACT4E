...
\begin{example}
Let's consider currencies, and in particular the sets~$\reals\times \{\stdcurr\}$ and~$\reals\times \{\stdcurr \text{ cents}\}$.
...
For one direction, the isomorphism transforms \stdcurr into \stdcurr cents (multiplying the real number by 100); the other direction transforms \stdcurr cents into \stdcurr (dividing the real number by 100).
\end{example}
