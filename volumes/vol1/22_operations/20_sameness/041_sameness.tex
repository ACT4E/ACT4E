...
\end{exercise}
\begin{solution}
  \todotext{Solution of \cref{ex:isoinverse}.}
\end{solution}
...
\todographics{Make \texttt{skull} a command - now a lot of formatting here}
...
\todotext{We cannot do this using \texttt{stdcurr}. Let's do it with Bitcoins and Satoshis }
\begin{example}
