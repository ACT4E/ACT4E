...
\devel{
    \begin{example}[Sizes]
        ...
        The only thing we care about is the fact that the sets~$W$ and~$\{1, 2, 3,\dots, 272, 273 \}$ are \emph{isomorphic}; we don't need to keep track of which counting isomorphism exhibits this fact.
    \end{example}
}
...
\devel{
    ...
    \todojira{101}{Examples from before: Dynamical systems (open, d=0).
