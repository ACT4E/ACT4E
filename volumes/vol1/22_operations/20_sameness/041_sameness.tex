...
\begin{ctdefinition}[Isomorphism]
    ...
    We say that~$\mora$ is an \emph{\iindex{isomorphism}} if there exists a morphism~$\morb\colon \Objb \mto \Obja$ such that~$\mora \mthen \morb = \catidat\Obja$ and~$\morb \mthen \mora = \catidat\Objb$.
\end{ctdefinition}
