...
\begin{ctdefinition}[Representable Functor]\label{def:representable-functor}
    ...
    A functor $\funa\colon\CatC \fto \Set$ is said to be \SY{representable}, if there exists an object $\Objc\setin\Ob_\CatC$ and a natural isomorphism between $\funa$ and the functor $\Hom_\CatC[\Objc, -]$.
