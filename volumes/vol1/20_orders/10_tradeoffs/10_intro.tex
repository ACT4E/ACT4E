...
\begin{figure*}[h]
    ...
    \caption{}
    \todographics{Align better the figures.
        Not sure why not well aligned.
    }
\end{figure*}
...
\begin{figure*}[b]
    ...
    \subfloat[
        \label{fig:accu_1_a}
        Feasibility curve with costs.
    ]
    {\includesag{accu_1}}
    \hfill
    \subfloat[
        \label{fig:accu_1_b}
        Feasibility curve with functionalities.
    ]
    {\includesag{accu_2}}
    \hfill
    \subfloat[
    ...
    \todographics{Align better the figures.
        Do not make captions go on two lines}
\end{figure*}
...
\subsection{The law of succesful products}
