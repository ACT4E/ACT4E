...
\todographics{This section definitely highlights the need to check what's the best practice for putting pictures/brands in figures. Should we track them at the end in a sort of reference?}
...
\end{center}
  \caption{\label{masks_expressive}}
\end{figure}
