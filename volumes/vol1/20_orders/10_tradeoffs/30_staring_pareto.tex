...
\begin{definition}[Antichain in a poset]
    ...
    \begin{equation}
        \prftree[r]{.}{\setAel \posAleq \setBel}{\setAel=\setBel}
    \end{equation}
\end{definition}
...
\begin{definition}[Upper set]
    ...
    In other words:
    \begin{equation}
        \prftree[r]{.}{\styleelements{x}\in \stylesets{U}}{\styleelements{x}\posAleq \styleelements{y}}{\styleelements{y}\in \stylesets{U}}
    \end{equation}
    %In formulas:
    %\begin{equation}
...
\begin{definition}[Lower set]
    ...
    In other words:
    \begin{equation}
        \prftree[r]{.}{\styleelements{x}\in \stylesets{L}}{\styleelements{y}\posAleq \styleelements{x}}{\styleelements{y}\in \stylesets{L}}
    \end{equation}
    %In formulas:
    %\begin{equation}
