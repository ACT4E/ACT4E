...
\todotext{If we want to make concrete examples, then we need more realistic numbers
than just saying ``1, 2''. Also: 1 bitcoin per pizza? I think maybe the answer
is to do one example with real things--maybe something more engineering-like,
  and then do not use units/numbers when we do all the examples for $\upit, \downit, etc.$}
