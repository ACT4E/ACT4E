...
\todotext{
    Use symbol $\subA$ for the generic subset. Change here and in the figures.
}
...
\begin{ctdefintion}[Least upper bound / join / supremum]
...
\begin{marginfigure}
    ...
    \todographics{The label $\setA$ is not near the subset. Also have brown line?Label ``upper bounds of $\setA$''.}
\end{marginfigure}
