...
Let $\setA = \{a, b, c, d, e \}$. Give examples of the following situations using Hasse diagrams. In each case, provide a poset structure on $\setA$ and a subset $\setB \subseteq \setA$ such that:
\begin{enumerate}
