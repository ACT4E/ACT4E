...
Let $\setA = \{1, 2, 3, 4, 5 \}$. Give examples of the following situations using Hasse diagrams. In each case, provide a poset structure on $\setA$ and a subset $\setB \subseteq \setA$ such that:
\begin{enumerate}
