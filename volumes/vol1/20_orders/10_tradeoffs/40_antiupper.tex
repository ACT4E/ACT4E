...
\begin{solution}
    ...
    So we know that at least~$\posetheight(\posA\times \posB)\geq \posetheight(\posA)+\posetheight(\posB)-1$.
...
\todographicsjira{73}{@Gioele: pictures and examples for width/height of posets}
