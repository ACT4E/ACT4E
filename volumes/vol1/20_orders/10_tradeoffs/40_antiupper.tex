...
\begin{figure*}[h!]
  ...
  \end{center}
  \caption{The upper closure of a singleton set of battery choices. \todographics{left is redundant. Add
...
\begin{figure*}[h!]
  ...
  \end{center}
  \caption{The upper closure of a set of battery choices. \todographics{left is redundant. Add
  example of a continuous curve.} }
