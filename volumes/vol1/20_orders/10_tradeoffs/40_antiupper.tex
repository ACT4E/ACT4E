...
\end{lemma}
\begin{proof}
    Consider the posets~$\tupp{\posPA,\subseteq}$ and~$\tupp{\setOfUppersets \posA,\supseteq}$, and $\stylesets{S_1}\com \stylesets{S_2}\in \linebreak[1] \posPA$.
...
\begin{figure*}
    ...
    \todographics{@Gioele: Divide in different files to align better}
\end{figure*}
...
\begin{figure*}[h!]
    ...
    \todographics{@Gioele: Divide in different tikz to align better.}
\end{figure*}
