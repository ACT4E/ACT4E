...
In the example of battery choices, \todotext{Which example?} first, consider the upper closure of a single element of the poset, for instance~$\posAel_1=\tupp{\unit[10]{\standardcurrency},\unit[500]{g}}$ (\cref{fig:upperclosure_1}, left).
...
\begin{figure*}[h!]
    ...
    \todographics{In the panel right, highlight the set $\subA$}
\end{figure*}
...
\begin{figure*}[h!]
    ...
    \todographics{@Gioele: In the panel right, highlight the set $\subA$}
