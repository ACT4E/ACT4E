...
\begin{definition}[Upper bounds in a poset]
    The \emph{upper bounds} of a subset~$\setA$ of a poset~$\posA$ are, if they exist, the elements which dominate all elements in~$\setA$.
    The \emph{least upper bound}, if it exists, is the least among the upper bounds of~$\setA$. This is also called \emph{join}, \emph{supremum}, or~$\vee \setA$.
\end{definition}
...
\begin{example}
    Least upper bounds need to exist even in total orders. For instance,
    \begin{equation*}
...
\begin{definition}[Lower bounds in a poset]
    ...
    The \emph{greatest lower bound}, if it exists, is the greatest among the lower bounds of~$\setA$. This is also called \emph{meet}, \emph{minimum}, or~$\wedge \setA$.
\end{definition}
