...
In a Hasse diagram elements are points, and if~$\ela \posAleq \elb$ then~$\ela$ is drawn lower than~$\elb$ and with an ege connected to it, if no other point is in between.
