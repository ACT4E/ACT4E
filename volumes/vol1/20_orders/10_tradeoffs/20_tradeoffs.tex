...
\begin{definition}[Totally ordered set]
    ...
    A partially ordered set~$\posA = \tupp{\posAset,\posAleq}$ is a \emph{totally ordered set} if the relation~$\posAleq$ is \emph{total}. In other words, if:
    \begin{equation}
...
\end{exercise}
\begin{solution}
    \todotextjira{291}{@Marius : write solution}
\end{solution}
