...
\todotext{JL: The first part of the example/figure mentioned above is incorrect, and needs to be changed (the left-most red dot is not an upper bound). I think we can just take $\setA$ to be a different set, namely the three points on the lower left-hand side.}
