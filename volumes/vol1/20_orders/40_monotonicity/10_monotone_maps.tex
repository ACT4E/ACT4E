...
E.g. generalization of "non-decreasing" and "non-increasing" from real numbers to partial orders}
...
\begin{definition}[Monotone map]
    ...
    \begin{equation}
        \prftree[r]{.}{\posAel_1 \posAleq \posAel_2 }{\mapa(\posAel_1) \posBleq \mapa(\posAel_2)}
...
\begin{definition}[Antitone map]
    ...
    \begin{equation}
        \prftree[r]{.}{\posAel_1 \posAleq \posAel_2}{\mapa(\posAel_1) \posgeq_\posB \mapa(\posAel_2)}
        %\posAel_1 \posAleq \posAel_2 \quad \Imp \quad \mapa(\posAel_1) \posBleq \mapa(\posAel_2).
    \end{equation}
\end{definition}
...
\begin{comment}
    ...
    \begin{equation*}
        \prftree[double line]{\posAel \posleq_\posA \posBel}{\mapa(\posAel) \posleq_\posB \mapa(\posBel)}
...
\devel{
    ...
    \devel{
        \begin{figure}[h!]
            \todographicsjira{81}{@Gioele: add picture}
            \caption{}
            \label{fig:unit_manufacturing}
        \end{figure}
        
        \begin{figure}[h!]
            \todographicsjira{82}{@Gioele: add picture}
            \caption{}
...
\begin{example}[Rounding functions]
    ...
    \todographicsjira{84}{@Gioele: Add picture with 3 functions}
\end{example}
...
\begin{proof}
    ...
    \begin{equation}
        \prftree[double line][r]{.}{\posAel_1\posAleq \posAel_2}{\posAel_1=\posAel_2}
        %\posAel_1\posAleq \posAel_2 \iff \posAel_1=\posAel_2.
    \end{equation}
    Therefore, one has
    \begin{equation}
        \prftree[r]{.}{\posAel_1\posAleq \posAel_2}{\prftree{\posAel_1=\posAel_2}{\prftree{\mapa(\posAel_1)=\mapa(\posAel_2)}{\mapa(\posAel_1)\posBleq \mapa(\posAel_2)}}}
    \end{equation}
\end{proof}
