...
\section[The category \Pos]{The category~\Pos of posets and monotone maps}
...
\todojira{85}{WAndrea: Rewrite this without assuming we know what is a design problem.}
...
\begin{example}[Battery]
    ...
    Conversely, in the other direction, the map that answers the question: ``Given a certain mass, what is the maximum capacity that can be provided?'' is also a monotone map.
\end{example}
...
\todotext{@Gioele: \GZ{Check with JL what he means.}}
