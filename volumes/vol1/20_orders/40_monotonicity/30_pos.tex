...
In this section, we want to abstract the concept of poset and describe a category in which the objects are posets themselves, and the morphisms are monotone functions between them. We call this category~\Pos.
...
\todojira{85}{Rewrite this without assuming we know what is a design problem.}
