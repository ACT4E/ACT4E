...
\end{equation}
    So, for example, ~$(\mapa \funcprod \mapb)(\tup{2,5})=\tup{2^2,5+1}=\tup{4,6}$.
\end{example}
...
\quad \quad  \text{ and } \quad \quad 
    ...
    \begin{equation}
        ...
        \end{aligned}
    \end{equation}
    So, for example, $(\mapa \funcsum \mapb)(\tup{1,2})=\tup{1,\mapa(2)}=\tup{1,2^2}=\tup{1,4}$ and~$(\mapa \funcsum \mapb)(\tup{2,-3})=\tup{2,\mapb(-3)}=\tup{2,(-3)^3}=\tup{2,-27}$.
\end{example}
