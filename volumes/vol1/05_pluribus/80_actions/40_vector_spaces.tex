...
\begin{ctdefinition}[Real vector space]
    ...
    \begin{body}
        ...
        \begin{enumerate}
            ...
            \item Scalar multiplication is a left action of the ring $\mathbb{R}$:
                  \begin{enumerate}
...
\todotext{J: I'm starting to think that the speak of ``left action'' is too much of a mouthful, and it seems it would be enough to speak of a ``left action'' instead, as this can still then be differentiated from an ``action'', which is the simpler, cleaner definition simply in terms of a homomorphism.}
