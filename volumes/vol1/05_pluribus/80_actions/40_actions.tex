...
This is standard way to formulate the definition. Another, equivalent way to formulate the definition is by ``currying'' the definition given above. Recall that 

\todotext{@JL: finish writing / filling in text}
