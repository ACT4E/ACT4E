...
\todotextjira{730}{POST-ALPHUBEL @J: better would be to make examples in the monoid and group sections for End(A) and Aut(A), respectively, and then reference those here.}
