...
An invertible endomorphism is called an \emph{automorphism}.
We will denote by $\Autof\setA$ the set of automorphisms of a set $\setA$.
This is naturally a group (do you see what the composition operation is?
and the identity element?), so we will also think of $\Autof\setA$ as a group!
