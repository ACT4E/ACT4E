...
they indicated that~$\lact$ is a semigroup morphism~(\cref{def:semigroup-mor}). This brings us to a more compact description of what a semigroup action is.
...
And what about contravariant actions? A contravariant semigroup action can in fact be defined as a covariant action of the opposite semigroup! And similarly for monoids and groups.
...
\todotext{Use macros/style for groups and matrices and sets}
\begin{gradedexercise}[\exname{MatrixMultAction}]
    \label{ex:MatrixMultAction}
    Let~$V = \reals^n$, and let~$G = \mgGLn$ be the group of invertible $n \cartprod n$ matrices. Let
    \begin{equation}
