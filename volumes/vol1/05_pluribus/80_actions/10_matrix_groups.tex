...
\begin{definition}
    [General linear group $\mgGLn$]\label{def:general-linear-group}
...
\begin{definition}
    [General orthogonal group $\mgOn$]\label{def:general-orthogonal-group}
...
\begin{definition}
    [\textbf{Special} linear group $\mgSLn$]\label{def:special-linear-group}
...
\end{definition}
\begin{definition}
    [\textbf{Special} orthogonal group $\mgSOn$]\label{def:special-orthogonal-group}
...
\begin{definition}
    [General Euclidean group $\mgEn$]\label{def:general-euclidean-group}
...
\begin{definition}
    [\textbf{Special} Euclidean group $\mgSEn$]\label{def:special-euclidean-group}
...
\todotext{AC: Did we define subgroup, submonoid, etc?}
