...
\todotextjira{409}{@J: NEXT RELEASE Define earlier subgroup, submonoid, so that we can use them here.
...
\todojira{610}{NEXT RELEASE: There's lots of definitions but not much synthesis.
