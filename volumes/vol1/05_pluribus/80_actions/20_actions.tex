...
\setB \to (\setA \to \setC).
\end{equation}
Applying this to $\act \colon \makecartprod{\sgrpAset, \setA} \sto \setA$ we obtain a function 
\begin{equation}
\curry(\act) \colon \sgrpAset \to (\setA \to \setA). 
\end{equation}
...
\begin{gradedexercise}[LeftActionCurry]
...
\begin{ctdefinition}
    ...
    A \emph{semigroup action operation} of a \SY{semigroup}~$\sgrpA$ on a set~\setA is a function
    \begin{equation}
    ...
    \begin{equation}
        \label{eq:lact1cond}
        \act(\monelb, \act(\monela, \setAel)) = \act(\monela \mtimesof\sgrpA \monelb, \setAel).
    \end{equation}
\end{ctdefinition}
...
\begin{ctdefinition}[Semigroup action]
    ...
    A \maindef{semigroup action} of a \SY{semigroup}~$\sgrpA$ onto a set~\setA is a \SY{semigroup} morphism
    \begin{equation}
...
\begin{ctdefinition}[Group action]
    ...
    A \maindef{group action} of a \SY{group}~$\grpA$ onto a set~\setA is a \SY{group morphism}
    \begin{equation}
        \label{eq:act-group}
