...
\devel{
    ...
    Suppose we are working with a dynamical system modeled as a monoid action of the monoid $\monA = \tup{\wnumbers, +, 0}$ on some set $\setA$, which is the ``state space''. In other words, 
