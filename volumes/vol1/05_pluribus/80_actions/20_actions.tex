...
\end{equation}
where each symbol is a command that induces a movement of ``1 square'' in the corresponding direction on the grid -- unless the movement would lead the robot to leave the grid, in which case no movement is undertaken. 
