...
\begin{example}
    ...
    Consider~$\tup{\stylesets{B},\booland}$ as in \cref{ex:bool_semigroup}, and consider~$\true$ as neutral element.
...
\begin{definition}
    ...
    Let~$\setA$ be a set.
    We denote by~$\listsof{\setA}$ set of all lists of elements of~$\setA$.
\end{definition}
