...
\begin{definition}[Monoid]
  ...
  \begin{quote}
    ...
    \begin{enumerate}
      ...
      \item a binary operation~$\mtimes  \colon \monoidAset \cartprod \monoidAset \sto \monoidAset$, called \emph{multiplication};
    ...
    \begin{enumerate}
      ...
      \monela\mtime  (\monelb\mtimes  \monelc)$;
...
%  \begin{equation} \label{eq:transition-property}
%    T_{\delta_1 + \delta_2} \then T_{\delta_3} = T_{\delta_1} \then (T_{\delta_2 + \delta_3})
%  \end{equation}
%
