...
The file format for \SY{groups} is an extension of the one for \SY{monoids} (which was an extension of the one for \SY{semigroups}).
...
\codeboilerplate{FiniteGroupRepresentation}{
    Create a function to load \SY{groups}.
}
