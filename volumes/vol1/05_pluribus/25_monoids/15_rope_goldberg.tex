...
\begin{gradedexercise}[\exname{Goldberg}]\label{ex:Goldberg}
    ...
    \begin{enumerate}
        ...
        \item It's now time to implement your discoveries. In this part of the exercise, you will implement the interface in \Cref{lst:RupeGoldbergSolver}.
