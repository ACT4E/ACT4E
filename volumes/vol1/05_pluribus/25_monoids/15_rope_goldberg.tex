...
\todo{Add remark with capacitors in electrical circuits (isomorphic example for ITET people) and temperature}
...
\begin{table}
  \begin{center}
\begin{tabular}{llll}
  Component & Spring constant (in \unit[]{[N/m]})&Length (in \unit[]{[m]})&Mass (in \unit[]{[kg]})\\
  \toprule
  ...
  Rubber & 45.0&0.2&0.3
\end{tabular}
  \caption{Spring constants for different materials. \label{tab:spring_const}}
\end{center}
\end{table}
