...
\begin{margintable}
    ...
    \todographicsjira{526}{Inconsistent color: rope/elastic is transparent, but brick and spring is not.
...
\begin{gradedexercise}[\exname{Goldberg}]
    ...
    \begin{enumerate}
        ...
        \item Assume now you are either pulling or pushing your chain, horizontally or vertically, as depicted in \cref{fig:push} and \cref{fig:pull}.
              ...
              \begin{equation}
                  \setA\definedas \{ \tup{m,l_0, \springconst_\mathrm{push},\springconst_\mathrm{pull}, c_\mathrm{max}, e_\mathrm{max}} \setin \nonNegReals^6\}.
              \end{equation}
...
\todotextjira{11}{@Gioele: part missing}
\clearpage
