...
\end{marginfigure}
\todojira{649}{J: Is it intentional that there is no mention of a start state in the above?
...
\todojira{649}{J: This equality is maybe not formally true on the nose... but maybe yes... i guess we should try to make a more precise definition?
