...
\Cref{fig:sm_min3} shows the data format to define a finite semigroup.
...
\todotext{use codeboilerplate to be concise?}
%\codeboilerplate{TestFiniteSemigroupConstruct}{
...
A \FreeSemigroup is a semigroup with the additional method \funcname{unit} that converts an element of the carrier set to an element of the free group (\eg, from element to a list with one element.)
