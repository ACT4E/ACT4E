...
\todotext{Write a few words to introduce this section?}
...
\begin{remark}
    ...
    Therefore, technically, a semigroup $\sgrpA$ is a pair~$\tup{\sgrpAset, \mtimes}$ consisting of a set~$\sgrpAset$ and a choice of composition~$\mtimes$. The set~$\sgrpAset$ is the \emph{underlying set} of the semigroup.
...
\begin{definition}
Let $\sgrpA = \tup{\sgrpAset, \mtimes, \idmon}$ be a semigroup. A \emph{subsemigroup} of $\sgrpA$ is:
...
\todotextjira{10}{POST-ALPHUBEL @J: insert something introducing a notion of “simplifying" or "computing ?
