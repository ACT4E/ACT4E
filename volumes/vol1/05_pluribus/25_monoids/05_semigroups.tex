...
\begin{example}
    ...
    \end{equation*}
    It is readily seen that concatenation satisfies the associative law, so~$\sgrpA$, together with this multiplication, forms a semigroup. It is often called \emph{free semigroup} on the set $\setA$, a terminology which we will explain later.
\end{example}
\showslides{
    \begin{forslides}
        \begin{equation}
