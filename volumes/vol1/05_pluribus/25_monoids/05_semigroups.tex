...
\begin{example}
    ...
    \end{equation}
    %
    Let~$\sgrpA^\ast$ be the set of non-empty lists of elements of~$\setA$.
    For example,
    %
    \begin{equation}
...
\begin{gradedexercise}[\exname{VariationsOnConcatenation}]
    ...
    \label{ex:alphabet}
    Consider the set~$\setA^\ast$ of finite non-empty lists of symbols from the alphabet~$\setA$, as in \cref{exa:string-semigroup}.
