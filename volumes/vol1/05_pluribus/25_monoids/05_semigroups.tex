...
\begin{definition}[Opposite semigroup]
$\sgrpA = \tup{\sgrpAset, {{\mtimes}}}$ be a \SY{semigroup}. Its \emph{opposite} $\sgrpA\op$ is the semigroup $\sgrpA\op = \tup{\sgrpAset, {{\mtimes \op}}}$ whose composition operation $\mtimes \op$ is the composite
\begin{equation}
