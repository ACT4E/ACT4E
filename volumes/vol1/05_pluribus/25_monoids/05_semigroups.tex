...
\end{example}
 ...
 \label{ex:discrete-time-linear}
  ...
  \end{definition}
\JL{The choice of notation here seems confusing. Why not take e.g. ``p'' and ``q'' as the dimensions of the input and output spaces, respectively? ``m'' and ``n'' go together in the alphabet, but not conceptually in this example, it seems.}
...
\JL{I think we want to take $[0 \ G]$ in the above, not just $G$. Similarly in the calculation below.}
