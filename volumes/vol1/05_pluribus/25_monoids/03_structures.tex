...
\todotext{Rename section "binary operations" to emphasize the key idea and deemphasize the obscure term 'magma'?}
...
\todotext{Put magma definition in constituents and conditions format.}
...
\begin{marginfigure}
    \centering
    \includesag{magma_diagram}
    \caption{The commutativity property}
    \label{fig:magma-diagram}
\end{marginfigure}

\todotext{Does Andrea want to keep or get rid of this? Maybe helpful to have here, to make clear that commutativity is not for free? Maybe we can discuss this notion here and remark that all the coming definitions may be 'commutative' or not, and in general are not, and then we are done with discussing this for the rest of the chapter?}
...
Magmas are quite general and simple.
