...
\end{equation*}
\todotextjira{549}{@Gioele: there is really no semantics to this when using drinks.
How about we use one of the color composition rules we defined already in the previous part?}
