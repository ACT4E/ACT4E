...
\chaptersecond{\statusdraft{Unos Pro Omnibus, Omnes Pro Uno}}{moschettieri}{}{
...
\todotext{I see $\ela, \elb$ as variable names, not objects. For example, it might be that $\ela=\elb$. @gioele, let's use here the generic symbol alphabet that we discussed. }
...
\input{05_semigroups}
\devel{\input{05_semigroups_exercise}}
\input{10_monoids}
