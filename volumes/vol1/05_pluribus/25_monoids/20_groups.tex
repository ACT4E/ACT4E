...
\todotextjira{501}{The $\widetilde \ginv$ notation is awkward/messy.
    Maybe use $\ginv_1$, $\ginv_2$?
}
\begin{corollary}
...
\begin{example}[Square matrices with full rank]
    ...
    \todostructure{Move this example to the section about group morphisms}
