...
\begin{gradedexercise}[Group with three elements]
...
\todotext{JL insert comment saying that the usual definition of a group looks different than the one we gave, and that this lemma explains why.}

\begin{gradedexercise}[Group inverse operation is uniquely determined by the underlying monoid]
