...
\begin{gradedexercise}[\str{GroupWithThreeElements}]\label{ex:GroupWithThreeElements}
...
\end{gradedexercise}
\instructors{
    \input{ACT4E-solutions/GroupWithThreeElements.tex}
}
...
\end{gradedexercise}
\instructors{
\input{ACT4E-solutions/GroupInverseProperties.tex}
}
