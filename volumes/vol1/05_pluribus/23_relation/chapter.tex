...
\devel{
    ...
    \todotext{@J: Note: this section is in devel because the equation mentioned eq:RelCompRule is only in devel. Remove devel here when the other is not in devel.}
}
\devel{
