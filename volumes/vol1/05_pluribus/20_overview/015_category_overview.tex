...
\begin{equation}\label{eq:colors-mixing}
...
%
\begin{widepar}
    \begin{equation}\label{eq:colors-additive}
        \middlesag{colors-additive}
    \end{equation}
\end{widepar}
\todographicsjira{480}{@Gioele: Fix alignment, somehow.
}
Green, red, blue additively make white:
\begin{equation}\label{eq:colors-additive-rgb}
...
\begin{equation}\label{eq:colors_subtractive}
    \middlesag{colors-subtractive}
\end{equation}

This is how you produce red, blue, green from CMY:
%
\begin{equation}\label{eq:colors-subtractive-rgb}
...
%
\begin{equation}\label{eq:colors-paint-over}
...
%
\begin{equation}\label{eq:colors-quoting}
...
\begin{equation}\label{eq:colors-commutativity}
...
\begin{equation}\label{eq:colors-associativity}
    \middlesag{colors-associativity}
\end{equation}

It is easy to see that this is valid for Lego composition.
\begin{equation}\label{eq:colors-assoc-legoa}
    \middlesag{colors-assoc-lego_1}
\end{equation}
\begin{equation}\label{eq:colors-assoc-legob}
...
% 
\begin{equation}\label{eq:color-and-shape}
...
\begin{equation}\label{eq:lego_world_red}
    \middlesag{lego_world_red}
\end{equation}
%
and
%
\begin{equation}\label{eq:lego_world_white}
...
% 
\begin{equation}\label{eq:knot_material}
...
\todographics{There was a picture from an old rope trick magic book that was in the slides.}
\begin{exercise}
...
\begin{solution}
    ...
    Therefore, the rope $$\rope{ropecola}{ropecolb}{2}{0}{0}{1}{$1$}$$ in the first theory describes a physical rope of length $1$, while the rope $$\rope{blue}{blue}{2}{0}{0}{1}{1}$$ in the second theory describes a rope of length $1+2k$.
