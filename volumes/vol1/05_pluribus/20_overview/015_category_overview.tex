...
\todographics{This not possible to be done yet. Very important: the quoting (shadowed box).
Maybe we should use banana/apple here. }
...
\todotext{Describe this part better.}
...
\todographics{Really need to have quoting here, otherwise it is not readable.}
...
\todographics{Not done in TikZ yet}
\begin{center}
\includegraphics[width=0.45\textwidth]{account}
\end{center}

One first attempt would be to call $k$ the extra rope for the know, and have rules like \cref{eq:rope-k}: from $a + k$ and $k + b$ we obtain a piece of rope of $a+b$.
% 
\begin{equation}\label{eq:rope-k}
