...
\todographics{@Gioele: In principle I would like to treat all the diagrams as equations using \str{equationsag}.
However, for these four: colors-mixing, colors-additive, colors-additive-rgb, colors-subtractive, I cannot do it because they use tabular and then I had to use \str{includesag}.}
...
\begin{table*}[p]
    ...
    \todographics{@Gioele: Add some padding to the fbox. Now it's too close to material.}
