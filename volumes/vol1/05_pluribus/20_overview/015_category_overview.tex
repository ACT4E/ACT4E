...
If we have a red-white-blue brick, we can also recover
the single bricks.
...
\todographics{@Gioele: We should use different placeholders than dotted boxes - colors too hard to distinguish.
Maybe square, circle, rectangle? (with A,B,C noted next to them?)}
...
\begin{table*}[p]
    ...
    \todographics{@Gioele: Add some padding to the fbox.
Now it's too close to material.}
