...
\end{remark}
\todographics{@Gioele:
    Let's not use fruit here. Maybe something with semantics?
...
\begin{example}
    ...
    \todographics{This is a horrible visualization for a morphism. Draw it like we would draw a functor?}
\end{example}
