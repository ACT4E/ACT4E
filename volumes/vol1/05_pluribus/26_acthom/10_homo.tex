...
\begin{gradedexercise}[\str{IsoViaTables}]\label{ex:IsoViaTables}
...
\end{gradedexercise}
\instructors{
\input{ACT4E-solutions/IsoViaTables.tex}
}
...
\begin{gradedexercise}[\str{CharacterizeSemigroupIsos}]\label{ex:CharacterizeSemigroupIsos}
  \label{ex:semi-morph}
...
\end{gradedexercise}
\instructors{
\input{ACT4E-solutions/CharacterizeSemigroupIsos.tex}
}
