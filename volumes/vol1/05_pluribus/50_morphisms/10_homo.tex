...
\begin{gradedexercise}[\exname{IsoViaTables}]\label{ex:IsoViaTables}
...
\begin{gradedexercise}[\exname{CharacterizeSemigroupIsos}]\label{ex:CharacterizeSemigroupIsos}
  \label{ex:semi-morph}
