...
\showslides{%
    \begin{forslides}
        ...
        \begin{equation}
            \label{eq:funccomp1}
            \prftree{\mora \colon \setA \sto \setB}{\morb \colon \setB \to \setC}{\mora \mthen \morb : \setA \sto \setC}
        \end{equation}
        %
        \begin{equation}
            \label{eq:funccomp2}
            \prftree{\mora \colon \setA \sto \setB}{\morb \colon \setB \to \setC}{\morb \after \mora : \setA \sto \setC}
        \end{equation}
        %
        \begin{equation}
            \label{eq:funccomp3}
