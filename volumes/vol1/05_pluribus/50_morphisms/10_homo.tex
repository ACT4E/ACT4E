...
\begin{gradedexercise}[\exname{TraceAndDeterminant}]
    ...
    Let~$\realsnn$ denote the set of real~$n \times n$ matrices.
    These form a monoid~$\tupp{\realsnn\com \cdot, \idmat}$, with matrix multiplication as composition, and the identity matrix as neutral element.
    They also form a monoid $\tupp{\realsnn, + , 0}$ with matrix addition as composition, and the zero matrix as neutral element.
    ...
    \begin{enumerate}
        \item Does~$\trace$ define a morphism of monoids~$\tup{\realsnn, \cdot, \idmat} \mto \tup{ \reals, \cdot, 1}$?
        \item Does~$\trace$ define a morphism of monoids~$\tup{\realsnn, \cdot, \idmat} \mto \tup{ \reals, + , 0}$?
        \item Does~$\deter$ define a morphism of monoids~$\tup{\realsnn, \cdot, \idmat} \mto \tup{ \reals, \cdot, 1}$?
        \item Does~$\deter$ define a morphism of monoids~$\tup{\realsnn, \cdot, \idmat} \mto \tup{ \reals, + , 0}$?
        \item Does~$\trace$ define a morphism of monoids~$\tup{\realsnn, +, 0} \mto \tup{ \reals, \cdot, 1}$?
        \item Does~$\trace$ define a morphism of monoids~$\tup{\realsnn, +, 0} \mto \tup{ \reals, + , 0}$?
        \item Does~$\deter$ define a morphism of monoids~$\tup{\realsnn, +, 0} \mto \tup{ \reals, \cdot, 1}$?
        \item Does~$\deter$ define a morphism of monoids~$\tup{\realsnn, +, 0} \mto \tup{ \reals, + , 0}$?
    \end{enumerate}
