...
\begin{gradedexercise}[\exname{MorphismMonoidIsomorphism}]
    Prove: a \SY{morphism of monoids}~$\funa\colon \monoidA \fto \monoidB$ is an isomorphism of \SY{monoids} if and only if the function~$\funa\colon \monoidAset \sto \monoidBset$ is \SY{bijective}.
\end{gradedexercise}
