...
\end{minted}
%
where \fieldname{source} and \fieldname{target} are representations of \SY{semigroups}/\SY{monoida}/\SY{groups}, and \fieldname{mapping} is the representation of a \classname{FiniteMap}.
