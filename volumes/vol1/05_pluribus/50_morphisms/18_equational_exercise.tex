...
\end{minted}
%
where \fieldname{source} and \fieldname{target} are representations of semigroups/monoid/groups, and \fieldname{mapping} is the representation of a \classname{FiniteMap}.
