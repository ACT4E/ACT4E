...
The fields \fieldname{source} and \fieldname{target} are two sets. These are expressions that you can pass to the set constructors you developed previously.
...
\begin{codeexercise}[\exname{FiniteMapRepresentation}]
