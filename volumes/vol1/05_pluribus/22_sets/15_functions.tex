...
\end{exercise}
\begin{solution}
    \todotextjira{341}{@Gioele: Write solution to inverse-is-unique}
\end{solution}
...
\end{exercise}
\begin{solution}
    \todotextjira{342}{@Gioele: Write solution to bijective=isomorphism}
\end{solution}
...
\todo{Not using the symbols for singleton}
