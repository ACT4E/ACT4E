...
\todotext{@J: Add some subsections to this section to make it easy to navigate.}
...
\todotext{@J: Shouldn't we call them domain and codomain?}

\todotext{@J: We never explained what ``!'' means in \cref{eq:function-determinism} }
...
\todotext{@J: We never explained the meaning of $\backslash$ in  $\reals \backslash \{ 0 \}$}
...
Recall that~$\mapa$ is said to be \emph{\iindex{injective}} if the condition
\begin{equation}
