...
\todo{make comment that we'll usually use the ``standard'' notation for functions, and not think in terms of the formel def}

\todo{remark that the formal def can be helpful for thinking about special cases involving the empty set}

\todo{say and give examples for different ways to define functions (e.g. exponential function defined by properties/equations!)}


\todo{define image and preimage of a function}
