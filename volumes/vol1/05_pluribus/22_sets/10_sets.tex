...
\todographics{@Gioele: Why don't we use happy symbols here rather than the bland $\{ +, -, ?, @ \}$? Like banana, apple.}
...
\todographicsjira{3}{insert figure}
...
\begin{equation*}
    x \in \setA \quad \implies  x \in \setB.
\end{equation*}
\todotextjira{354}{@Gioele: [multi] Use sequent notation rather than $\implies$}
...
\end{equation*}
\todotextjira{354}{@Gioele: [multi] Use sequent notation}
...
\subsection{Ordered pairs}\label{sub:ordered-pairs}
...
\devel{
    \todojira{1}{There is a break in content here; it will be filled/bridged}
