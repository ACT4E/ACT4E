...
There is an interesting special case of this way of constructing subsets of a set~$\setB$: what if, for a given statement~$S(x)$, \emph{none} of the elements~$x \in \setB$ are such that~$S(x)$ is true?
