...
\todographicsjira{380}{@Gioele: Why don't we use happy symbols here rather than the bland $\{ +, -, ?, @ \}$? Like banana, apple.}
...
\todographicsjira{3}{@Gioele: insert figure about sets}
...
\begin{equation*}
    \prfdouble{\setA = \setB}{{\setA \subseteq \setB}\quad{\setB \subseteq \setA}}
\end{equation*}
...
\begin{equation*}
    \subA \cup \subB \coloneqq \{ \ela \in \setA \mid \ela \in \subA \text{ or } \ela \in \subB \}
\end{equation*}
and
\begin{equation*}
    \subA \cup \subB \coloneqq \{ \ela \in \subA \text{ and } \ela \in \subB \}.
\end{equation*}
