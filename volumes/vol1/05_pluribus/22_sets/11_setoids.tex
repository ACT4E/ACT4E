...
\begin{itemize}
    \item \emph{Elements are opaque}: We never specify any interface for elements.
          ...
          However, this is for a beginner i counter-intuitive, and goes against to beginner's advice in object-oriented languages, where a \classname{Dog} is an \classname{Animal} that \funcname{barks}.
