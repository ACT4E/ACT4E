...
However, in \SY{category theory}, we look at the ``essence'' of things, and we consider \textbf{what is true regardless of conventions}.
...
Just like this book is written in rather plain English, and could be translated to another language while preserving the meaning, in \SY{category theory} we look at what is not changed by a 1:1 translation that can be reversed.
...
\end{equation}
(A bit more advanced \SY{category theory} can describe this transformation more precisely.)
...
\todographics{\alphubel: @Gioele: Need red arrows, red points in these figures.}
\begin{figure}[h!]
    \centering
    \begin{tabular}{c}
