...
\todographics{We should not have here the currencies in red bold. There is no way 
around it: need to have two different commands for each currency, one 
as category and object and one without.}
