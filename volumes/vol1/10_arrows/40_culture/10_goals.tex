...
\todotextjira{42}{@Andrea: Lots of things missing from presentation}
...
For example, there is a currency exchanger that, given 1 \usd, will give you back 2 \usd; there is one currency exchanger that corresponds to converting \usd  to \chf back and forth 21 times before getting you the money.
