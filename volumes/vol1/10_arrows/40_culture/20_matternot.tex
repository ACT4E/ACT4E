...
\begin{figure}[h!]
    \includegraphics[width=10cm]{veni-vidi-vici}
\end{figure}
\todographicsjira{544}{@Gioele: Redo vector image}

Sometimes, the meaning is in the typography, as in Apollinaire's poem ``Po\`eme \`a Lou''.
\begin{figure*}[h!]
    \includegraphics[width=15cm]{apollinaire}\hfill\hfill
\end{figure*}
\todographicsjira{543}{@Gioele: Redo vector image}
