...
\devel{
    \begin{figure}
        \includegraphics[width=6cm]{veni-vidi-vici}
    \end{figure}
    \begin{figure*}
        \includegraphics[width=8cm]{apollinaire}
    \end{figure*}

    \begin{figure}
        \includegraphics[width=6cm]{transform1}
    \end{figure}
...
\begin{figure}[h]
    \includegraphics[width=10cm]{isomorphic}
    \todographicsjira{434}{Redo isomorphic in tikz}
...
\section{Diagrams conventions don't matter}
