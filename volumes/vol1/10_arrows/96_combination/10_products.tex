...
\todotext{The simbol $\phi$ should be macrod and blued.}
...
\begin{gradedexercise}[\exname{PosetProductCategorical}]
    Prove that the product poset~$\posA \Ctimes \posB$ ``is'' the categorical product of~\posA and~\posB within the category~$\Pos$ of \SY{posets} and \SY{monotone maps}.
\end{gradedexercise}
