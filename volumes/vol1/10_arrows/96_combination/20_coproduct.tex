...
\begin{example}
    ...
    \begin{figure*}[tbh]
        ...
        \todographics{\alphubel: @Gioele: use proper macro rather than $\iota$ in figure.
            Also, this diagram should be ``the other way around'' such that the "test object" (prices) are at the top, so that it matches our diagram in the definition of coproduct.
        }
