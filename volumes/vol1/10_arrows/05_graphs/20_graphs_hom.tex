...
\begin{definition}[Graph homomorphism]
    ...
    \begin{equation*}
        (\funamor \mthen \source_2)(\arc)=(\source_1\mthen \funaob)(\arc), \quad \forall \arc\setin \arcs_1,
    \end{equation*}
    and
    \begin{equation*}
        (\funamor \mthen \target_2)(\arc)=(\target_1\mthen \funaob)(\arc), \quad \forall \arc\setin \arcs_1.
    \end{equation*}
    %\begin{equation}
