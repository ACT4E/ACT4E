...
\footnote{
    ...
    \begin{equation*}
        \arcs \subseteq \{ \tup{\vertexa, \vertexb} \mid \tup{\vertexa, \vertexb} \setin \vertices \cartprod \vertices \text{ and } \vertexa \neq \vertexb\}.
    \end{equation*}
    The following constructions in this chapter can be adapted for this definition too.
}
