...
\begin{exercise}\label{ex:alphabet}
...
\end{exercise}
\begin{solution}
  \todotext{Solution of \cref{ex::alphabet}.}
\end{solution}
...
\begin{exercise}\label{ex:max-semigroup}
...
\end{exercise}
\begin{solution}
  \todotext{Solution of \cref{ex::max-semigroup}.}
\end{solution}
...
\end{exercise}
\begin{solution}
  \todotext{Solution of \cref{ex::non-isomorphic}.}
\end{solution}
...
\end{exercise}
\begin{solution}
  \todotext{Solution of \cref{ex::semi-morph}.}
\end{solution}
