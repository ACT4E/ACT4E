...
\begin{definition}[Monoid]
  \label{def:monoid}
  A \emph{\iindex{monoid}} is a set~$\monoidA$ with a binary operation~$\mtimes \colon \monoidA \cartprod \monoidA \sto \monoidA$, and a \emph{neutral element}~$\idmon\in \monoidA$, which satisfy:
  \begin{enumerate}
