...
We can generalize them by allowing non-linear functions, so to have
...
\begin{solution}
    ...
    \end{publictodo}
    \todotextjira{60}{@Gioele: write solution / definition of More Machines. Actually maybe remove as an exercise and make it part of the text.}
\end{solution}
