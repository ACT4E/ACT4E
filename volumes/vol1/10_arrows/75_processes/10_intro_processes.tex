...
We can generalize them by allowing non-linear functions. We call these \textbf{Moore} machines, and describe them as:
%
\begin{equation}
    \label{eq:moore-1}
    \begin{cases}
...
\end{equation}
such that~$\prout_{\mora} \subseteq \prin_{\morb}$. \todo{J: this subset business here is not a good idea I would say. We want our morphisms to have clearly specified sources and targets, and for composition we want things to match up.}
...
\begin{solution}
    ...
    \todotextjira{393}{@Gioele: To adjust given the new signature we gave.
    }
    \begin{widepar}
        \begin{equation*}
