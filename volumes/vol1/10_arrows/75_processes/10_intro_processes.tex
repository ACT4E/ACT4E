...
\todojira{167}{Review the full chapter}
...
\todotextjira{56}{Enrich the whole text above, too schematic.}
...
\todographicsjira{57}{check graphically}


\section{Other machines}
\todotextjira{58}{Need much more description of all possible machines.}
...
\todotextjira{59}{Enrich text, using descriptions from lecture}
