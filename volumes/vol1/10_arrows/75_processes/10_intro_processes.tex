...
\todo{J: this subset business here is not a good idea I would say.
    We want our morphisms to have clearly specified sources and targets, and for composition we want things to match up.
}
...
\todotextjira{60}{@Gioele: write definition of More Machines.}
    ...
    \begin{definition}[\More]
        ...
        \begin{enumerate}
            ...
            \item \emph{Morphisms:}
                  ...
                  where:
                  \begin{itemize}
                      \item $\prin_{\mora}$,~$\prst_{\mora}$,~$\seqsof{\prout_{\mora}}$ are objects of \SetL;
                      \item $ \prdyn_{\mora} \colon \prin_{\mora} \mtoin\SetL  \Endof{\prst_{\mora}}$;
                      \item $ \prreadout_{\mora} \colon \prst_{\mora}  \mtoin\SetL \seqsof{\prout_{\mora}}$.
                  \end{itemize}
            \item \emph{Composition of morphisms:}
...
\todojira{587}{Example of More: each input is duplicated}
\todojira{588}{Example of More: discard every other input}
\todojira{589}{Example of More: Composition of duplicator and discarder gives identity}
\todojira{591}{Define the terminator}
