...
\begin{definition}[\Moore]
    ...
    \begin{enumerate}
        ...
        \item \emph{Morphisms:} A morphism is a tuple
              ...
              \end{itemize}
        \item \emph{Composition of morphisms:} Composition is given by \cref{eq:moore-comp-good-1,eq:moore-comp-good-2,eq:moore-comp-good-3}.
    \end{enumerate}
\end{definition}
...
\begin{solution}
    ...
    \todotext{@Gioele: To adjust given the new signature we gave.}
    \begin{widepar}
        \begin{equation*}
