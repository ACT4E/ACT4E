...
The culprit for associativity failing is the \SY{cartesian product} that we use to define the state space $\prst_{\mora} \cartprod \prst_{\morb}$ of a composite Moore machine $\morab$.
