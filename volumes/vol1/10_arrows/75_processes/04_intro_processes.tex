...
The reason we wish it \emph{were} \SY{associative} is that Moore machines would then form a \SY{semicategory}, and we could integrate them nicely into the mathematics we have been developing thus far.
...
This construction will allow us to make a new, modified formalization of Moore machines which form a bona fide \SY{semicategory}, and it will prove useful in other respects further down the road.
