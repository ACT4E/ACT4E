...
One of the objects of \SetStar is the empty list of sets, the monoid unit $\idmon$. This set contains only one element: the empty tuple. It is not the empty set. 
