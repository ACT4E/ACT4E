...
\end{equation}
%
\todojira{590}{Adjust the definition as discussed}
...
\todojira{583}{Define and explain the functor from \SetL to \Set (use strictification argument as JL mentioned)}
