...
%\begin{equation}
%( \cohm_{\setLA, \setLB} \times \catid_{ \tupset(\setLC) }) \mthen \cohm_{\setLA \listconcat \setLB, \setLC} = 
% (\catid_{ \tupset(\setLA) } \times  \cohm_{\setLB, \setLC}) \mthen \cohm_{\setLA, \setLB  \listconcat\setLC}.
%\end{equation}
 \begin{center}
        \includesag{coh-isos-compat-lemma}
    \end{center}
