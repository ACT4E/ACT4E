...
\begin{widepar}
    \begin{equation}
        ...
        \begin{aligned}
            ...
            \prinel \tupconcat \prstel_{\mora} \tupconcat \prstel_{\morb} \tupconcat \prstel_\morc                                      & \mapsto \prdyn_{\mora \mthen \morb}(\prinel \tupconcat \prstel_\mora \tupconcat \prstel_\morb) \tupconcat \prdyn_{\morc}(\prreadout_{\mora \mthen \morb}(\prstel_\mora \tupconcat \prstel_\morb) \tupconcat \prstel_\morc) \\
...
Finally, we verify that~$\prreadout_{(\mora\mthen\morb) \mthen \morc} = \prreadout_{\mora\mthen (\morb \mthen \morc)}$:
\begin{equation}
