...
\begin{definition}[Moore machine, \SetL version]
    ...
    \SYNDEF{Moore machine}
    A \SY{Moore machine} is a tuple
    \begin{equation}
...
Now that we have shown that composition of Moore machines is \SY{associative} (with our new definition), we can organize Moore machines as a \SY{semicategory}.
