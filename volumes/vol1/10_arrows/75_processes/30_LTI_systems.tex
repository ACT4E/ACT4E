...
\todotext{J: in the definition of LTI below the starting state is the first entry of a tuple, while for Moore the starting state is the last -- we should choose a common convention. I'd be for having the state last.}
