...
We call this operation concatenation, and in the context of \SetL we think of it as a kind of multiplication.
...
\begin{remark}
    ...
    Indeed, both
    \begin{equation}
        ( \cObj{\setAn{1}, \ldots, \setAn{l}} \cprod \cObj{\setBn{1}, \ldots, \setBn{m}})
        \cprod \cObj{\setCn{1}, \ldots, \setCn{n}}
    \end{equation}
    and
    \begin{equation}
