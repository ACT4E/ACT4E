...
Given sets~$\setAn{1}, \setAn{2}, \ldots , \setAn{n}$, where $n \in \natnumbers$, we define
\begin{equation}
...
\begin{ctdefinition}[\SetL]
    The category \SetL is the subcategory of \Set in which the objects are the sets of the form~$\cObj{\setAn{1}, \setAn{2}, \ldots, \setAn{n}}$, for any~$n \setin \natnumbers$ and any sets~$\setAn{1}, \setAn{2}, \ldots, \setAn{n}$.
\end{ctdefinition}
\todotext{\alphubel: It is very nice to use the word subcategory here, but we haven't defined subcategories yet.
