...
\begin{example}[Discarder]
    ...
    \begin{equation}
        ...
        \end{aligned}
    \end{equation}
    and~$\prstart_\discarder = \tup{\false} \tupconcat \tup{\prstel} \in \prstL_\discarder$, for an arbitrary~$\prstel\in \prinL_\discarder$.
\end{example}

\todojira{589}{@Gioele: Example of More: Composition of duplicator and discarder gives identity action but not identity of cat}
