...
\begin{equation}
    ...
    \defmapperiodset{
        ...
        \prdyn_{\mora} (u \tupconcat x_{\mora}) \tupconcat \prdyn_{\morb}(\tupentry{y_\mora}{n} \tupconcat \prdyn_{\morb}(\tupentry{y_\mora}{n-1}  \tupconcat \dots \prdyn_{\morb}(\tupentry{y_\mora}{1} \tupconcat x_{\morb} )\dots))
    }
\end{equation}
...
\todotext{J: it doesn't seem to me like the thing mentioned in the above ToDO can even be true... }
