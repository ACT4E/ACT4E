...
\end{widepar}
\todotext{Come back later to address notation for list entries (possibly use superscripts?)}
%
...
\begin{example}[Discarder]
    ...
    \end{equation*}
    where~$\prstL_{\discarder}= \cObj{\{\false,\true\}} \cprod \prinL_\discarder$, and
    \begin{equation*}
        \begin{aligned}
            \prdyn_\discarder\colon \prinL_\discarder \cprod \cObj{\{\false,\true\}} \cprod \prinL_\discarder &\sto \cObj{\{\false,\true\}} \cprod \prinL_\discarder\\
    ...
    \begin{equation*}
        \begin{aligned}
            \prreadout_\discarder\colon \cObj{\{\false,\true\}} \cprod \prinL_\discarder &\sto \listsof{\proutL_\discarder}\\
...
\todojira{589}{Example of More: Composition of duplicator and discarder gives identity action but not identity of cat}
