...
\end{widepar}
    ...
    \end{widepar}
    %
Observe that~$\prdyn''_{(\mora \mthen \morb) \mthen \morc} =  (\catid_{\prin_{\mora}} \cartprod \alpha) \mthen \prdyn_{\mora \mthen (\morb \mthen \morc)} \mthen (\catid_{\prin_{\mora}} \cartprod \alpha)^{-1}$. 
