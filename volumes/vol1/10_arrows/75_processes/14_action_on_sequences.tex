...
\todotext{@JL: Insert a graded exercise here.}
...
\todotext{J: Idea: maybe we can model ODE solvers such as the Euler method, etc., as Moore machines and their actions?
