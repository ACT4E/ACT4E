...
\begin{lemma}\label{lem:moore-new-recursion-equations}
    The recursion equations \cref{eq:moore-new-recursion-equations} do indeed define a \SY{semicategory} action of Moore machines in the sense of \cref{def:semicategory-action}.
\end{lemma}
