...
\devel{
    ...
    \todotextjira{61}{Difference between functions and procedures. Model resources. We don't introduce type theory, say we are in FinSet.}


    \subsection{Modeling execution time}

    \todotextjira{62}{A procedure is a pair of function and of a non-negative integer. }
    ...
    \todotextjira{63}{To finish. Define composition and identities the obvious way. Prove associativity. Nice pics.}
...
%
    ...
    \end{eqnarray}
    \todotextjira{64}{To finish. Define composition and identities the obvious way.}}
