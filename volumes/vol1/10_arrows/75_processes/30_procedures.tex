...
\devel{
    ...
    \todotextjira{61}{@Andrea: Difference between functions and procedures.
        Model resources.
        We don't introduce type theory, say we are in FinSet.}
    ...
    \end{eqnarray}
    \todotextjira{64}{@Andrea: To finish.
        Define composition and identities the obvious way.}
}
