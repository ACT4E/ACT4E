...
\begin{equation}
    \funmorspace{\act} \colon \Mor_\Moore \sto \Mor_\Set \qquad \text{ and } \qquad \funobspace{\act} \colon \Ob_{\Moore} \sto \Ob_{\Set}
\end{equation}
...
\begin{ctdefinition}[Semicategory action]
    ...
    \constit
    \begin{itemize}
        \item A map~$\funobspace{\act} \colon \Ob_{\CatC} \sto \Ob_{\Set}$;
