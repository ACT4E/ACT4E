...
In this section we generalize from actions of a \SY{semigroup} to actions of a semicategory, using the example of Moore machines acting on signal sequences.
