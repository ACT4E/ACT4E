...
\end{equation}
%
\todotext{\alphubel: Wrong - we defined a path as a list of edges. A trivial path is only an empty list.
Concatenation is just list concatenation. We already proved it's associative. Very convoluted.}
