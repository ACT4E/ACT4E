...
%                    \Obja \arrow[loop right, "\mora", distance=0.5cm] \arrow[loop right,in=-30, out=30, "\mora \mthen\mora", distance=1.25cm]
%                    \arrow[loop right,in=-50, out=50, "\mora \mthen\mora\mthen \mora", distance=4cm, looseness=1]
%                \end{tikzcd}
%            };
%        \end{tikzpicture}
%        \caption{Category with one object and one morphism}
...
\bigyamlcolstikz{cat_Zero}{A category with zero objects.}

\seprule

\bigyamlcolstikz{cat_single}{A category with one object, no morphisms.}

\ifextraspace{\vfill\pagebreak}


\bigyamlcolstikz{cat_One}{A category with one object and its identity.}

\bigyamlcolstikz{cat_fgh_notsame}{
