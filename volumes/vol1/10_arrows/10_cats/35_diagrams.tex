...
These are a different visual tool for reasoning ``diagrammatically'' about situations in \SY{category theory}.
...
This is technically a true statement, however it does not emphasize the key point that, in \SY{category theory}, we are often interested in comparing composite morphisms which might turn out to be equal, or not.
