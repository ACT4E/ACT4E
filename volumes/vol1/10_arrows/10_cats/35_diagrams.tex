...
Diagrams of this kind are usually used as a tool to speak and think about specific situations, where one is focusing on \emph{certain} objects and morphisms of a given (semi)category (and not \emph{all} the objects and morphisms).
...
\begin{gradedexercise}[\exname{InventingCommDiagrams}]
    \label{ex:InventingCommDiagrams}

    Come up with three different examples of a commutative diagram in the category of sets and functions.
    In each example, be sure to define clearly all of the functions involved.

\end{gradedexercise}

\solutionof{InventingCommDiagrams}
