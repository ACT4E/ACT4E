...
By the \SY{associative law} for semicategories, however, we know that~$(\morab) \mthen \morc = \mora \mthen (\morb \mthen \morc)$;
...
\begin{remark}
    When drawing a diagram in a category (as opposed to just a semicategory), we usually do not draw the \SY{identity morphisms}.
