...
\section{Formal definition of (semi) category}
...
\todostructure{The following should be moved to the chapter about sets and functions where we use $\then$ already for functions}
\begin{remark}
