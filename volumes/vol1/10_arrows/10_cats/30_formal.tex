...
A monoid is a semigroup that additionally has an identity element, and similarly a category is a semicategory that additionally has \SY{identity morphisms}.
...
This is analogous to how the identity element of a monoid ``does nothing'' when we multiply it with other elements of the \SY{monoid}.
...
\begin{remark}
    ...
    To see this, observe that~$\HomSet{\CatC}{\Obja}{\Obja}$ is a \SY{semigroup}, and~$\catidat\Obja$ is a neutral element for this \SY{semigroup}, making~$\HomSet{\CatC}{\Obja}{\Obja}$ a \SY{monoid}.
...
\begin{ctdefinition}[Category]
    ...
    A \emph{\iindex{category}}~\CatC is a semicategory in which there is an \SY{identity morphism} for every object.
\end{ctdefinition}
...
\todojira{667}{\alphubel: @JL: Fill this section on semicategories.
...
\begin{gradedexercise}[\exname{CategorySemigroups}]
    There is a category where the objects are \SY{semigroups} and the morphisms are semigroup homomorphisms.
...
\showslides{
    \begin{forslides}
        ...
        \begin{equation}
            X = \makeset{ \sprout, \yng, \mature, \old, \dead }
        \end{equation}
        ...
        %                       \mora \colon \Obja \mto \Objb.
        %                   \end{equation}
        %             \item Identity morphisms: for each object~$\Obja$, there is a morphism~$\catidat\Obja\colon \Obja \mto \Obja$  called \emph{the identity morphism of~$\Obja$}.
        ...
        %                   \begin{equation}
        %                       \catidat\Obja \mthen \mora = \mora \qqand \mora \mthen \catidat\Objb = \mora.
        %                   \end{equation}
        %         \end{enumerate}
        %     \end{body}
        % \end{ctdefinition}
