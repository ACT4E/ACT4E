...
\todotext{J: Maybe make an example here where morphisms are taxi trips and their costs, calculated as an initial fee, plus a rate for time and kilometers each. There are no identity morphisms because any trip incurs a non-zero cost.}
