...
We begin to introduce the concept of a \SY{semicategory} by listing key aspects of the electrical cords example in th4e previous section which each correspond to a part of the formal definition of \SY{semicategory}.

\subsection{Constituents: objects, morphisms, composition}

Firstly, in the chords example, we have a set of types of electrical interfaces.
In a \SY{semicategory}, the things that play the role of types of interfaces are called \emph{objects}.
...
\subsection{Condition: associativity}
