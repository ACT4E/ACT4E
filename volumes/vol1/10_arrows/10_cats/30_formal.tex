...
\begin{ctdefinition}[Semicategory]
    ...
    \begin{body}
        ...
        \begin{enumerate}
            ...
            \item \label{def:hom-set} Morphisms: For every pair of objects~$\Obja,\Objb$ in $\ObC$, there is a set called a ``hom-set'' and indicated as~$\HomSet{\CatC}{\Obja}{\Objb}$, elements of which are called \emph{morphisms} and denoted $\mora \colon \Obja \mto \Objb$.
