...
\begin{ctdefinition}[Identity morphisms]\label{def:identity-morphism}
	...
	\end{equation}
	that is an identity for composition with all other compatible morphisms in the category:
	\begin{equation}
		\prfperiod{
			\mora \colon \Obja \mto \Objb
		}{
...
\begin{ctdefinition}[Category]
	...
	A \emph{\iindex{category}}~\CatC is a semicategory in which there is an identity at every object.
\end{ctdefinition}
