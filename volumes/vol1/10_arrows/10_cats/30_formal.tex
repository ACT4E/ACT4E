...
Our notation for composition of~$\mora$ and~$\morb$ is~$\mora \mthen \morb$, read ``$\mora$ then~$\morb$''.
    ...
    \begin{body}
        ...
        \begin{enumerate}
            ...
            \item Composition operations: For every three objects~$\Obja,\Objb,\Objc$ in~$\ObC$ there is a composition map
                  \begin{equation}
                      \mthenof{\Obja,\Objb,\Objc}\colon \HomSet{\CatC}{\Obja}{\Objb} \times \HomSet{\CatC}{\Objb}{\Objc}\mto \HomSet{\CatC}{\Obja}{\Objc}.
                  \end{equation}
...
\begin{remark}
    If an identity morphism~$\catidat\Obja$ for an object~$\Obja$ exists, then it is unique.
    To see this, observe that~$\HomSet{\CatC}{\Obja}{\Obja}$ is a semigroup, and~$\catidat\Obja$ is a neutral element for this semigroup, making~$\HomSet{\CatC}{\Obja}{\Obja}$ a monoid.
