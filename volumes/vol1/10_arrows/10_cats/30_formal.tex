...
\section[(Semi-)categories]{Formal definition of (semi)category}\label{sec:formal-def-semicat}
...
\begin{ctdefinition}[Semicategory]
    ...
    \begin{body}
        ...
        \begin{compactenum}
            \item Objects: A collection\footnotemark~$\ObC$ whose elements are called \emph{objects}.
            \item Morphisms: For every pair of objects~$\Obja,\Objb$ in~$\ObC$, there exists a set~$\HomSet{\CatC}{\Obja}{\Objb}$, elements of which are called \emph{morphisms}.
            We write
            \begin{equation}
