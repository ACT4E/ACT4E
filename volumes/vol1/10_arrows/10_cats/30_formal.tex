...
\begin{remark}
    ...
    To see this, observe that~$\HomSet{\CatC}{\Obja}{\Obja}$ is a semigroup, and~$\catidat\Obja$ is a neutral element for this semigroup, making~$\HomSet{\CatC}{\Obja}{\Obja}$ a \SY{monoid}.
