...
For instance, if~$\Obja$ and~$\Objb$ are objects in a semicategory~$\CatC$, and~$\mora\colon \Obja \mto \Objb$ is a morphism, we draw this as in \cref{fig:points-and-arrow-diagram}.
And if $\morb\colon \Objb \mto \Objc$ is another morphism in $\CatC$, we depict this as in \cref{fig:points-and-two-arrows-diagram}, for example.
