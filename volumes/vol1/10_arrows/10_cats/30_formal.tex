...
\begin{remark}
    ...
    For instance, if $\Obja$ and $\Objb$ are objects in a (semi)category $\CatC$, and $\mora: \Obja \mto \Objb$ is a morphism, we draw this as in \cref{fig:points-and-arrow-diagram}.
    \begin{marginfigure}
...
\todotext{Add remark about relationship between semicategories and semigroups}
