...
\todographicsjira{383}{@Gioele: POST-ALPHUBEL Make a figure that shows a physical cable and the math representation, and another with an adapter and the math representation.}
