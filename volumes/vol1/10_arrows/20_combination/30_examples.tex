...
The diagram reported in \cref{fig:prod_coprod_prop} illustrates the structure of the proposition lattice for three elements~$\posAel,\posBel,\posCel\setin \posA$.
