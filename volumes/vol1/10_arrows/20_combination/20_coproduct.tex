...
\begin{example}
    ...
    If we choose~$\setC = \{ \sfondue \}$, we see that~$\setC \subseteq \subAn{1}$ and~$\setC \subseteq \subAn{2}$, and that also~$\setC \subseteq \subAn{1} \setunion \subAn{2}$ (as it must, according to the universal property).
