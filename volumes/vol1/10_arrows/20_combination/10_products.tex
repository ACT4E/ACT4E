...
\begin{example}
    ...
    If we choose~$\setC = \{ 2 \}$, we see that~$\setC \setsubseteq \subAn{1}$ and~$\setC \setsubseteq \subAn{2}$, and that also~$\setC \setsubseteq \subAn{1} \setintersection \subAn{2}$ (as it must, according to the universal property).
