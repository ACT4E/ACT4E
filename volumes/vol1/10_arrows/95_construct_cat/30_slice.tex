...
\label{def:slice-category}
    ...
    Let \CatC be a category and fix an object $\slicetarget \in \Ob_\CatC$. The \maindef{slice category} $\sliceCat{C}{\slicetarget}$ \emph{of} $\CatC$ \emph{over} $\slicetarget$ is: 
    \begin{enumerate}
...
\equationsag{slice-morphism}{eq:slice-morphism}
commutes. 
...
\label{def:coslice-category}
    ...
    Let \CatC be a category and fix an object $\coslicesource \in \Ob_\CatC$. The \maindef{coslice category} $\cosliceCat{C}{\coslicesource}$ \emph{of} $\CatC$ \emph{under} $\coslicesource$ is: 
    \begin{enumerate}
...
\equationsag{coslice-morphism}{eq:coslice-morphism}
commutes. 
