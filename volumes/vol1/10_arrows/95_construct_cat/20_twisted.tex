...
\begin{gradedexercise}[\exname{TwistedCat}]
    ...
    Let $\CatC$ be a category, and let $\TwistedArrow\CatC$ be the associated twisted arrow category. Check that the definition of $\TwistedArrow\CatC$ does indeed define a category. Specifically, check that for $\TwistedArrow\CatC$
 \begin{enumerate}
