...
\devel{
    \begin{remark}
        Recall \cref{sec:posetsarecats} and note that the map which sends a \SY{poset} (a category) to its twisted arrow category is a functor, which sends objects of the poset
