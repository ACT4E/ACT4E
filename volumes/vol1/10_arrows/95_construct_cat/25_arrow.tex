...
\begin{example}[Intervals]
    ...
    The arrow category~$\Arrow \poscat{\posA}$ is isomorphic to the \SY{poset} (viewed as a category)~$\poscat{\left(\posintbis\posA\right)}$ of nonempty \emph{intervals} in~\posA:
    \begin{equation}
...
\todotextjira{406}{\alphubel: Add remark about functor category isomorphism}
