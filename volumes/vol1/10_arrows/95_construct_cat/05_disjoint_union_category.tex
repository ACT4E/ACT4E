...
\begin{ctdefinition}[Disjoint union category]
    ...
    \begin{enumerate}
        \item \emph{Objects}: $\Ob_{\CatC\Cplus\CatD} = \ObC \setdisunion \ObD$. That is, objects are tuples of the form~$\disunionI{\Obja}$, with $i=1$ and $\Obja \setin \ObC$  or $i=2$ and~$\Obja \setin \ObD$.
