...
\begin{ctdefinition}[Disjoint union category]
    ...
    \begin{enumerate}
        \item \emph{Objects}: $\Ob_{\CatC\Cplus\CatD} \definedas \ObC \setdisunion \ObD$. That is, objects of $\CatC\Cplus\CatD$ are tuples of the form~$\disunionI{\Obja}$, with $i=1$ and $\Obja \setin \ObC$  or $i=2$ and~$\Obja \setin \ObD$.
...
\begin{exercise}
    Show that the \SYN{disjoint union of categories}{disjoint union} of two categories indeed forms a category.
\end{exercise}
