...
\begin{ctdefinition}[Cartesian product of categories]
    ...
    \begin{enumerate}
        ...
        \item \emph{Identity morphisms}: Given objects~$\Obja\setin \ObC$ and~$\Objb\setin \ObD$, the identity morphism on~$\tup{\Obja,\Objb}$ is the pair $\tup{\catidat\Obja ,\catidat\Objb}$.
