...
\AC{
    ...
    morphisms are the formulas.
    There is an object $1$ that can be the domain
...
Consider a table with columns $P \cartprod X_1 \cartprod X_2 \cartprod \cdots X_n$,
...
Therefore, a table with columns $P \cartprod X_1 \cartprod X_2 \cartprod \cdots X_n$
...
\todo{\JL{I don't see yet how the set $A$ comes into play.}}
\begin{comment}
    \begin{table*}[h]
        \centering
