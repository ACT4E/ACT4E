...
\end{equation*}
which defines a new column in our table. The composition of functions is usually written as~$\Volume = \Multiply  \after \Size $, however we stick to our convention of writing~$\Volume = \Size  \then \Multiply $. Schematically, we can represent what we did as a diagram (\cref{fig:diagram_functions}).
