...
\begin{remark}
    A \SYN{thin category}{\emph{thin} category} is one in which there is at most one morphism between any two objects.
    Categorifications of posets are examples of thin categories.
    Conversely, we can interpret any thin category as defining a poset.
\end{remark}

\begin{remark}
    Categorifications of posets are also examples of \SYN{skeletal category}{\emph{skeletal} categories}.
    These are categories where, if any two objects are isomorphic, then they are necessarily equal.
    Not every skeletal category can be interpreted as defining a poset.
    Can you see why?
\end{remark}
