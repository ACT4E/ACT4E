...
There are various simple constructions where we can build categories whose objects are not just sets, but sets together with some extra data.
Morphisms are then functions which are compatible with the extra data.
Below we give a few examples and we encourage the reader to imagine further variations.
