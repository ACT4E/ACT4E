...
\todojira{616}{POST-ALPHUBEL @JL: include / move more material on the category of relations here}
...
\todotext{POST-ALPHUBEL @JL: the above remark is a bit out on its own at the moment.
    Figure out where to place it or what it wants to say.

    \AC{This probably goes to locally posetal structure}
}
}