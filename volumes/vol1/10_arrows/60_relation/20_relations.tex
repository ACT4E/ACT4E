...
\showslides{
    \begin{forslides}
        ...
        \begin{equation}
            \relA = \{ \tup{\ela_1, \elb_1}, \tup{\ela_2, \elb_3}, \tup{\ela_1, \elb_4} \} \subseteq \setA \cartprod \setB \label{eq:slides-7}
        \end{equation}
        %
        \begin{equation}
            \relB = \{ \tup{\ela_2, \elc_1}, \tup{\ela_2, \elc_2} \} \subseteq \setA \cartprod \setB \label{eq:slides-8}
        \end{equation}
        %
        \begin{equation}
            \relA \then \relB = \{ \tup{\ela_2, \elc_1}, \tup{\ela_2, \elc_2} \} \subseteq \setA \cartprod \setB \label{eq:slides-9}
        \end{equation}
        %
        \begin{center}
