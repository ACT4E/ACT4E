...
\begin{example}
    ...
    Let~$\setA = \{ \sbretzel, \sfondue, \schoco \}$ and~$\setB = \{ \stea, \sbubtea, \swater, \swine \}$.
...
\showslides{
    \begin{forslides}
        ...
        $$\setB = \{ \stea, \sbubtea, \swater, \swine \} \label{eq:slides-2}$$
...
\begin{figure}[h!]
    ...
    \todographics{@Gioele: Make sure that this and the next figure are together (subfloat?).}
