...
%\includegraphics[width=0.5\linewidth]{pics/dist_net_10.png}
  \caption{Composition of relations.\todographics{Can you make it so the spacing is the same as the previous figure? just like the middle set disappeared. (Maybe it looks good to have the previous set appear with very low opacity)}}
