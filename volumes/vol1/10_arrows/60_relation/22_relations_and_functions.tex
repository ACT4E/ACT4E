...
\begin{marginfigure}
    ...
    \includesag{30_rel_1}
    \caption{}
    \totographics{@Gioele: maybe for this one we keept the boring symbols $a, b, c, ...$, because it is an exercise. }
    \label{fig:example_rel_again}
\end{marginfigure}

\begin{gradedexercise}[\exname{Rel3Functions}]
    \label{ex:Rel3Functions}
    For the relation $\relA$ illustrated in~\cref{fig:example_rel_again},
