...
%\end{example}
\todotext{@Gioele: horrible way to format the entries of relation. Maybe a diagram with nodes and "first level relation", then another one with transitive closure?}
\begin{example}
