...
\begin{ctdefinition}[Symmetry, asymmetry, and antisymmetry of endorelations]
...
\end{example}
\todotextjira{438}{@Gioele: very uninsteresting example.
    How about one with clear semantics?
    E.g.
    there is a party and everybody invites their friends.
    How big can the party get?
    Or: relation = two cities are connected by train.
    Where can I reach by train only?
}