...
\todotextjira{410}{@J: At this point we have already introduced relations as a category.
    We continue to say $\relA\subseteq \setA \cartprod \setB$ and we go back and forth without
    $\relA: \setA \to \setB$.
    Be consistent.
}
...
\begin{figure}[h!]
    ...
    \todographics{@Gioele: there is a double R in the figure}
    \todographics{@Gioele: split the figures in two files so that we can have them vertical}
\end{figure}
