...
In this example, there are two objects: \str{CHF} and \str{USD}. There are two identity morphisms, as well as a morphism from \str{CHF} and \str{USD}.
...
\paragraph{Hints} Here are some hints:
\begin{itemize}
...
\item  You might be needing the functionality of the \pystr{networkx} Python package. Note that there are various graph types to choose from. You likely need to use \pystr{MultiDiGraph} rather than \pystr{DiGraph}.
\end{itemize}
