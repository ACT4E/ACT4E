...
We will show how \SY{category theory} can help in formalizing the chai{}ns of causality that underlie a certain design.
...
\begin{remark}[Are we going the wrong direction?]
    ...
    In the meantime, it is a good exercise to liberate your mind about the preconception of what an arrow means; in \SY{category theory} there will be categories where the arrows represent much more abstract concepts than input/output.
\end{remark}
