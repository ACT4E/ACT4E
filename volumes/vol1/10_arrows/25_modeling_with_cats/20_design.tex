...
\begin{figure}[h!]
    ...
    \label{fig:e1}
    \todographics{\alphubel: @Gioele: points should be red, in this and other figures}
\end{figure}
...
\begin{example}
    ...
    Take the binary operation~$\mtimes$ to be the composition~$\mthen$ in~\CatC, and the neutral element to be the identity~$\catid_\Obja$.
