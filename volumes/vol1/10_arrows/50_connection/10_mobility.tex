...
\begin{example}
  ...
  Furthermore, consider the \Flight category with $\vertices_\mathrm{f}=\{\FCOf, \LIN, \MPXf, \ZRHf\}$ and arrows as in~\cref{fig:flight}. The nodes represent airports in California and the arrows represent connections, offerend by specific flight companies.
