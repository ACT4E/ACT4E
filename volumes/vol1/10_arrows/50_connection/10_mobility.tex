...
\begin{example}
  ...
  Imagine that you are in the parking lot of \ZRH airport and you want to reach \transmuted{Florence}. From there, you can onboard to a \transmuter{Swiss} flight to~$\FCOf$, will then offboard reaching the parking lot~$\FCOc$, and drive on highway \transmuter{A1} reaching \transmuted{Florence}.
