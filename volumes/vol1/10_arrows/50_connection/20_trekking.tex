...
\todotextjira{43}{Let's not assume that people know what is a manifold. This was also a questions.}
...
\todographicsjira{44}{Add a figure here. To the left a picture of a Swiss mountain, to the right a stylization
...
\todotext{@Gioele. This is not using the convention for defining categories.}
...
\todographicsjira{45}{Make a technical sketch of the manifold showing what are the velocities,
