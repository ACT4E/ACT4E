...
\todotextjira{363}{@Gioele: \AC{I am a bit confused, shouldn't the objects of the category be just
...
\end{exercise}
\begin{solution}
    \todotextjira{40}{@Gioele: Write Solution of \cref{ex:temperatures}.}
\end{solution}
