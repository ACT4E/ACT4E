...
\begin{solution}
    ...
    \begin{itemize}
        ...
        \item \emph{Morphisms:} There is a single morphism from \transmuted{e} to \transmuted{f} for any~$\transmuted{e},\transmuted{f}\setin \Ob_\Temp$, given by~$\tup{a,d}$, with~$a,d$ as in \cref{tab:temperature_conversions};
