...
\begin{solution}
    ...
    \begin{itemize}
        ...
        \item \emph{Morphisms:} There is a single morphism from \transmuted{c} to \transmuted{d} for any~$\transmuted{c},\transmuted{d}\in \Ob_\Temp$, given by~$\tup{a,d}$, with~$a,d$ as in \cref{tab:temperature_conversions};
