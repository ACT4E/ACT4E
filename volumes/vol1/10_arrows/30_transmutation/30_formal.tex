...
%a category consists of:
  \begin{compactenum}
    ...
    morphism of~$\Obja$}.
    \item \textbf{Composition rules}: given any morphism~$ { \mora} \in  \HomC(\Obja,\Objb)$ and any morphism~${ \morb} \in \HomSet\CatC\Objb\Objc$, there exists a morphism~$\mora \mthen \morb$ in $\HomSet\CatC\Obja\Objc$ which is the \emph{composition of~$\mora$ and~$\morb$}.
  \end{compactenum}
...
explicitly. For example, we can consider the composition~$\wheels \mthen \motor \mthen \dynamo \mthen \move$, which
