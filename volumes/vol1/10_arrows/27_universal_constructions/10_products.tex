...
\begin{proposition}\label{prop:prod-unique-up-to-canon-iso}
    ...
    \begin{equation}
        \begin{tikzcd}[column sep=large, every arrow/.append style={arrowmorphismstyle}]
                  & \Objc \arrow{dl}[swap]{\stylemorph{pr_1}} \arrow{dr}{\stylemorph{pr_2}}  \arrow{dd}{\stylemorph{\phi}} & \\
            \Obja &                                                                                                        & \Objb \\
                  & \Objcprime \arrow{ul}{\stylemorph{pr_1'}}[swap]{} \arrow{ur}[swap]{\stylemorph{pr_2'}}                 &
        \end{tikzcd}
    \end{equation}
    commutes.
\end{proposition}
