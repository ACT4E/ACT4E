...
\footnote{See \cref{sec:technical-terms}, where we discuss these terms briefly.}
...
\todojira{460}{Is DP the join of rel and pos when using embedding?}
\todojira{463}{Cats picture}
