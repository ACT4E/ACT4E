...
\todotext{Remove or change this section.
JL: There is not a formal definition of a ``forgetful functor''; I think this lemma doesn't make sense as stated.
We could instead state/explain how ``forgetting structure'' is often functorial, and include,  among other things, the Pos --> Set example. }
