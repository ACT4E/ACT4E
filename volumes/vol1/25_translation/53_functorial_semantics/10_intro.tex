...
To see what we mean, consider the example of \SY{Moore machines}. A way to specify a \SY{Moore machine}, according to our \cref{def:moore-machine}, is to specify a tuple of the form \cref{eq:moore-machine-specification}.
