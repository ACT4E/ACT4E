...
\section{An example}
\todojira{143}{
    An example of a Galois connection between functionalities and resources could be treated here to motivate the adjunction discussion}
...
Suppose~$V$ and~$W$ are finite-dimensional real vector spaces, equipped with inner products~$(-, -)_V$ and~$(-, -)_W$, respectively.
...
\begin{ctdefinition}[Adjunction, Version 1]
    ...
    An \emph{\iindex{adjunction}} from \CatC to \CatD is given by the following data:
    \begin{compactenum}
