...
\begin{example}\label{ex:Vect}
  ...
  Applying the above duality construction twice to a vector space or a linear map gives their double dual. It turns out that this is a functorial operation. That is, there is a functor~$\stylefunctors{Double dual}\colon \Vect \fto \Vect$ that maps every vector space and every linear map to its double dual.
