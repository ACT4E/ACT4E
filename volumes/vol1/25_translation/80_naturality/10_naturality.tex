...
\end{equation}
In order to implement these changes, we use a function $\ntrafoa_{\styleobj{D}}: \funa(\styleobj{D}) \mto \funb(\styleobj{D})$ which maps the old discipline names to the corresponding new ones in the obvious way. For instance, 
\begin{equation*}
...
This can be formulated succinctly by saying that we want the diagram in figure [REF] to commute!
