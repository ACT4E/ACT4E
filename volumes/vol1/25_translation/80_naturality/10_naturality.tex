...
\devel{
    ...
    The architecture of the database in our example might be encoded by a category with four objects and three non-identity morphisms, as depicted in \XXX.
    ...
    Let's assume the university updates its database once a year.
...
\end{equation}
\todo{@J: ideally say more here to motivate or explain this.
