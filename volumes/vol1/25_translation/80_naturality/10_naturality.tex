...
Indeed, categories may be assembled into a category \index{\Category} where the objects are categories and morphisms are functors.
It turns out that there is an important third layer to this world of categories: there are also morphisms \emph{between} functors, and these are known as ``natural transformations''.
...
\end{ctdefinition}
\todotext{@J: seems like a lot of things are missing here.}
\clearpage
\section{Examples}
