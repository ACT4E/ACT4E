...
Given the existence of an identity \SY{functor} and the ability of \SY{functors} t o compose, we can define a category of categories \Category.
...
\begin{ctdefinition}[Category of small categories]
    ...
    \begin{itemize}
        ...
        \item Identity morphisms: identity \SY{functors};
        \item Composition: composition of \SY{functors}.
    \end{itemize}
\end{ctdefinition}
\vfill
...
\todojira{460}{\bernina: Is DP the join of rel and pos when using embedding?}
