...
\begin{ctdefinition}[Functor composition]
    ...
    \begin{itemize}
        \item Given~$\Obja\setin \Ob_\CatA$, one has
              \begin{equation}
                  (\funa\fthen \funb)(\Obja)\definedas\funb(\funa(\Obja)).
              \end{equation}
        \item Given~$\mora \setin \HomSet{\CatA}{\Obja}{\Objb}$, one has
              \begin{equation}
                  (\funa\fthen \funb)(\mora)\definedas \funb(\funa(\mora)).
              \end{equation}
    \end{itemize}
\end{ctdefinition}
