...
\begin{equation*}
    ...
    {\Tupcatt{\mapa(\setAel_1)}{\ldots}{\mapa(\setAel_n)}}
\end{equation*}
...
\begin{equation*}
    \begin{aligned}
        \listfun(\mapa \then \mapb)(\Tupcatt{\setAel_1}{\ldots}{\setAel_n}) & =\Tupcatt{(\mapa \then \mapb)(\setAel_1)}{\ldots}{(\mapa \then \mapb)(\setAel_n)} \\
                                                                            & =\listfun(\mapb)(\Tupcatt{\mapa(\setAel_1)}{\ldots}{\mapa(\setAel_n)}) \\
                                                                            & =(\listfun(\mapa)\then \listfun(\mapb))(\Tupcatt{\setAel_1}{\ldots}{\setAel_n}).
    \end{aligned}
\end{equation*}
