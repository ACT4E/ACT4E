...
\begin{example}[Vector spaces]
    ...
    \todotextjira{403}{@JL: Can you give a specific name to this category?}
...
\begin{equation}
    \begin{aligned}
        \listfun(\mapa \then \mapb)(\cObj{\setAeln{1},\ldots,\setAeln{n}}) & =\cObj{(\mapa \then \mapb)(\setAeln{1}), \ldots, (\mapa \then \mapb)(\setAeln{n})} \\
                                                                           & =\listfun(\mapb)(\cObj{\mapa(\setAeln{1}), \ldots, \mapa(\setAeln{n})}) \\
                                                                           & =(\listfun(\mapa)\then \listfun(\mapb))(\cObj{\setAeln{1}, \ldots, \setAeln{n}}).
    \end{aligned}
\end{equation}
