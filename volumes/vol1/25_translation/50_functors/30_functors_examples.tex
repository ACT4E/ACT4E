...
\begin{example}[Powerset functor]
    ...
    \begin{equation*}
        \begin{aligned}
            ...
            \setC                                  & \mapsto \{\mora(\setCel) \mid \setCel \setin \setC\}.
        \end{aligned}
    \end{equation*}
    ...
    \begin{equation*}
        \begin{aligned}
            \funa(\mora\mthen \morb)(\setC) & =\{ \morb(\mora(\setCel))\mid \setCel \setin \setC\},
        \end{aligned}
    \end{equation*}
    and
    \begin{equation*}
        \begin{aligned}
            (\funa(\mora)\mthen \funa(\morb))(\setC)
             & =\{ \mora(\setCel) \mid \setCel \setin \setC\}\mthen \funa(\morb) \\
             & =\{g(\setDel)\mid \setDel \setin \{\mora(\setCel)\mid \setCel\setin \setC\}\} \\
             & =\{ \morb(\mora(\setCel))\mid \setCel \setin \setC\}.
        \end{aligned}
    \end{equation*}
    Second, one has
    \begin{equation*}
        \begin{aligned}
            \funa(\catid_\setA)(\setC) & = \{\catid_\setA(\setCel)\mid \setCel \setin \setC\} \\
                                       & =\catid_{\funa(\setC)}.
        \end{aligned}
    \end{equation*}
\end{example}
...
\begin{gradedexercise}[\exname{UpperSetsViaFunctors}]
    ...
    Prove that the set
    \begin{equation}
        \subA \definedas \{ \posAel \setin \posA \mid \funaMap(\posAel) = \true \} \setsubseteq \posA
    \end{equation}
    is an upper set.
\end{gradedexercise}
