...
\todojira{119}{This is the free monoid functor. Recall concept of monoid and add}

\subsection{Planning as the search of a functor}
\begin{example}\label{ex:planning-as-search-functor}
...
\begin{figure}[h!]
  \centering
  \caption{\todographicsjira{120}{to create}}
