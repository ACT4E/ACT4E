...
One option is to simply drop the last condition in the definition of functor. We call the gadget we obtain in this way a \emph{semifunctor}. It is a generalization of the notion of semigroup homomorphism in a completely analogous way as to how functors generalize monoid homomorphisms. 
