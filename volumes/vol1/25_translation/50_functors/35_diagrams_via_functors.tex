...
\todojira{368}{@JL: Explain how diagrams can be encoded using functors}
...
\end{align*}
\todojira{621}{Insert a nice figure showing the shape category being mapped to the diagram.}
...
\todotextjira{622}{@JL: finish writing}
