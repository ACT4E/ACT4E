...
\begin{example}
    ...
    For instance, since~$\{\setAel\}\setsubseteq \{\setAel,\setBel\}$ and~$\{\setAel,\setBel\} \setsubseteq \{\setAel,\setBel,\setCel\}$, we can say that~$\{\setAel\}\setsubseteq \{\setAel,\setBel,\setCel\}$.
\end{example}
