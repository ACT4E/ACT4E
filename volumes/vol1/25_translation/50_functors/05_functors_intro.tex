...
Later on, we will see that there is yet another level of generalization: we can define \emph{arrows between \SY{functors}}, called \SY{natural transformations}.
