...
\begin{enumerate}
    ...
    \item For~$\Obja,\Objb\setin \Ob_{\Bergama}$, we know that paths satisfying the steepness constraint are specific paths in \Berg:~$\Hom_{\Berg_\alpha}\subseteq \Hom_{\Berg}$.
