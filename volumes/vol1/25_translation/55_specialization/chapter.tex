...
\chaptersecond{Specialization}{chapter-swissguard}{}{
    ...
    First, a category can be a \emph{subcategory} of another: it contains a subset of the objects and morphisms of the other, in such a way that it is closed to composition.
