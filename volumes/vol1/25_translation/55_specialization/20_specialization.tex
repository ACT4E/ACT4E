...
\begin{example}[\Set and \Rel]
    ...
    \begin{enumerate}
        ...
        \item For each~$\Obja \setin \Ob_{\Set}$, the identity relation~$\catid_\Obja=\makeset{\tupp{\ela,\ela\styleelements{'}}\setin {\Obja} \cartprod \Obja \mid \ela=\ela\styleelements{'}}$ corresponds to the identity function~$\catid_\Obja \colon \Obja \mto \Obja$ in \Set.
