...
\todographicsjira{429}{@Gioele: Needs graphics for subcategorie}
...
\begin{example}[\FinSet]\index{\textbf{FinSet}|textbf}
    \label{ex:FinSet}
...
\begin{example}[\Set and \Rel]
    ...
    \begin{enumerate}
        ...
        \item For each~$\Obja \setin \Ob_{\Set}$, the identity relation~$\catid_\Obja=\makeset{\tupp{\ela,\ela\elprime}\setin {\Obja} \cartprod \Obja \mid \ela=\ela\elprime}$ corresponds to the identity function~$\catid_\Obja \colon \Obja \mto \Obja$ in \Set.
