...
\begin{solution}
    ...
    \begin{itemize}
        ...
        \item \textbf{Affine transformations.}
              Let~$\mat{A}\setin \reals^{\matdim{2}{2}}$ and~$\mat{b}\setin \reals^{\matdim{2}\times {1}}$.
              ...
              Finally, the identity morphism in \Draw corresponds to an affine transformation of the form~$\affinetrafo_{\mathbb{1},\mathbf{0}^{\matdim{2}{1}}}$.
    \end{itemize}
\end{solution}
