...
An equivalent way of phrasing the above definition is this: 
...
Using our new notation and terminology, let us now also fix, for reference, the following definition.
