...
\multicolumn{4}{c}{\nomencsubsectionname{Generic sets and elements}}\\ 
 ...
 $\wnumbers$ &  Natural numbers: $0, 1, 2, \dots$ &  & \\ 
...
\multicolumn{4}{c}{\nomencsubsectionname{Basic}}\\ 
 ...
 $\sgrpA$ &  Generic semigroup &  & \\ 
 $\sgrpB$ &  Generic semigroup &  & \\ 
 $\sgrpelAa$ &  Generic semigroup element &  & \\ 
 $\sgrpelAb$ &  Generic semigroup element &  & \\ 
 $\sgrpmorA$ &  Generic semigroup morphism &  & \\ 
 $\sgrpmorB$ &  Generic semigroup morphism &  & \\ 
 ...
 $\monoidB$ &  Generic monoid & $\to$\cref{def:monoid} & \pageref{def:monoid}\\ 
 $\monelA$ &  Generic monoid element & $\to$\cref{def:monoid} & \pageref{def:monoid}\\ 
 $\monelAa$ &  Generic monoid element & $\to$\cref{def:monoid} & \pageref{def:monoid}\\ 
 $\monelAb$ &  Generic monoid element & $\to$\cref{def:monoid} & \pageref{def:monoid}\\ 
 $\monelB$ &  Generic monoid element & $\to$\cref{def:monoid} & \pageref{def:monoid}\\ 
 $\monelBa$ &  Generic monoid element & $\to$\cref{def:monoid} & \pageref{def:monoid}\\ 
 $\monelBb$ &  Generic monoid element & $\to$\cref{def:monoid} & \pageref{def:monoid}\\ 
...
$\constit$ &  &  & \\ 
 ...
 \hline
$\id$ &  &  & \\ 
 \multicolumn{4}{l}{\nomencsectionname{Morse code}}\\ 
 \hline
$\morsedot$ &  &  & \\ 
 $\morsedash$ &  &  & \\ 
 $\morsedsp$ &  space betwen dots and dashes &  & \\ 
 $\morselsp$ &  letter space &  & \\ 
 $\morsewsp$ &  word space &  & \\ 
 $\lettersp$ &  &  & \\ 
 $\wordsp$ &  &  & \\ 
 $\morseA$ &  &  & \\ 
