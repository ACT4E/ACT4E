...
\multicolumn{4}{c}{\nomencsubsectionname{Generic sets and elements}}\\ 
 ...
 $\funceil$ &  ceiling function & $\to$\cref{ex:rounding-functions} & \pageref{ex:rounding-functions}\\ 
 $\funfloor$ &  floor function & $\to$\cref{ex:rounding-functions} & \pageref{ex:rounding-functions}\\ 
...
$\idmat$ &  identity matrix &  & \\ 
 $\trace A$ &  trace of a linear map &  & \\ 
 $\deter A$ &  determinant of a linear map &  & \\ 
 $\posdef$ &  Positive-definite matrices &  & \\ 
 $\possemidef$ &  Positive-semidefinite matrices &  & \\ 
 $\vecspA, \vecspB, \vecspC$ &  generic vector spaces &  & \\ 
 \multicolumn{4}{l}{\nomencsectionname{Relations}}\\ 
 \hline
$\relA, \relB$ & Generic relation names. &  & \\ 
 $\relA\reltransp$ & Transpose of a relation $\relA$. &  & \\ 
 $\mat{A}\mattransp$ & Transpose of a matrix $\mat{A}$. &  & \\ 
...
\multicolumn{4}{c}{\nomencsubsectionname{Generic poset names}}\\ 
 ...
 $\posela, \poselb, \poselc$ &  Generic elements of posets &  & \\ 
 $\posAleq$ &  Order on poset $\posA$ &  & \\ 
 $\posUA$ &  Upper sets of poset $\posA$ &  & \\ 
 $\posLA$ &  Lower sets of poset $\posA$ &  & \\ 
 $\Int$ &  Interval monad &  & \\ 
 ...
 $\Inf_{\posAleq} \subA $ &  Infimum element of the subset $\subA$. & $\to$\cref{def:Inf} & \pageref{def:Inf}\\ 
 $\Sup_{\posAleq} \subA $ &  Supremum element of the subset $\subA$. & $\to$\cref{def:Sup} & \pageref{def:Sup}\\ 
 $\low$ &  &  & \\ 
 $\upp$ &  &  & \\ 
...
\multicolumn{4}{c}{\nomencsubsectionname{Basic}}\\ 
 ...
 $\Objael, \Objbel, \Objcel$ &  generic objects elements \XXX &  & \\ 
 ...
 $\fish$ &  & $\to$\cref{def:monad-computer-science} & \pageref{def:monad-computer-science}\\ 
 $\lift$ &  & $\to$\cref{def:monad-computer-science} & \pageref{def:monad-computer-science}\\ 
 $\mjoin$ &  & $\to$\cref{def:monad-computer-science} & \pageref{def:monad-computer-science}\\ 
 $\bind$ &  & $\to$\cref{def:monad-computer-science} & \pageref{def:monad-computer-science}\\ 
 $\fmap$ &  & $\to$\cref{def:monad-computer-science} & \pageref{def:monad-computer-science}\\ 
 $\return$ &  & $\to$\cref{def:monad-computer-science} & \pageref{def:monad-computer-science}\\ 
 ...
 $\TwistedArrow$ &  Twisted Arrow category &  & \\ 
 $\op$ &  &  & \\ 
 $\funcbetween$ &  &  & \\ 
 \multicolumn{4}{c}{\nomencsubsectionname{Semigroups}}\\ 
 $\sgrpA, \sgrpB, \sgrpC$ & Generic semigroup names. &  & \\ 
 $\sgrpAset, \sgrpBset, \sgrpCset$ & Generic names for underlying semigroup &  & \\ 
 $\mlog$ &  Matrix logarithm &  & \\ 
 $\mexp$ &  Matrix exponential &  & \\ 
 $\sgrpela,\sgrpelb,\sgrpelc$ & Generic semigroup elements &  & \\ 
 ...
 $\grpela, \grpelb, \grpelc$ &  Generic group elements &  & \\ 
...
\multicolumn{4}{c}{\nomencsubsectionname{\cref{ch:sameness}}}\\ 
 ...
 $\alphanums$ &  Alphabet &  & \\ 
 $\asciienc$ &  ASCII encoding functor &  & \\ 
 $\asciifunc$ &  ASCII function &  & \\ 
 $\morseset$ &  &  & \\ 
 $\morsemorph$ &  &  & \\ 
