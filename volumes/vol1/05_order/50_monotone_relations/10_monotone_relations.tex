...
Equation~\cref{eq:dp-left-curry} on the one hand, and \cref{eq:dp-right-curry} on the other hand, give two perspectives on the mathematical definition of what we are calling a \emph{design problem}.
...
\todotext{If the above material is generalized to preorders, this subsection needs to be removed and/or put as a different kind of comment}
