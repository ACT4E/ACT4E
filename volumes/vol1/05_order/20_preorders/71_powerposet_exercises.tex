...
\codeboilerplate{FinitePosetConstructionPower}{
    Write code to compute the power \SY{poset} of a finite set.
}

\classlisting{FinitePosetConstructionPower}

A \classname{PosetOfFiniteSubsets} is a \SY{poset} whose carrier is a \classname{SetOfFiniteSubsets}.
