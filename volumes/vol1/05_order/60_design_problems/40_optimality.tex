...
\todotext{2026-07 add intro material here}

\subsection{Chains and Antichains}
\label{sec:chains-antichains}

\todotext{Decide if this is a CT or a DP thing; and decide if to generalize to preorder case}
...
\todotext{In the definition below, let's put the formula in a dual form to the one above, and make sure it works for preorders well}
...
\todotext{Decide if the material in this subsection should be DP or CT material (probably the former); only if the latter do we want to extend to preorders}
...
\todotext{The definition of Min needs to be re-thought through to see if / how to handle in preorder case. Also the definition of Min is only given later (should be moved)}
