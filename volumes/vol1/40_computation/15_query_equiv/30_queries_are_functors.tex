...
\begin{proof}
    ...
    We want to check
    \begin{equation}
        \FixFunMinRes(\adpa \meetof\DP \adpb)=\FixFunMinRes(\adpa) \meetof\UPos \FixFunMinRes(\adpb),
    \end{equation}
    and
    \begin{equation}
        \FixFunMinRes(\adpa \joinof\DP \adpb)=\FixFunMinRes(\adpa) \joinof\UPos \FixFunMinRes(\adpb).
    \end{equation}
    We have
    \begin{equation}
        \begin{aligned}
            ~ &
            \ulposmap{\FixFunMinRes(\adpa \meetof\DP \adpb)}(\Objael) \\
              & =\makeset{ \R{\Objbel} \setin \R{\Objb} \mid (\adpa \meetof\DP \adpb)(\F{\Objael}^*,\R{\Objbel})} \\
    ...
    \begin{equation}
        \begin{aligned}
            ~ & \ulposmap{\FixFunMinRes(\adpa \joinof\DP \adpb)}(\Objael) \\
              & =\makeset{ \R{\Objbel} \setin \R{\Objb} \mid (\adpa \joinof\DP \adpb)(\F{\Objael}^*,\R{\Objbel})} \\
