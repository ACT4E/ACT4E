...
\begin{proof}
    ...
    \begin{equation}
        ...
        \begin{aligned}
            ~ & \ulposmap{\left(\left( \mora \mtimescatmor \morb\right)\mthen \braiding_{ \Objb, \Objd}\right)}(\Objael,\Objcel) \\
    ...
    \begin{equation}
        ...
        \begin{aligned}
            ~ & \ulposmap{\left(\braiding_{ \Objd, \Objb}\mthen \left( \mora \mtimescatmor \morb\right)\right)}(\Objael,\Objcel) \\
              & =
            \tup{\upit\makeset{\Objcel},\upit\makeset{\Objael}}\mthen \ulposmap{\left( \mora \mtimescatmor \morb\right)} \\
