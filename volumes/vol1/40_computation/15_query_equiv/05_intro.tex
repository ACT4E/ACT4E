...
We will consider an arbitrary graph of \SY{design problems}, in which nodes are \SY{design problems} and edges are arbitrary interconnections between functionality and resources, obtained through the operations of a traced monoidal category (series, parallel, feedback) plus the lattice structure (and, or) of \SY{design problems}.
