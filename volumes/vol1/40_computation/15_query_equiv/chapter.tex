...
\chaptersecond{\DP queries as functors}{chapter-placeholder}{chap:query-equivalence}{
    \todotext{to write}
    In this chapter we show how the two types of queries
    \FixFunMinRes and \FixResMaxFun can be seen as \emph{functors}
    from the category \DP to two new categories to be defined that represent the types of ``solutions''.
