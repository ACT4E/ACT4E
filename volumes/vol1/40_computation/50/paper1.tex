...
\begin{lemma}
    ...
    \[
        ...
        B\qquad\equiv\qquad\upit A\supseteq\upit B.
    \]
\end{lemma}
...
2) An \textbf{algorithmic result }(\cref{thm:CDP-solvig}) says that the functionality-resources map~$\ftor$ for the entire MCDP has an explicit expression in terms of the maps~$\{\ftor_{\cdpin},\,\cdpin\setin\cdpiN\}$ for the subproblems.
