...
\begin{figure}[h]
    \subfloat[\label{fig:mass}]{
        \includegraphics[scale=0.4]{unc_approx2a}
    }%
    \subfloat[\label{fig:num_iterations}]{
        \includegraphics[scale=0.4]{unc_approx2c}
    }
    \caption{
...
The sequence is guaranteed to satisfy~$\vdc(n)\setsubseteq\vdc(n+1)$
...
\begin{lemma}
    \label{lem:udpsem-well-formed}\cref{def:semantics-udp} is well formed, in the sense that 
            \begin{equation}
