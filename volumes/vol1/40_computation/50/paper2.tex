...
DPs. The top of the pyramid is~$\postop_{\udpsp}$, which represents
maximum uncertainty.
...
and obtain upper and lower bounds for~$\adp$. Furthermore, by
...
results predicted by the theory. First, if the solutions for both~$\udpL\adp_{\alpha}$
