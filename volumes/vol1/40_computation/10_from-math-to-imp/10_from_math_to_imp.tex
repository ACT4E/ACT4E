...
Given a design problem to be solved, we formulate the \FixFunMinReq problem as to find a map
\begin{equation}
    \label{eq:hfromftoupr}
\ftor\colon \funsp \to \uppersets \ressp.
\end{equation}
...
\begin{equation}
    ...
    \ftor\colon \funsp \to \antichains \ressp.
\end{equation}
