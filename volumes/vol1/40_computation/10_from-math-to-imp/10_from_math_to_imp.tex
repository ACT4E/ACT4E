...
\todo{Not just any map, but the curried and op-ed version of the original design problem, right? Also, we need to say explicitly here that we are ordering upper sets by containment. We can refer back to \cref{ex:CurryingDesignProblems} which was about showing that design problems can be viewed this way.}
%
\begin{equation}
...
\end{equation}
%
\todo{J: is this perhaps a bit misleading? Isn't what we actually want a map to antichains? Why not say it here rather than below? From a mathematical perspective, $h$ above is just the curried version of the original design problem... so it seems almost a bit strange to pose that as the problem perhaps?}
%
