...
\todotext{Not just any map, but the curried and op-ed version of the original design problem, right? Also, we need to say explicitly here that we are ordering upper sets by containment. We can refer back to \cref{ex:CurryingDesignProblems} which was about showing that design problems can be viewed this way.}
%
\begin{equation}
...
\todojira{253}{@Andrea: I think it is good to have an overview that connects to the four phases before starting the meat. Should we also talk about functors DP to UPos, UPoscomp, UPosdiscrete?}
