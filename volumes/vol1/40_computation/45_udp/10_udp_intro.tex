...
\begin{figure}[h!]
    ...
    \caption{}
    \label{fig:consider1}
    \todographicsjira{744}{\alphubel: @Gioele: redo picture. Label $\adp$ rather than $\ftor_a$.}
\end{figure}
...
\begin{figure}[h!]
    ...
    \caption{}
    \label{fig:pair}
    \todographicsjira{744}{\alphubel: @Gioele: redo picture. Need to use $\interv\cdot\cdot$ rather than the brackets. }
\end{figure}
