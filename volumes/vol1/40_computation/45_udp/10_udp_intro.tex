...
This result says that we can swap any DP in a CDP with a UDP relaxation, obtain a uncertain CDP, which we can solve to obtain inner and outer approximations to the solution of the original CDP.
