...
\devel{
    Second, as noted in the previous section, each element $\ela \setin \setA$ can be viewed as a ``generalized element'' $\{ \ela \} \setin \powerset \setA$.
...
\begin{remark}
    ...
    In terms of components, the unitality conditions state that for every object~$\Obja \setin \ObC$, the diagrams
    ...
    commute.
    And the associativity condition states that for every object~$\Obja \setin \ObC$,
