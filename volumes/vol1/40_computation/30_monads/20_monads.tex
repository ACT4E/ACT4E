...
\begin{gradedexercise}[\exname{FinProbMonad}]
    ...
    \begin{enumerate}
        \item
              ...
              \end{equation}
              Check that the collection of functions~$\{ \stylenat{\delta}_{\setA} \}_{\setA \setin\Ob_{\Set}}$ defines a natural transformation~$\stylenat{\delta}\colon \stylefunctors{Id}_\Set \nto \stylefunctors{\mathcal{P}}$.
        ...
        \item
              ...
              \end{equation}
              Check that the collection of functions $\{ \stylenat{\mu}_{\setA} \}_{\setA \setin\Ob_{\Set}}$ defines a natural transformation~$\stylenat{\mu}\colon \stylefunctors{\mathcal{P}} \stylefunctors{\mathcal{P}} \nto \stylefunctors{\mathcal{P}}$.
