...
\devel{
    ...
    So we have, for each set, a function $\monunit_\setA : \setA \to \powerset \setA, \ela \mapsto \makeset{ \ela }$.
...
\todotextjira{230}{@JL: I'm not sure if we ever introduced ``whiskering'' and the notation for it (which is used in the diagrams in the definition of a monad).
...
\todotextjira{422}{@JL: I think we should use two different notations for the functor for the monad and the actual arrow construction\dots}
\begin{equation}
