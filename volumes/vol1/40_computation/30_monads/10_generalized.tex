...
Recall that for a \SY{poset} $\posA$, we can define the \SY{poset} of intervals~$\posintbis\posA$ (see \cref{def:arrow-poset-of-intervals}) and~$\posint\posA$ (see \cref{def:twisted-poset-of-intervals}).
...
\begin{equation}
    ...
    \prftree{
        ...
        \morb\colon \Objb \mto (\Objc \cartprod \nonNegReals)
    }{
        \defmapset{
            (\morab)
        }{
...
\begin{equation}
    ...
    \prftree{
        ...
        \morb\colon \Objb \mto (\Objc \cartprod \monoidAset)
    }{
        \defmapset{
            (\morab)
        }{
            ...
            (\Objc\cartprod \monoidAset)
        }{
            x
        }{
            \tup{
                \morb_1(\mora_1(x)),
                \morb_2(\mora_1(x)) \mtimesof\monoidA \mora_2(x)
            }
        }
    }.
\end{equation}
