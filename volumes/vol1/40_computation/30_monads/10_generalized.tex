...
\begin{proof}
\todotextjira{226}{We showed this already in a previous chapter. We could include a cross reference and/or also explain how this works again.}
\end{proof}
...
\begin{figure}[h]
    \todographicsjira{227}{Put here the same figure for composition of relation; however now making it clear that it's not x in relation with many ys, but rather x maps to a subset of ys.}
    \caption{}
