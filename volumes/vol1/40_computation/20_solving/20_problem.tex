...
for the subproblems, one needs to evaluate \todotext{evaluate or compute?} the map~$\ftor\colon\funsp \toinPos \uppersets \ressp$
...
The strategy to obtain these results \todotext{which results?} consists in reducing an arbitrary
