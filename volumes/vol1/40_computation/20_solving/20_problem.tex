...
\begin{example}[Non-convexity]
    ...
    \begin{equation*}
        ...
        \end{cases}
    \end{equation*}
    \todotext{@Gioele: Need to use macros for $\Phi$ and $P$.}
    % \todo{why underlined?} fea -> feasible
...
\Cref{sec:Decomposition}~shows how to turn a graph into a tree, where each junction is one of the three operators.
