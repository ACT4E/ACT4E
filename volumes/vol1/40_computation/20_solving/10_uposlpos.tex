...
\begin{proof}
    ...
    \begin{itemize}
        ...
        \item \emph{Antisymmetry:}
              Consider~$\mora,\morb \in \HomSet{\UPos}{\Obja}{\Objb}$ with~$\mora \posleqof\UPos \morb$ and~$\morb \posleqof\UPos \mora$.
              We know
              \begin{equation*}
        ...
        \item \emph{Transitivity:}
              Consider~$\mora,\morb,\morc \in \HomSet{\UPos}{\Obja}{\Objb}$ with~$\mora \posleqof\UPos \morb$ and~$\morb \posleqof\UPos \morc$.
