...
\begin{proof}
    ...
    \end{equation}
    To do so, we first look at the left-hand side of \cref{eq:upos_hexagon_1}. One has
    \begin{equation*}
        \begin{aligned}
...
\end{aligned}
\end{equation*}
\todotext{Not clear yet how to massage to show equivalence. Talk with J}
\paragraph*{Vanishing}
...
\end{equation*}
\end{compactitem}
\todotext{Here, meet and join are swapped (wr.t. to symbols), because of the inverse order. Should we define them oppositely for UPos?}
