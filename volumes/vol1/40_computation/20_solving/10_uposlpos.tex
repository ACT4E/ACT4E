...
\begin{proof}
    ...
    Consequently, there must exist an~$i'\in I$ such that~$s_{i'}\posleq_\posA \posAel'$.
...
\begin{proof}
    ...
    One has
    \begin{equation*}
        \prfcomma{\setAel \in \setA}{\setAel \posleq_\posA \setAel'}{\setAel'\in \setA}
    \end{equation*}
    and
    \begin{equation*}
        \prfperiod{\setBel \in \setB}{\setBel \posleq_\posB \setBel'}{\setBel'\in \setB}
    \end{equation*}
    Therefore:
    \begin{equation*}
        \prfcomma{
            ...
            \tup{\setAel,\setBel} \posleq_{\posA \cartprod \posB} \tup{\setAel',\setBel'}
        }{
            \tup{\setAel',\setBel'}\in \setA \cartprod \setB
        }
    \end{equation*}
...
\begin{proof}
    ...
    \begin{equation*}
        \prfdouble{ \Tr_{\Obja,\Objb}^{\Objc}(\mora)(\Objael) \posleq_{\UPos}  \Tr_{\Obja,\Objb}^{\Objc}(\mora)(\Objael')}{\ulposmap{\Tr_{\Obja,\Objb}^{\Objc}(\mora)}(\Objael) \supseteq \ulposmap{\Tr_{\Obja,\Objb}^{\Objc}(\mora)}(\Objael')}
    \end{equation*}
...
\begin{definition}
    ...
    \begin{equation*}
        \prfperiod{\mora \posleq_\UPos \morb}{\ulposmap{\mora}(\Objael)\posleq_{\uppersets \Objb} \ulposmap{\morb}(\Objael), \quad \forall \Objael \in \Obja}
    \end{equation*}
\end{definition}
...
\begin{definition}
    ...
    \begin{equation*}
        \prfperiod{\mora \posleq_\LPos \morb}{\ulposmap{\mora}(\Objael)\posleq_{\lowersets \Objb} \ulposmap{\morb}(\Objael), \quad \forall \Objael \in \Obja}
    \end{equation*}
\end{definition}
...
\begin{proof}
    ...
    \begin{compactitem}
        ...
        \item \emph{Antisymmetry:}
              Consider~$\mora,\morb \in \HomSet{\UPos}{\Obja}{\Objb}$ with~$\mora \posleq_\UPos \morb$ and~$\morb \posleq_\UPos \mora$.
              We know
              \begin{equation*}
        ...
        \item \emph{Transitivity:}
              Consider~$\mora,\morb,\morc \in \HomSet{\UPos}{\Obja}{\Objb}$ with~$\mora \posleq_\UPos \morb$ and~$\morb \posleq_\UPos \morc$.
...
\todo{Here we use CT colors, but we should use DP colors when DPs are there, to help contextualizing?}
\begin{lemma}
...
\begin{proof}
    ...
    We want to check
    \begin{equation*}
        \prfperiod{\adpa \posleq_\DP \adpb}{\FixFunMinRes(\adpa) \posgeq_\UPos \FixFunMinRes(\adpb)}
    \end{equation*}
    One has:
    \begin{equation*}
        \begin{aligned}
