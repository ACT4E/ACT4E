...
\begin{enumerate}
    ...
    \item \emph{Left unitor}: The left unitor is given by the pair of morphisms~$\leftunitor_\Obja\colon \{\styleobj{\singletonel}\}\mtimescat \Obja \mto \Obja$ and~$\leftunitor_\Obja^{-1}\colon \Obja \mto \{\styleobj{\singletonel}\}\mtimescat \Obja$, with
    \begin{equation}
        \begin{aligned}
            \ulposmap{\leftunitor_\Obja}\colon \{\styleobj{\singletonel}\}\mtimescat \Obja &\mto \Up{\Obja}\\
    ...
    \begin{equation}
        \begin{aligned}
            \ulposmap{\leftunitor_\Obja^{-1}}\colon \Obja &\mto \Up(\{\styleobj{\singletonel}\}\mtimescat \Obja) \\
            \Objael&\mapsto \{\styleobj{\singletonel}\} \times \upit \{\Objael\}.
        \end{aligned}
    \end{equation}
    \item \emph{Right unitor}: The right unitor is given by the pair of morphisms~$\rightunitor_\Obja\colon \Obja\mtimescat \{\styleobj{\singletonel}\}  \mto \Obja$ and~$\rightunitor_\Obja^{-1}\colon \Obja \mto \Obja \mtimescat \{\styleobj{\singletonel}\}$, with
    \begin{equation}
        \begin{aligned}
            \ulposmap{\rightunitor_\Obja}\colon \Obja\mtimescat \{\styleobj{\singletonel}\}  &\mto \Up{\Obja}\\
    ...
    \begin{equation}
        \begin{aligned}
            \ulposmap{\rightunitor_\Obja^{-1}}\colon \Obja &\mto \Up( \Obja \mtimescat \{\styleobj{\singletonel}\}) \\
            \Objael&\mapsto \upit \{\Objael\} \times \{\styleobj{\singletonel}\}.
        \end{aligned}
    \end{equation}
    \todo{Continue from here with new notation, still to be adapted.}
...
\todo{define functor that goes back. Show equivalence. Transcribe strong monoidal functor story.}
\begin{lemma}
