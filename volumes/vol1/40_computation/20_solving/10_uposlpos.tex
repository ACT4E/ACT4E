...
\begin{definition}[Order on morphisms in~$\UPos$]
...
\begin{definition}[Order on morphisms in~$\LPos$]
    \label{def:upos_order}
...
\begin{definition}[Intersection of morphisms in~$\UPos$]
...
\begin{definition}[Intersection of morphisms in~$\LPos$]
...
\begin{definition}[Union of morphisms in~$\LPos$]
...
\begin{lemma}\label{lem:UPos-is-bounded-lattice}
...
\begin{proof}
    ...
    \begin{equation*}
        \begin{aligned}
            \ulposmap{\FixFunMinResBack(\catid_{\Obja}^{\UPos})}(\F{\Objael}^*,\R{\Objbel})&=
    ...
    \begin{equation}
        ...
        \begin{aligned}
            \ulposmap{\FixFunMinResBack(\mora\mthen_\UPos \morb)}(\Objael^*,\Objcel)&=
    ...
    \begin{equation}
        ...
        \begin{aligned}
            \ulposmap{(\FixFunMinResBack(\mora)\mthen_\DP \FixFunMinResBack(\morb))}(\Objael^*,\Objcel)&=
