...
\begin{proof}
    ...
    One has
    \begin{equation*}
        \prftree[r]{,}{\setAel \in \setA}{\setAel \posleq_\posA \setAel'}{\setAel'\in \setA}
    \end{equation*}
    and
    \begin{equation*}
        \prftree[r]{.}{\setBel \in \setB}{\setBel \posleq_\posB \setBel'}{\setBel'\in \setB}
    \end{equation*}
    Therefore:
    \begin{equation*}
        \prftree[r]{,}{\tup{\setAel,\setBel} \in \setA\cartprod \setB}{\tup{\setAel,\setBel} \posleq_{\posA \cartprod \posB} \tup{\setAel',\setBel'}}{\tup{\setAel',\setBel'}\in \setA \cartprod \setB}
    \end{equation*}
...
\begin{definition}
    ...
    \begin{equation*}
        \prftree[r]{.}{\mora \posleq_\UPos \morb}{\ulposmap{\mora}(\Objael)\posleq_{\uppersets \Objb} \ulposmap{\morb}(\Objael), \quad \forall \Objael \in \Obja}
    \end{equation*}
\end{definition}
...
\begin{definition}
    ...
    \begin{equation*}
        \prftree[r]{.}{\mora \posleq_\LPos \morb}{\ulposmap{\mora}(\Objael)\posleq_{\lowersets \Objb} \ulposmap{\morb}(\Objael), \quad \forall \Objael \in \Obja}
    \end{equation*}
\end{definition}
...
\begin{proof}
    ...
    We want to check
    \begin{equation*}
        \prftree[r]{.}{\adpa \posleq_\DP \adpb}{\FixFunMinRes(\adpa) \posgeq_\UPos \FixFunMinRes(\adpb)}
    \end{equation*}
    One has:
    \begin{equation*}
        \begin{aligned}
