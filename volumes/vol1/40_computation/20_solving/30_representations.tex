...
\todotext{Say somewhere in the above how we are ordering antichains. Also, is "objective function" above a technical term? Is it clear what is meant?}
...
\todotext{J: Is $\varphi$ a good choice of notation here? It seems better to choose a notation that is more similar to $h$. The distance/clash between latin and greek seems too large to me.}
