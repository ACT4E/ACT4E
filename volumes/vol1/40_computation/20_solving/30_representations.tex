...
Also, is "objective function" above a technical term? Is it clear what is meant?}
...
\begin{remark}
    ...
    In short, the condition is satisfied if in the poset \todotext{In the poset or resources or in the poset of upper subsets of the poset or resources? And/or this equivalent?} no \emph{infinite descending chain} exists.
...
\todotext{J: Is $\varphi$ a good choice of notation here? It seems better to choose a notation that is more similar to $h$.
