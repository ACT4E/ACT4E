...
One effective approach that we will develop in \cref{chap:udp} is to \emph{approximate the design problem} \emph{itself}, rather than the spaces~$\funsp,\ressp$, which are left as possibly infinite.
