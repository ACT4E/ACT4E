...
We now look at upper sets that can be represented as the upper closure of a finite \SY{antichains}.
...
\begin{definition}[Category of finite design problems \DPfinite]
    ...
    \begin{enumerate}
        ...
        \item \emph{Morphisms}: The morphisms of~\DP are \emph{finite} \SY{design problems} (\cref{def:finite_des_prob}).
