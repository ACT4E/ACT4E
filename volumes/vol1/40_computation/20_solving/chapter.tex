...
\chaptersecond{{Solving finite co-design problems}}{chapter-yodel}{chap:solving}{
    ...
    A finite co-design problem is one in which the \SY{upper set} of the solutions can be described as the \SY{upper closure} of a finite \SY{antichain}.
    Therefore, the solution can be represented with finite memory.

    \iflabelexists{chap:udp}{
        Later, in \cref{chap:udp}, we will see how to deal with non-finite \SY{design problems}.
