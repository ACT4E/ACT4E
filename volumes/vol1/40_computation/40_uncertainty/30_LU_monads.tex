...
\begin{proof}
    ...
    \begin{equation}
        ...
        \end{aligned}
    \end{equation}
    where we used the fact that the union of \SY{upper sets} is the upper closure of the union of sets.
    ...
    \begin{equation}
        ...
        \end{aligned}
    \end{equation}
    where we use the facts that the union of \SY{upper sets} is an \SY{upper set}, the union of an \SY{upper sets} is the upper closure of the union of sets, and that the upper closure of an \SY{upper set} returns the \SY{upper set}.
