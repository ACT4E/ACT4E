...
\begin{ctdefinition}[Symmetric strict monoidal category]
    ...
    A \maindef{symmetric strict monoidal category} is a \SY{strict monoidal category} $\tup{\CatC, \mtimescat, \idmoncat}$ which is a symmetric stacking category and additionally satisfies an axiom relating the symmetry to the monoidal unit. 
    ...
    which satisfy the conditions of naturality, compatibility with nesting, and symmetry, plus the following axiom: ( MISSING! ) 
\end{ctdefinition}

\todotext{JL: definition above is incomplete}
