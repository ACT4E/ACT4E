...
\begin{remark}
    ...
    \begin{equation*}
        ...
        \end{aligned}
    \end{equation*}
    Clearly, these two equations are different, as soon as one has uncomparable~$\posgenCel,\posgenCel'\setin \posgenC$, and~$\posgenAel\setin \posgenA$,~$\posgenBel\setin \posgenB$ such that
    \begin{equation*}
        \begin{aligned}
