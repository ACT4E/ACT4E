...
\begin{widepar}
    \begin{proof}
        ...
        \end{equation}
        Because the operations $\mtimescatob, \tupconcat, \booland$ are associative, we can erase all the light  parentheses in the formulas, and we find that $(\adpa \mtimescatmor  \adpb) \mtimescatmor \adpc$ and
...
\begin{lemma}[\DPL is \SY{functorial stacking}]\label{lem:DPL-functorial-stacking}
