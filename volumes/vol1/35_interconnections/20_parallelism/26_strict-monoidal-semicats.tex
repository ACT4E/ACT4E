...
\todotext{J: @J: what is a good definition of symmetric strict monoidal semicategory ? Take inspiration from the \SY{adjunctions} for semicategories paper that AC posted recently in order to encode ``isomorphism'' without saying it with identities?}
