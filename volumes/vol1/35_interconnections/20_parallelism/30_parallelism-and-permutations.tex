...
\todotext{J: @J: there is another compatibility condition to include, namely compatibility with stacking... }

\todotext{J: @J: also I think we need/should say something about how block permutations related to their non-block forms... how is this dealt with for classical symmetric monoidal categories? coherence? perhaps call this property something like ``compatibility with aggregation''?}
