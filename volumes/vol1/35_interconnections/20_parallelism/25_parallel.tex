...
\begin{example}
    \SetL  is an associative stacking semicategory, with list concatenation being the semigroup operation on objects.

    \todotext{expand and explain this example}
\end{example}
