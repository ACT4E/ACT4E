...
\begin{proof}
    ...
    \begin{widepar}
        \begin{equation*}
            ...
            {\adpa \cprodmor \adpb \colon \cObj{\posA_1, \ldots, \posA_m, \posB_1, \ldots, \posB_n}\op \acprod \cObj{\posC_1, \ldots, \posC_o, \posD_1, \ldots, \posD_t}\toinPos \cObj{\Bool,\Bool}}
        \end{equation*}
    \end{widepar}
        ...
        \begin{equation*}
            ...
            {\prftree{\posAnel{1} \posAleq \posAnel{1}' \booland \ldots \booland \posAnel{m} \posAleq \posAnel{m}'\booland \posBnel{1} \posBleq \posBnel{1}'\booland \ldots \booland \posBnel{n} \posBleq \posBnel{n}'}
                {\prftree{\adpa(\tup{\posAnel{1},\ldots, \posAnel{m}}^*,\posCnel{})\posgeqof{\Bool} \adpa(\tup{\posAnel{1}',\ldots, \posAnel{m}'}^*,\posCnel{})
                    ...
                    {
                        \prftree{
                            \adpa(\tup{\posAnel{1},\ldots, \posAnel{m}}^*,\posCnel{})\tupconcat \adpb(\tup{\posBnel{1},\ldots, \posBnel{n}}^*,\posDnel{})
                            \posgeqof{\cObj{\Bool,\Bool}}
                            \adpa(\tup{\posAnel{1}',\ldots, \posAnel{m}'}^*,\posCnel{})\tupconcat \adpb(\tup{\posBnel{1}',\ldots, \posBnel{n}'}^*,\posDnel{})
                        }
                        {(\adpa \cprodmor \adpb)(\tup{\posAnel{1},\ldots, \posAnel{m},\posBnel{1},\ldots, \posBnel{m}}^*,\tup{\posCnel{},\posDnel{}})\posgeqof{\cObj{\Bool,\Bool}}
                            (\adpa \cprodmor \adpb)(\tup{\posAnel{1}',\ldots, \posAnel{m}',\posBnel{1}',\ldots, \posBnel{m}'}^*,\tup{\posCnel{},\posDnel{}})} }
                }
            }
        \end{equation*}
    \end{widepar}
        ...
        \begin{equation*}
            ...
            {\prftree{\posCnel{1} \posAleq \posCnel{1}' \booland \ldots \booland \posCnel{o} \posCleq \posCnel{o}'\booland \posDnel{1} \posBleq \posDnel{1}'\booland \ldots \booland \posDnel{t} \posDleq \posDnel{t}'}
                {\prftree{\adpa(\posAnel{}^*,\tup{\posCnel{1},\ldots, \posCnel{o}})\posleqof{\Bool}
                    ...
                    {
                        \prftree{
                            \adpa(\posAnel{}^*,\tup{\posCnel{1},\ldots, \posCnel{o}})\tupconcat \adpb(\posBnel{}^*,\tup{\posDnel{1},\ldots, \posDnel{t}})
                            \posleqof{\cObj{\Bool,\Bool}}
                            \adpa(\posAnel{}^*,\tup{\posCnel{1}',\ldots, \posCnel{o}'})\tupconcat \adpb(\posBnel{}^*,\tup{\posDnel{1}',\ldots, \posDnel{t}'})
                        }
