...
\begin{proof}
    ...
    \end{equation*}
    where~$(\mora \cprodmor \morb)(\tup{\posAnel{1},\ldots, \posAnel{m}} \tupconcat \tup{\posBnel{1},\ldots, \posBnel{n}})\definedas \mora(\tup{\setAel_1,\ldots, \setAel_m})\tupconcat \morb(\tup{\setBel_1,\ldots, \setBel_n})$.
