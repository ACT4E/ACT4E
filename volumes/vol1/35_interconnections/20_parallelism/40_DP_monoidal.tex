    ...
    \begin{equation}
        \begin{aligned}
            ...
            \left( \tup{\F{\posgenAel_1},\F{\posgenBel_1}}\Fop,\tup{\R{\posgenAel_2},\R{\posgenBel_2}}\right) \\
              & =
            \catid_\posgenA(\F{\posgenAel_1\opel},\R{\posgenAel_2})\booland \catid_\posgenB(\F{\posgenBel_1\opel},\R{\posgenBel_2}) \\
              ...
              & =\catid_{\posA\cartprod \posB}\left( \tup{\F{\posgenAel_1},\F{\posgenBel_1}}\opel,\tup{\R{\posgenAel_2},\R{\posgenBel_2}}\right).
        \end{aligned}
    \end{equation}
    ...
    \begin{equation}
        \begin{aligned}
            ~ & \star \left( \tup{\F{\posgenAel_1},\F{\posgenAel_2}}\Fop,\tup{\R{\posgenCel_1},\R{\posgenCel_2}}\right) \\
              ...
              & =\left(\bigvee_{\posBel_\styleelements{1}\setin \posB_\stylepos{1}}\left( \adpa(\F{\posgenAel_1\opel},\R{\posgenBel_1})\booland \adpc(\F{\posgenBel_1\opel},\R{\posgenCel_1})\right)\right) \booland\left(\bigvee_{\posBel_\styleelements{2}\setin \posB_\stylepos{2}}\left( \adpb(\F{\posgenAel_2\opel},\R{\posgenBel_2})\booland \adpd(\F{\posgenBel_2\opel},\R{\posgenCel_2})\right)\right) \\
              & =\bigvee_{\posBel_\styleelements{1}\setin \posB_\stylepos{1}}\bigvee_{\posBel_\styleelements{2}\setin \posB_\stylepos{2}} \left(\adpa(\F{\posgenAel_1\opel},\R{\posgenBel_1})\booland \adpc(\F{\posgenBel_1\opel},\R{\posgenCel_1})\booland \adpa(\F{\posgenAel_2\opel},\R{\posgenBel_2})\booland \adpd(\F{\posgenBel_2\opel},\R{\posgenCel_2}) \right) \\
              & =\bigvee_{\tup{\posBel_\styleelements{1},\posBel_\stylepos{2}}\setin \posB_\stylepos{1}\cartprod \posB_\stylepos{2}} \left(\adpa(\F{\posgenAel_1\opel},\R{\posgenBel_1})\booland \adpb(\F{\posgenAel_2\opel},\R{\posgenBel_2})\booland \adpc(\F{\posgenBel_1\opel},\R{\posgenCel_1})\booland \adpd(\F{\posgenBel_2\opel},\R{\posgenCel_2}) \right) \\
...
\begin{proof}
    ...
    \begin{itemize}
        \item $\leftunitor_\posA \colon \F{\singleton} \cartprod \funposA \profto \resposA$, for all~$\posA\setin \Ob_\DP$, is the left unitor.
              ...
              \begin{equation}
                  \begin{aligned}
                      ~ & \left( \leftunitor_\posA^{-1}\fthen \leftunitor_\posA\right)(\tup{\F{\posgenAel_1\opel},\R{\posgenAel_2}}) \\
                        & =
                      \bigvee_{\tup{\singletonel,\posAel}\setin  \singleton\cartprod \posA} \leftunitor_\posA^{-1}(\F{\posgenAel_1\opel},\tup{\R{\singletonel},\R{\posgenAel}})\booland \leftunitor_\posA(\tup{\F{\singletonel},\FposgenAel}\Fop,\R{\posgenAel_2}) \\
                        ...
                        & =\id_\posA(\F{\posgenAel_1\opel},\R{\posgenAel_2}).
                  \end{aligned}
              \end{equation}
