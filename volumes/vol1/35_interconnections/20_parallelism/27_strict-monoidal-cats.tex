...
\todotextjira{753}{\alphubel: @GZ write up LTI as an example of a strict monoidal semicat, where the monoidal unit is built using the empty matrices (these need to be introduced/discussed elsewhere), and show that the monoidal unit indeed does have an identity}
