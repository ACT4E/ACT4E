...
\todotext{ It seems that LTI is almost an example of a strict monoidal semicat, where the monoidal unit is built using the empty matrices. the issue though is that functoriality fails. perhaps worth making the monoidal definition for stacking, and don't assume functorial stacking?}
