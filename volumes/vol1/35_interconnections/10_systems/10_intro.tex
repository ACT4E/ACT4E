...
For example, given a sequence of inputs $u_0, u_1, u_2, ... $, we may map this to a sequence of outputs $y_0, y_1, y_2, ... $ \cref{eq:moore-specification} using the following recursion relations
\begin{align}
