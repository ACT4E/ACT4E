...
\todojiratext{755}{\alphubel: @GZ: we need a brief definition/discussion of for matrices with 0 dimension here and a remark that this case is included in the definition.}
...
\todojiratext{756}{\alphubel: @GZ: we need a remark and discussion of the case of matrices with 0 dimension, in particular the rules for multiplying them and forming block matrices.}
