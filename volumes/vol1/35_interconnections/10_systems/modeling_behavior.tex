...
\todotext{the below needs editing/rewriting}
    ...
    We will develop here a general-purpose formalization of system behaviors, using relations between signal spaces. This is certainly not the only way one might model system behaviors. We choose to introduce this model here because it provides a quite flexible yet unified lense for viewing many different types of behaviors.  
