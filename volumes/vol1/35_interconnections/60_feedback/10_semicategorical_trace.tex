    ...
    \begin{enumerate}
        ...
        \item \emph{Yanking:}
              ...
              \begin{equation}
                  ...
                  (L_\pi  \mthen \Tr_{\Objc,\Objc}^\Objc)\left(\catid_\Objc \mtimescat \catid_\Objc \right)=\catid_\Objc
              \end{equation}
              and
              \begin{equation}
                  \label{eq:semicat-trace-yanking-II}
                  (R_\pi  \mthen \Tr_{\Objc,\Objc}^\Objc)\left(\catid_\Objc \mtimescat \catid_\Objc \right)=\catid_\Objc,
              \end{equation}
