        ...
        \begin{enumerate}
            ...
            \item \emph{Superposing:}
                  ...
                  \begin{equation}
                      ...
                      \Tr_{\Obje\mtimescatob \Obja,\Objf\mtimescatob \Objb}^{\Objc}(\morb \mtimescatmor \mora)=\morb \mtimescat \Tr_{\Obja,\Objb}^\Objc(\mora).
                  \end{equation}
            ...
            \item \emph{Yanking:}
                  ...
                  \begin{equation}
                      ...
                      (\sourceperm{\pi}   \mthen \Tr_{\Objc,\Objc}^\Objc)\pars{\catidat\Objc \mtimescat \catidat\Objc }=\catidat\Objc
                  \end{equation}
                  and
                  \begin{equation}
                      \label{eq:semicat-trace-yanking-II}
                      (\targetperm{\pi}  \mthen \Tr_{\Objc,\Objc}^\Objc)\pars{\catidat\Objc \mtimescat \catidat\Objc }=\catidat\Objc,
                  \end{equation}
