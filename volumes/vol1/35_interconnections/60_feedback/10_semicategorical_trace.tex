...
\devel{
    \begin{example}
        ...
        + \begin{bmatrix} \mat{0}\\ \rowscols{\mat{B}_\mora}{:}{i+1:i+k} \end{bmatrix}\mat{F}\begin{bmatrix} \mat{0}&\rowscols{\mat{D}_\mora}{:}{1:i}\end{bmatrix}\\
        &=\begin{bmatrix}
        ...
        + \begin{bmatrix}\mat{0}\\ \rowscols{\mat{D}_\mora}{:}{i+1:i+k}\end{bmatrix}\mat{F}\begin{bmatrix} \mat{0}&\rowscols{\mat{C}_\mora}{j+1:j+k}{:}\end{bmatrix},
        \end{aligned}
        \end{equation*}
        and
        \begin{equation*}
        ...
        +\begin{bmatrix}\mat{0}\\ \rowscols{\mat{D}_\mora}{:}{i+1:i+k}\end{bmatrix}\mat{F}\begin{bmatrix} \mat{0}&\rowscols{\mat{D}_\mora}{:}{1:i}\end{bmatrix}
        \end{aligned}
        \end{equation*}
