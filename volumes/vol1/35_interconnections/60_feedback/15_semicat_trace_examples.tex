...
\devel{
    \begin{example}
        ...
        Take for instance the system $\mora\colon 3\mto 3$ with
        \begin{equation*}
            \mat{A}_\mora =\begin{bmatrix}1&0&0\\1&0&0\\0&0&0\end{bmatrix},\quad
            \mat{B}_\mora =\begin{bmatrix}1&0&0\\0&1&1\\0&0&0\end{bmatrix},\quad
            \mat{C}_\mora =\begin{bmatrix}0&1&0\\1&0&1\\0&0&0\end{bmatrix},\quad
            \mat{D}_\mora =\begin{bmatrix}0&0&1\\0&0&0.5\\0.5&0.5&0.5\end{bmatrix}.
        \end{equation*}
        In this case, we have:
        \begin{equation*}
            \projB((1))=\begin{bmatrix}
                1 & 0 & 0 \\ 1&0&0\\ 0&0&0
            \end{bmatrix}\neq
            \begin{bmatrix}
                1 & 0 & 0 \\
