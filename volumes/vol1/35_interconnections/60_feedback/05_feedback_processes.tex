...
\begin{definition}\label{def:trace-moore}
    ...
    \end{equation}
    %
    Above, $\pi_\prObjw$ is the projection $\prinL \cprod \prObjw \to \prObjw$ and $\pi_\proutL$ is the projection $\proutL \cprod \prObjw \to \proutL$.
\end{definition}
...
\begin{definition}\label{def:trace-lti}
    ...
    \begin{equation}
        \tupp{\prstart,\mat{A} + \rowscols{\mat{B}}{:}{i+1:k}\rowscols{\mat{C}}{j+1:j+k}{:},\rowscols{\mat{B}}{:}{1:i},\rowscols{\mat{C}}{i:j}{:}}
    \end{equation}
