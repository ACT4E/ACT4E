...
The strain~$\strain$ is usually written as the ratio of the difference in length along the direction of the stress~$\Delta L$, and the original length of the material~$L_0$:
    ...
    Whether the material returns to its original shape when stress is removed, depends on the extent of deformation.
    ...
    The ability of a material to be deformed elastically is described by the so-called Young's \emph{modulus}, the name of which is due to the physicist Thomas Young.
...
\todotextjira{11}{\bernina: @Gioele: Rube Goldberg part missing }
\clearpage
