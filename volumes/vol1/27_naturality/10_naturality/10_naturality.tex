...
Suppose we have three categores:~$\CatC, \CatD$ and~$\CatE$ with functors~$\funaA,\funaB\colon\CatC \fto \CatD$ and~$\funbA,\funbB\colon \CatD \fto \CatE$ and finally two natural transformations
$\ntrafoa\colon \funaA \nto \funaB$ and~$\ntrafob\colon \funbA \nto \funbB$.
...
\todotext{J: there is a incomplete diagram commented out here for whiskering.... needs to be finished (and maybe make two: one for left-whiskering, one for right-whiskering)}
