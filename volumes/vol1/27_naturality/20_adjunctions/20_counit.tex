...
Given \SY{functors}
%
\equationsag{091_functors_adjunctions}{eq:globular-left-right-functors}
%
...
\end{equation}
\todotext{J: i think it'd be nicer if the notation for the identity functor was ``Id'' instead of ``id''.}
