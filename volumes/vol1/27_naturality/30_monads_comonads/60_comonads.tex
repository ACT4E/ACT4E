...
\end{equation}
Elements of $\setA^{\positions} \cartprod \positions$ are pairs which consist of a function $\tau \colon \positions \mto \setA$ (a ``lookup table'') and a distinguished element of $\styleelements{p} \setin \positions$ (the ``current position''). On the level of morphisms, given any function $\mora \colon \setA \mto \setB$, we define
\begin{equation}
    \stylefunctors{\aword{Store}}(\mora)(\morb, \styleelements{p}) = (\morb \mthen \mora,\; \styleelements{p}),
\end{equation}
where $\morb \colon \positions \mto \setA$ and $\styleelements{p} \setin \positions$.
...
\begin{equation}\label{eq:store-comonad-extraction}
    \comonex_\setA(\morb, \styleelements{p}) = \morb(\styleelements{p}).
\end{equation}
...
\begin{equation}\label{eq:store-comonad-duplication}
    \comondu_\setA(\morb, \styleelements{p}) = (\styleelements{p}' \mapsto (\morb, \styleelements{p}'),\; \styleelements{p}).
\end{equation}
...
\begin{align*}
(\comondu_\setA \mthen \comondu_{\stylefunctors{\aword{Store}}(\setA)})(\morb, \styleelements{p})
& = \comondu_{\stylefunctors{\aword{Store}}(\setA)}(\styleelements{p}' \mapsto (\morb, \styleelements{p}'),\; \styleelements{p}) \\
& = (\styleelements{p}'' \mapsto (\styleelements{p}' \mapsto (\morb, \styleelements{p}'),\; \styleelements{p}''),\; \styleelements{p}).
\end{align*}
On the other hand:
\begin{align*}
(\comondu_\setA \mthen \stylefunctors{\aword{Store}}(\comondu_\setA))(\morb, \styleelements{p})
& = \stylefunctors{\aword{Store}}(\comondu_\setA)(\styleelements{p}' \mapsto (\morb, \styleelements{p}'),\; \styleelements{p}) \\
& = (\comondu_\setA \after (\styleelements{p}' \mapsto (\morb, \styleelements{p}')),\; \styleelements{p}) \\
& = (\styleelements{p}'' \mapsto \comondu_\setA(\morb, \styleelements{p}''),\; \styleelements{p}) \\
& = (\styleelements{p}'' \mapsto (\styleelements{p}' \mapsto (\morb, \styleelements{p}'),\; \styleelements{p}''),\; \styleelements{p}).
\end{align*}
Both sides are equal, confirming coassociativity.
...
\begin{align*}
(\comondu_\setA \mthen \comonex_{\stylefunctors{\aword{Store}}(\setA)})(\morb, \styleelements{p})
& = \comonex_{\stylefunctors{\aword{Store}}(\setA)}(\styleelements{p}' \mapsto (\morb, \styleelements{p}'),\; \styleelements{p}) \\
& = (\morb, \styleelements{p}).
\end{align*}
For right counitality, we need $\comondu_\setA \mthen \stylefunctors{\aword{Store}}(\comonex_\setA) = \catid$:
\begin{align*}
(\comondu_\setA \mthen \stylefunctors{\aword{Store}}(\comonex_\setA))(\morb, \styleelements{p})
& = \stylefunctors{\aword{Store}}(\comonex_\setA)(\styleelements{p}' \mapsto (\morb, \styleelements{p}'),\; \styleelements{p}) \\
& = (\comonex_\setA \after (\styleelements{p}' \mapsto (\morb, \styleelements{p}')),\; \styleelements{p}) \\
& = (\styleelements{p}' \mapsto \morb(\styleelements{p}'),\; \styleelements{p}) \\
& = (\morb, \styleelements{p}).
\end{align*}
\end{solution}
