...
The functor $\streamfun$ becomes a co-monad when equipped with the following extraction and duplication. The extraction $\comonex_\setA \colon \streamsof{\setA} \mto \setA$ returns the first element (the ``head'') of a stream:
...
This functor becomes a co-monad when equipped with the following extraction and duplication. The extraction $\comonex_\setA \colon \setA^{\monoidAset} \mto \setA$ evaluates the function at the identity element of the monoid:
...
For coassociativity, we need $\comondu_\setA \mthen \comondu_{\setA^{\monoidAset}} = \comondu_\setA \mthen \stylefunctors{\aword{Cowrite}}(\comondu_\setA)$. Let $\morb \colon \monoidAset \mto \setA$. On the one hand:
\begin{align*}
(\comondu_\setA \mthen \comondu_{\setA^{\monoidAset}})(\morb)(\styleelements{m}_1)(\styleelements{m}_2)(\styleelements{m}_3)
& = \comondu_{\setA^{\monoidAset}}(\comondu_\setA(\morb))(\styleelements{m}_1)(\styleelements{m}_2)(\styleelements{m}_3) \\
& = \comondu_\setA(\morb)(\styleelements{m}_1 \mtimesof\monoidA \styleelements{m}_2)(\styleelements{m}_3) \\
& = \morb((\styleelements{m}_1 \mtimesof\monoidA \styleelements{m}_2) \mtimesof\monoidA \styleelements{m}_3).
\end{align*}
On the other hand:
\begin{align*}
(\comondu_\setA \mthen \stylefunctors{\aword{Cowrite}}(\comondu_\setA))(\morb)(\styleelements{m}_1)(\styleelements{m}_2)(\styleelements{m}_3)
& = \comondu_\setA(\comondu_\setA(\morb)(\styleelements{m}_1))(\styleelements{m}_2)(\styleelements{m}_3) \\
& = \comondu_\setA(\morb)(\styleelements{m}_1)(\styleelements{m}_2 \mtimesof\monoidA \styleelements{m}_3) \\
& = \morb(\styleelements{m}_1 \mtimesof\monoidA (\styleelements{m}_2 \mtimesof\monoidA \styleelements{m}_3)).
\end{align*}
These are equal by associativity of the monoid multiplication, confirming coassociativity.

For left counitality, we need $\comondu_\setA \mthen \comonex_{\setA^{\monoidAset}} = \catid$:
\begin{align*}
(\comondu_\setA \mthen \comonex_{\setA^{\monoidAset}})(\morb)(\styleelements{m})
& = \comonex_{\setA^{\monoidAset}}(\comondu_\setA(\morb))(\styleelements{m}) \\
& = \comondu_\setA(\morb)(\idmon_\monoidA)(\styleelements{m}) \\
& = \morb(\idmon_\monoidA \mtimesof\monoidA \styleelements{m}) \\
& = \morb(\styleelements{m}).
\end{align*}
This uses the left identity law of the monoid.

For right counitality, we need $\comondu_\setA \mthen \stylefunctors{\aword{Cowrite}}(\comonex_\setA) = \catid$:
\begin{align*}
(\comondu_\setA \mthen \stylefunctors{\aword{Cowrite}}(\comonex_\setA))(\morb)(\styleelements{m})
& = \comonex_\setA(\comondu_\setA(\morb)(\styleelements{m})) \\
& = \comondu_\setA(\morb)(\styleelements{m})(\idmon_\monoidA) \\
& = \morb(\styleelements{m} \mtimesof\monoidA \idmon_\monoidA) \\
& = \morb(\styleelements{m}).
\end{align*}
This uses the right identity law of the monoid.

Note how the three monoid axioms (associativity, left identity, right identity) correspond exactly to the three co-monad axioms (coassociativity, left counitality, right counitality).
\end{example}
