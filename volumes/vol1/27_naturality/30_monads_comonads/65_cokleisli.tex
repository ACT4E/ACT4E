...
Since the underlying functor and the duplication are the same as for the product/environment co-monad (\cref{exa:product-comonad}), a co-Kleisli morphism $\setA \mto \setB$ is a function $\mora \colon \setA \cartprod \monoidAset \mto \setB$, and the co-Kleisli composition works the same way:
\begin{equation*}
