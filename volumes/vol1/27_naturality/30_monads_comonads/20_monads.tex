...
\begin{equation}
\writerfunctor \colon \Set \fto \Set
\end{equation}
(with respect to the monoid $\monoidA$) is defined as follows. 

First let's consider the level of objects. Given any set $\setA$, we define $\writerfunctor(\setA) = \setA \cartprod \monoidAset$. 
...
This writer functor is a monad when equipped with the following multiplication and unit.
