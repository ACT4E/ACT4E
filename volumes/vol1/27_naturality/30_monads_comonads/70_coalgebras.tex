...
\begin{ctdefinition}[Coalgebra of a comonad]
    ...
    Let~$\tup{\comonW, \comondu, \comonex}$ be a co-monad on a category~\CatC.
...
\begin{ctdefinition}[$\comonW$-co-algebra morphism]
    ...
    Let~$\tup{\comonW, \comondu, \comonex}$ be a co-monad on a category~\CatC, and let~$\tup{\Obja_1, \comoncoact_1}$ and~$\tup{\Obja_2, \comoncoact_2}$ be co-algebras of $\comonW$.
...
\begin{gradedexercise}[\exname{CofreeCoalgebras}]
    ...
    Let $\tup{\comonW, \comondu, \comonex}$ be a co-monad on a category $\CatC$, and let $\Obja$ be an object of $\CatC$.
