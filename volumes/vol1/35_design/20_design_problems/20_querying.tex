...
Another type of query is: ``Given a lower bound on the functionality~\fun and an upper bound on the functionality~\fun, what are the feasible implementations?
