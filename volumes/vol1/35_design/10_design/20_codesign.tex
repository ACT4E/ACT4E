...
% \todotext{JL: to me, this is quite a cool quote/observation! However, it seems it is due to a different Conway, not the mathematician... rather, a certain Melvin Conway}

Conway\footnote{Not the mathematician John Horton Conway, but Melvin Conway, a computer scientist.
}'s Law states that:
...
We look at designs not as something that exists as a single decision in time, but rather as something that continues to exist and evolve, independently on the designer.
