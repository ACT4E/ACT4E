...
\begin{figure*}
    ...
    \todographicsjira{561}{@Gioele:
        Possible to shrink the spacing of the diagrams but keeping the font size the same?
    }
\end{figure*}
...
\todotext{Missing: example of a chain in the two posets. (For the continuous, do a continuous chain.)}

\vspace{5cm}
\todotext{I achieved this gap above with a \str{vspace}.
