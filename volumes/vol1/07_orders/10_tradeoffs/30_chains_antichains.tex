...
\begin{figure*}
    \fitinpage{
        \subfloat[\label{fig:power_chains_a}A chain.]{
            \includesag{40_dpcatfig_power_chains}
        }
        \subfloat[\label{fig:power_chains_b}A chain.]{
            \includesag{40_dpcatfig_power_chains_bis}
        }
        \subfloat[\label{fig:power_antichains_a}An antichain.]{
            \includesag{40_dpcatfig_power_antichains}
        }
        \subfloat[\label{fig:power_antichains_b}An antichain.]{
...
\begin{example}
    ...
    \todotext{\alphubel: @Gioele: it's unclear that these are continuous posets for which you can have the red marker in the middle}
    %
    \begin{marginfigure}
        \centering
