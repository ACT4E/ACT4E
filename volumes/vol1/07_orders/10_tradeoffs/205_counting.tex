...
Let's count the number of distinct \SY{posets} on a finite set, ``up to isomorphism''.
...
\begin{figure}[h]
    ...
    % \hfill
    \subfloat[All \SY{posets} on 2-element sets, up to isomorphism.
    ...
    % \medskip
    \subfloat[All \SY{posets} on 3-element sets, up to isomorphism.
    ...
    \caption{Examples of \SY{posets} on sets with 1, 2, 3, and 4 elements, up to isomorphism.
