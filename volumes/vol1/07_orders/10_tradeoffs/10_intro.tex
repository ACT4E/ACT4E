...
\begin{marginfigure}
    ...
    \todographics{\alphubel: @Gioele: Needs to have an x in the middle.}
\end{marginfigure}
...
\begin{marginfigure}
    ...
    \todographics{@Gioele: can you make this diagram a bit more horizontally compressed? }
\end{marginfigure}
...
\begin{figure*}[h]
    ...
    \todographics{\alphubel: @Gioele: I had to squeeze these figures using \str{fitinpage}. Can you make the actual size of the figures smaller, so that they can fit 4 in a line without using \str{fitinpage}?}
\end{figure*}
...
\begin{equation}
    (\textF{keeps warm}\Ctimes \textF{music fidelity})
