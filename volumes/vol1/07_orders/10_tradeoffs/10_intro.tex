...
Undoubtedly, in the human speed-strength trade-off curve he positions himself close to the highest achievable speeds.
At the same time, Usain Bolt is not among the strongest men in the world.
...
On the other hand, the kind of training Bolt undergoes is not optimizing strength, and therefore his strength results will be less impressive.
...
The FFP2 class filters at least \unit[94]{\%} of airborne particles and allows less than \unit[8]{\%} inward leakage, and the FFP3 class filters at least \unit[99]{\%} of airborne particles and allows less than \unit[2]{\%} inward leakage.

Obviously, based on the protection level, the most performant mask in \cref{fig:masks_covid} is FFP3, and the worst is the fashion mask.
...
Indeed, choosing a fashion mask might say that the wearer cares more about aesthetics than safety, and choosing a FFP3 highlights responsible behaviors, care, and research into mask models.
...
More performant masks are typically more expensive, and the fashion mask will be probably the least performant and most expensive.
