...
\end{definition}
\todotext{Not really clear explanation. Also what is the source?}
\todographics{Add diagram like the one in the wikipedia page about semiorders.}
...
\todotextjira{471}{@Andrea: POST-ALPHUBEL properties/examples of semi-orders, quasitransitive relations}
