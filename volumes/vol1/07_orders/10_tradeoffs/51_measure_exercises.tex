...
\begin{hint}
    ...
    Dilwort's theorem shows that the \emph{width} of a \SY{poset} (size of maximum \emph{antichain}) relates to a partition in \emph{chains}, while Mirksy's theorem shows that the \emph{height} of a \SY{poset} (size of the longest \emph{chain}) relates to a partition in \emph{antichains}.
    ...
    \begin{theorem}[Mirsky's theorem]
        \label{thm:mirsky}
        A finite \SY{poset} of height $h$ can be partitioned into $w$ \SY{antichains}.
    \end{theorem}
