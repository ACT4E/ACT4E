...
\todotextjira{503}{Explain how quantitative is not numeric. Example of $\text{cheap}\leq\text{midrange}\leq\text{expensive}$}

\todotextjira{504}{Bad example for Hasse diagram because there are no implicit arrows.}
\begin{example}
