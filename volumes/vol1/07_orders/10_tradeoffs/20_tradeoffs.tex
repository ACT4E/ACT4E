...
By comparing this with \cref{fig:pre_order_graph}, we notice that the double headed arrow is not allowed anymore (indeed, its existence would imply that source and target of the arrow are actually the same element in the poset).
