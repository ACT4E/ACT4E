...
\begin{figure*}[h]
    ...
    \todographics{I had to use maxsizebox to make everything fit. However we could make it some figure more compact and not resort to it. Fir example, in panel d, the second, fourth, fifth posets cocan be formatted on two "floors".
