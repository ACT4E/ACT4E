...
\showslides{
    \begin{forslides}
        ...
        \begin{equation}
            \label{eq:set_disj}
            \posA\Cplus\posB=\makeset{ \tup{1,\posAel} \mid \posAel\setin \posA }\setunion \makeset{\tup{2,\posBel}\mid \posBel \setin \posB}
        \end{equation}
        \begin{equation}
            \label{eq:latt_1}
            \posAel \wedge \posBel
...
\begin{equation}\label{eq:posdef-matrices}
    \mat{A}=
    \begin{bmatrix}
        1 & 0 \\0& 1
