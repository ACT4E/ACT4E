...
A pre-order is a set together with a relation that is \SY{reflexive} (\cref{def:endo_reflexive_irreflexive}) and transitive (\cref{def:endo_transitive}).
