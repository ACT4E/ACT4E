...
\begin{example}[Cardinality map]
    ...
    \begin{figure}[h!]
        ...
        \todographicsjira{532}{@Gioele: There is no poset background in this picture.}
    \end{figure}
\end{example}
...
\devel{
    ...
    \begin{equation*}
        \prfdouble{\posAel \posleqof\posA \posBel}{\mapa(\posAel) \posleqof\posB \mapa(\posBel)}
        \posAel \posleqof\posA \posBel \quad \Leftrightarrow \quad \mapa(\posAel) \posleqof\posB \mapa(\posBel).
    \end{equation*}
}

\subsection{Other examples}

\todostructure{We haven't introduced monotone maps yet}
