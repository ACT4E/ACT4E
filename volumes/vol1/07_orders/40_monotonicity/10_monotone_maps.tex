...
\begin{example}[Rounding functions]
    ...
    \todotextjira{512}{Function $\rtntte$ not defined.}
...
\begin{example}[Cardinality map]
    In \cref{ex:hasseinclusion} we presented the poset arising from the power set of a set~$\setA=\{\posela,\poselb,\poselc\}$ and ordered via subset inclusion.
    ...
    \begin{figure*}[h!]
        ...
        \todographicsjira{563}{Use \str{posela,b,c} in figure.}
        \todotextjira{564}{@Andrea: Dow we define $\powerset A$ as a poset ordered by inclusion?
            I guess we need two different symbol for the power set and power poset.
        }
    \end{figure*}
\end{example}
