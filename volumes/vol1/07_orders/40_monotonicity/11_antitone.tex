...
It is easy to see that an \SY{antitone map} $\mapa: \posA \mto \posB$ is the same thing as a \SY{monotone map} $\mapa: \posA\op \mto \posB$.

\begin{lemma}\label{lem:antitone-is-monotone}
    An \SY{antitone map}  $\mapa: \posA \mto \posB$ is a \SY{monotone map} $\mapa: \posA\op \mto \posB$
