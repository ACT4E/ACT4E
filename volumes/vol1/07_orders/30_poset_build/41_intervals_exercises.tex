...
The code requires that you produce a \classname{PosetOfIntervals}. This is a special poset for which we can create elements by naming the two boundary points, and from an element, we can extract the two boundar points.
