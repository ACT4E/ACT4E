...
\begin{ctdefinition}[Opposite of a poset]
    ...
    \end{equation}
\end{ctdefinition}
For a given~$\posela \setin \posAset$, we will sometimes write~$\posela^*$ to denote its corresponding copy in~$\posAop$, in order to emphasize that~$\posela$ and~$\posela^*$ belong to distinct \SY{posets}.
