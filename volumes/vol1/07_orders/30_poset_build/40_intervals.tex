...
The notation $[a,b]$ usually defines an interval on the real line.  We an generalize the notion to an interval of a poset.

\todographics{@Gioele: we need pictures for intervals on partial orders and their inclusion}

\todotext{FIXME: inconsistent}
...
\begin{definition}
    [``Twisted'' poset of intervals~$\posint\posA$]
