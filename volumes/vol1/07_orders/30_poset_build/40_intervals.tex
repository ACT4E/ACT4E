...
\todographicsjira{734}{\alphubel: @Gioele: we need pictures for intervals on partial orders and their inclusion}

\begin{marginfigure}
    \centering
    \todographicsjira{734}{\alphubel: @Gioele: make figure for interval of posets}
\end{marginfigure}
...
\begin{marginfigure}
    ...
    \caption{
        Graphic visualization of~$\posint{\posA}$.
    }
    \todographicsjira{734}{\alphubel: @Gioele: make figure for interval of posets}
\end{marginfigure}
