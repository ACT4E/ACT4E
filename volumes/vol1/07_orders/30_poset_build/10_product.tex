...
That is a \SY{poset} with the underlying set being the product of the underlying sets.

\begin{definition}[Product of posets]
    \label{def:productposet}
    Given \SY{posets}~$\posA=\tupp{\posAset, \posAleq}$ and~$\posB=\tupp{\posBset, \posBleq}$, the \maindef{product poset}
