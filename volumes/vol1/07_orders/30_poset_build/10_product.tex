...
\begin{figure*}[h!]
    ...
    \todographics{@Gioele: It looks like a lot of space is wasted.
        I understand this is because of the grid.
        Try fooling tikz by putting \emph{negative spaces} so that the objects are considered smaller.
    }
\end{figure*}
...
\begin{example}
    ...
    \begin{figure*}[h!]
        ...
        \todographics{@Gioele: Use fat times, $= $instead of $\equiv$ - they are definitionally equal.}
    \end{figure*}
\end{example}
\vfill
\clearpage
