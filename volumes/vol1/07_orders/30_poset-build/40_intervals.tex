...
\begin{definition}
    ...
    \end{align}
\end{definition}
\todotextjira{510}{Check that the order is consistent with the categorical construction.}
\begin{exercise}
...
\begin{example}
    ...
    \todotextjira{511}{We have macros for intervals: $\interv{0}{100}$ rather than $[0,100]$}
    \begin{equation*}
    ...
    \begin{figure}[h!]
        ...
        \caption{}
        \todographicsjira{531}{That is not the poset $\posA$ but the poset of intervals.}
