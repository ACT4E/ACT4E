...
\todotextjira{507}{@Gioele: We should highlight the quantitative-but-not-numeric angle.
    Change the example to have ``cheap'', ``midrange'', ``expensive'' and ``fast'', ``slow''.
}
...
\todotextjira{508}{
    @Andrea: These are not good as exercises.
    Put in text.
}
