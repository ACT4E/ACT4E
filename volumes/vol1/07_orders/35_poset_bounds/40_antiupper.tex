...
In the example of battery choices, \todotext{@Gioele: Which example?
} first, consider the upper closure of a single element of the poset, for instance~$\posAel_1=\tupp{\unit[10]{\standardcurrency},\unit[500]{g}}$ (\cref{fig:upperclosure_1}, left).
...
\begin{figure*}[h!]
    ...
    \todographicsjira{526}{@Gioele: In the panel right, highlight the set $\subA$, don't draw points}
    \todographics{@Gioele: alos no need to repeat unit/scale. See next figure for example.}
\end{figure*}
...
\begin{figure*}[h!]
    ...
    \todographicsjira{526}{@Gioele: In the panel right, highlight the set $\subA$, don't draw points}
    \todographics{@Gioele: in these figures the y axis could be a bit shorter.}
