...
\begin{ctdefinition}[Upper bounds in a poset]
    ...
    \end{equation*}
    \todotext{Create a symbol for upper/lowerbounds so that we can name this set.}
\end{ctdefinition}
...
\begin{figure*}[h!]
    ...
    \caption{}
    \todographics{@Gioele: Arrow is to close to label}
    \todographics{@Gioele: make this poset as similar as possible to the previous posets (with red dots only changing). Also make same height.}
\end{figure*}
\begin{example}
