...
\begin{ctdefinition}
    ...
    \begin{enumerate}
        ...
        \item A function
              ...
              \end{equation}
    \end{enumerate}
    These constituents must satisfy conditions which encode compatibility with the composition operations and with \SY{identity morphism}s; these conditions are analogous to the ones in the definition of a \SY{functor} between categories.
\end{ctdefinition}
...
\begin{definition}
    ...
    An \emph{algebra} for~$\operada$ is a \SY{functor} of operads~$\operada \fto \Set$.
\end{definition}
