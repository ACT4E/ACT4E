...
\begin{ctdefinition}
    ...
    Conditions which encode \emph{compatibility with compositions}  and \emph{compatibility with identity morphisms}. We do not spell these out here; however they are analogous to the ones in the definition of a \SY{functor} between categories.
\end{ctdefinition}
