...
\end{equation}
    ...
    \begin{enumerate}
        ...
        \item \emph{Neutrality}:
              \begin{equation}
                  \tup{\catidat{\Obja_1},\ldots, \catidat{\Obja_n}}
                  \mthen \mora = \mora = \mora \mthen \catidat\Objb, \quad \forall \mora\colon \tup{\Obja_1,\ldots,\Obja_n}\mto \Objb.
              \end{equation}
    \end{enumerate}
\end{ctdefinition}
