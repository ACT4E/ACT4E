...
\devel{
    \begin{definition}
        ...
        \begin{enumerate}
            ...
            \item \emph{Identity morphism}: $\catid_\Obja \setin \HomSet{\operada_\CatC}{[\Obja]}{\Obja}=\catid_\Obja \setin \HomSet{\CatC}{\Obja}{\Obja}$;
...
\begin{gradedexercise}[\exname{MonoidsAsAlgebras}]
    ...
    With this notation, we define $\Hom_\operada([n];1)$ to be the 1-element set $\{ * \}$ for each $n \setin \natnumbers$.
