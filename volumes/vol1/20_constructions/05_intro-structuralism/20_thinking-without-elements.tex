...
\todotext{2026-07-16, JL: Discuss re-thinking sets and functions from a structuralist point of view}

Text fragments to perhaps integrate: 


One guiding philosophy for creating and understanding generalizations is to formulate properties of functions in a way that only uses their ``external compositional aspects'' and does not rely on the fact that we are dealing with sets, which have elements, and so we cannot ``look inside them''.
