...
The monoidal product $\styleobj{L_1} \times \styleobj{L_2}$ of bounded lattices is defined straightforwardly: the underlying set of $\styleobj{L_1} \times \styleobj{L_2}$ is $\posA_1 \times \posA_2$, and all other operations are defined ``componentwise''. 
\end{gradedexercise}
