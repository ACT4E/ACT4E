...
\begin{document}
   ...
   We highlight five outstanding features:
    ...
    \begin{enumerate}
        ...
        \item 
        The book is designed to facilitate \textbf{spiral learning}, which means that, as readers progress, they incrementally and periodically encounter previous material framed in a new light which deepens their understanding. As the book becomes increasingly abstract, general, and interwoven, this provides an integrative, gradual path of the learning which allows for a comprehensive and interconnected understanding of the subject matter.
        
        The spiral learning is also supported by an \textbf{inductive exposition} style, which differs from the deductive style often used in mathematical expositions, where a general mathematical structure is defined first and then afterward specific examples is given. Instead, in this book, examples are presented initially as intriguing and valuable in their own right, and as motivation for the general concepts that follow, which are then ultimately connected to the broader, overarching theory.
