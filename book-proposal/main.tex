...
\begin{document}
    ...
    The initial version of the book has been successfully completed and now requires adaptation to a standard format by the publisher.
    We anticipate that the final manuscript will be fully completed within the next six months, if not sooner.
