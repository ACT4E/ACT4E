...
\begin{document}
 ...
 This is one of the early expository monographs on category theory which aims to be accessible and convey not only formal definitions and theorems, but also the spirit and ways of thinking used in category theory. It focuses on basic conceptual insights rather than covering a large amount of technical material.  A modest amount of simple and insightful examples (both of a `pure' and `applied' flavor) motivate and illustrate the theory. However, it is still not a text which is mainly focused on \emph{applied} category theory, let alone one that centers engineering.
        

    \paragraph{Category Theory, 2nd Ed., \emph{S.
            Awodey, Oxford University Press, 2010}}
            
            This was the first major textbook after MacLane's \emph{Categories for the working mathematician} which covers a good deal of standard category theory material, and it aims expressly to be much much more accessible than MacLane's book, both in terms of prerequisites needed and in terms of of pedagogical style. It also is addressed not only to mathematics students, but also to readers with a background in computer science, logic, linguistics, or philosophy. For this reason, the book covers material for example on cartesian closed categories and the lambda calculus. Despite its broader audience, the book remains, however, one written in a mathematical style. Furthermore, the applied areas that it does address to some degree are not in engineering. 

    \paragraph{Category Theory in Context, \emph{E.
            Riehl, Aurora: Dover Modern Math Originals, 2016}}
            
            This is another well-known textbook for category theory, and is written in a modern style which conveys some of the categorical way of thinking alongside the formal mathematics. Although certainly more accessible than MacLane, it is nevertheless aimed at readers with a certain level of mathematical training and maturity and is also comparatively dense, covering a good deal of material relative to its length. It is a wonderful book for mathematicians which emphasizes how to use category theory fruitfully inside of mathematics; however it is not realistically accessible for readers without mathematical training, nor does it emphasize applications outside of mathematics. 

\paragraph{Basic Category Theory, \emph{T.
            Leinster,  Cambridge University Press, 2014}}
            
            This is another excellently-written, introductory book on category theory. Shorter and covering less material than Riehl's \emph{Category theory in context}, this book is also aimed at mathematicians and provides a concise, pedagogical, and elegant exposition of core category theory topics for such an audience. It does not however cover some topics which are quite relevant for applied category theory, nor does it aim to discuss examples and applications outside of mathematics. 
            
\todo{Put in chronological order and adapt text accordingly}
