...
\instructors{
  ...
  \section*{Introduction for admins}

  \subsection*{Repositories}
  There are 3 repositories involved:
  \begin{compactenum}
    \item \texttt{idsc-frazzoli/ACT4E-exercises} - a \textbf{public} repository.
    This contains the Python interfaces, or ``problem statements''.
    \item \texttt{idsc-frazzoli/ACT4E-exercises-template} - a \textbf{public} repository.
    This is the repository that the students need to clone and work inside.
    \item \texttt{idsc-frazzoli/ACT4E-private} - a \textbf{private} repository.
  ...
  \begin{compactenum}
    \item Fork \texttt{idsc-frazzoli/ACT4E-exercises-template}.
    \item Work on the exercises inside this repository
    \item To evaluate the exercises type \mintinline{console}{make exercises}.
