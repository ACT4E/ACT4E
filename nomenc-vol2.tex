...
\multicolumn{4}{c}{\nomencsubsectionname{Generic poset names}}\\ 
 ...
 $a \join b$ & \unused  Join of two elements $a$, $b$ & $\to$\cref{def:lattice} & \pageref{def:lattice}\\ 
 $a \meet b$ & \unused  Meet of two elements $a$, $b$ & $\to$\cref{def:lattice} & \pageref{def:lattice}\\ 
 \multicolumn{4}{c}{\nomencsubsectionname{Constructors}}\\ 
...
\multicolumn{4}{c}{\nomencsubsectionname{Basic}}\\ 
 $\then$ &  Composition (in general) &  & \\ 
 $\mthen$ &  Composition for morphisms &  & \\ 
 $\fthen$ & \unused  Composition for functors &  & \\ 
 ...
 $\funl$ &  left adjunct functor &  & \\ 
 $\funr$ &  right adjunct functor &  & \\ 
 $\adjtau$ & \unused  &  & \\ 
 $\equivunit$ &  Unit &  & \\ 
