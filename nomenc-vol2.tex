...
\multicolumn{4}{c}{\nomencsubsectionname{Generic sets and elements}}\\ 
 ...
 $\powerset \setA$ &  Power set of $\setA$. & $\to$\cref{ex:hasseinclusion} & \pageref{ex:hasseinclusion} & \cref{ex:dpi_example}\\ 
...
\multicolumn{4}{c}{\nomencsubsectionname{Formalization}}\\ 
 ...
 $\wdp$ &  generic design problem for wirings &  & \\ 
 ...
 $\FixFunMinRes$ & \unused  & $\to$\cref{prob:FixFunMinReq} & \pageref{prob:FixFunMinReq}\\ 
 $\FixResMaxFun$ & \unused  & $\to$\cref{prob:FixResMinFun} & \pageref{prob:FixResMinFun}\\ 
