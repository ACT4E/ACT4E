...
\multicolumn{4}{c}{\nomencsubsectionname{Generic poset names}}\\ 
 ...
 $\posB$ & \unused  &  & \\ 
 $\posAel, \posBel, \posCel$ & \unused  Generic elements of posets &  & \\ 
 $\posAel$ & \unused  &  & \\ 
 $\posBel$ & \unused  &  & \\ 
 $\posCel$ & \unused  &  & \\ 
 $\posAleq$ & \unused  &  & \\ 
...
$\USD$ &  &  & \\ 
 ...
 \multicolumn{4}{l}{\nomencsectionname{Used in set example}}\\ 
 \hline
$\SanyoDenki$ & \unused  &  & \\ 
...
$\One$ &  \XXX not sure if category or set &  & \\ 
 ...
 $\deltaN$ &  &  & \\ 
 $\deltaS$ &  &  & \\ 
 $\thefourohfive$ &  change number to 405 &  & \\ 
 $\sbanana$ &  &  & \\ 
 $\sapple$ &  &  & \\ 
 $\scarrot$ &  &  & \\ 
 $\Snacks$ &  &  & \\ 
 $\Drinks$ &  &  & \\ 
 $\Participants$ &  &  & \\ 
 $\swater$ &  need to find better icon &  & \\ 
 $\stea$ &  &  & \\ 
 $\eats$ &  &  & \\ 
 $\drinks$ &  &  & \\ 
 $\meal$ &  &  & \\ 
