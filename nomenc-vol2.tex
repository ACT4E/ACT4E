...
\multicolumn{4}{l}{\nomencsubsectionname{Basic}}\\ 
 ...
 $\leftunitor$ & \unused  Left unitor & $\to$\cref{def:monoidal_cat} & \pageref{def:monoidal_cat}\\ 
 $\rightunitor$ & \unused  Right unitor & $\to$\cref{def:monoidal_cat} & \pageref{def:monoidal_cat}\\ 
 $\associator$ & \unused  Associator & $\to$\cref{def:monoidal_cat} & \pageref{def:monoidal_cat}\\ 
 \multicolumn{4}{l}{\nomencsubsectionname{Operations}}\\ 
 ...
 $\monA$ & \unused  Generic monoid & $\to$\cref{def:monoid} & \pageref{def:monoid}\\ 
 $\mtimes$ & \unused  Monoid operation &  & \\ 
 ...
 $\Vect$ & \unused  Category of vector spaces & $\to$\cref{ex:Vect} & \pageref{ex:Vect}\\ 
