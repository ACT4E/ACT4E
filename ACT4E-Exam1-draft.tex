...
\begin{gradedexercise}[\exname{BatteryDP}]\label{ex:BatteryDP} (10 points)
...
\item (2 points) We fix an element $\adp_0 \in \posA$, which is a design problem that we think of as some standard mass-manufactured battery. Consider the function $\phi : \posA \to \posA, \adp \mapsto \adp_0 \vee \sigma(\adp,\adp)$, and consider the sequence of batteries that could be built using $\phi$ as a recipe: 
$$
...
\begin{gradedexercise}[\exname{SpringMonoid}] (6 points)
