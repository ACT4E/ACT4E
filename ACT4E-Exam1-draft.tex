...
%\includegraphics[width=0.5\linewidth]{pics/ExamPosets.png}
    \begin{tikzcd}[column sep=small, row sep=small]
        &\bullet&&[+50pt]\bullet\\
        &\bullet \arrow[u,dash]&&\bullet \arrow[u,dash]\\
        \bullet \arrow[ur,dash]&&\bullet\arrow[ul,dash] &\\
        &\bullet \arrow[ul,dash] \arrow[ur,dash]&&\bullet \arrow[uu,dash]
    \end{tikzcd}
\end{equation}

The following is a list of diagrams of functions~$\posA \mto \posB$. We will refer to them by~$\mapa_1$,~$\mapa_2$,~$\mapa_3$ and~$\mapa_4$, respectively.

\begin{equation}
%\includegraphics[width=0.5\linewidth]{pics/ExamPosetMap1.png}
    \begin{tikzcd}[column sep=small, row sep=small]
        &\bullet \arrow[-Triangle,rr, bend left=10, morphisms]&&[+50pt]\bullet\\
        &\bullet \arrow[-Triangle,rr, bend left=10, morphisms]\arrow[u,dash]&&\bullet \arrow[u,dash]\\
        \bullet \arrow[-Triangle,urrr, bend left=10, morphisms]\arrow[ur,dash]&&\bullet\arrow[-Triangle,ur, bend right=10, morphisms]\arrow[ul,dash] &\\
        &\bullet \arrow[ul,dash] \arrow[ur,dash]\arrow[-Triangle,rr, bend right=10, morphisms]&&\bullet \arrow[uu,dash]
    \end{tikzcd}
\end{equation}
...
%\includegraphics[width=0.5\linewidth]{pics/ExamPosetMap2.png}
    \begin{tikzcd}[column sep=small, row sep=small]
        &\bullet \arrow[-Triangle,rr, bend left=10, morphisms]&&[+50pt]\bullet\\
        &\bullet \arrow[-Triangle,urr, bend left=10, morphisms]\arrow[u,dash]&&\bullet \arrow[u,dash]\\
        \bullet \arrow[-Triangle,uurrr, bend right=10, morphisms]\arrow[ur,dash]&&\bullet\arrow[-Triangle,ur, bend right=10, morphisms]\arrow[ul,dash] &\\
        &\bullet \arrow[ul,dash] \arrow[ur,dash]\arrow[-Triangle,uurr, bend right=10, morphisms]&&\bullet \arrow[uu,dash]
    \end{tikzcd}
\end{equation}
...
%\includegraphics[width=0.5\linewidth]{pics/ExamPosetMap4.png}
        ...
        &\bullet \arrow[-Triangle,rr, bend left=10, morphisms]&&[+50pt]\bullet\\
        &\bullet \arrow[-Triangle,urr, bend left=10, morphisms]\arrow[u,dash]&&\bullet \arrow[u,dash]\\
        \bullet \arrow[-Triangle,urrr, bend left=10, morphisms]\arrow[ur,dash]&&\bullet\arrow[-Triangle,uur, bend right=10, morphisms]\arrow[ul,dash] &\\
        &\bullet \arrow[ul,dash] \arrow[ur,dash]\arrow[-Triangle,uurr, bend right=10, morphisms]&&\bullet \arrow[uu,dash]
    \end{tikzcd}
\end{equation}
...
\item (2 points) The set of all monotone maps from~$\tup{\posA, \posleq_\posA}$ to~$\tup{\posB, \posleq_\posB}$ can itself be given a poset structure (i.e., a partial order) in a straightforward way. How is this partial order defined?
