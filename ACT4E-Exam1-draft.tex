...
\begin{gradedexercise}[\exname{MonotoneMaps}]\label{ex:MonotoneMaps}
 (4 points) Consider the posets $\tup{\posA, \leq_\posA}$ and $\tup{\posB, \leq_\posB}$, described by the following Hasse diagrams, respectively. 
...
\begin{enumerate}
\item (4 points) Which of the functions $\mapa_1$, $\mapa_2$, $\mapa_3$ and $\mapa_4$ are monotone functions? If any are not, why not? 
