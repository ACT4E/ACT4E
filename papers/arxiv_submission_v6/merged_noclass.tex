...
\let\oldfun\funn    \renewcommand{\funn}{{\colF\oldfun}}
...
\end{equation}
\end{problem}
\captionsideleft{\label{fig:setup-1}}{\includegraphics[scale=0.33]{papers/arxiv_submission_v6/gmcdp_setup_query_f.pdf}}
...
\end{equation}
\end{rem}
\captionsideleft{\label{fig:setup_max_f}}{\includegraphics[scale=0.33]{papers/arxiv_submission_v6/gmcdp_setup_query_r.pdf}}
...
\end{defn}
\captionsideleft{\label{fig:setup_h-1}}{\includegraphics[scale=0.33]{papers/arxiv_submission_v6/gmcdp_setup_h.pdf}}
...
\captionsideleft{\label{fig:dp_graphical}}{\includegraphics[scale=0.33]{papers/arxiv_submission_v6/gmcdp_dp_graphical.pdf}}
...
\captionsideleft{\label{fig:mcdps}}{\includegraphics[scale=0.33]{papers/arxiv_submission_v6/gmcdptro_cdpi.pdf}}
\end{defn}
...
\captionsideleft{\label{fig:motor}}{\includegraphics[scale=0.33]{papers/arxiv_submission_v6/gmcdp_motor.pdf}}
...
\captionsideleft{\label{fig:gmcdp_chassis}}{\includegraphics[scale=0.33]{papers/arxiv_submission_v6/gmcdp_chassis.pdf}}
...
\captionsideleft{\label{fig:gmcdp_chassis_plus_motor_series}}{\includegraphics[scale=0.33]{papers/arxiv_submission_v6/gmcdp_chassis_plus_motor_series.pdf}}
...
\captionsideleft{\label{fig:total_cost}}{\includegraphics[scale=0.33]{papers/arxiv_submission_v6/gmcdp_weightsum.pdf}}
...
\noindent 
\begin{figure}[h]
\centering{}\includegraphics[scale=0.33]{papers/arxiv_submission_v6/gmcdp_chassis_plus_motor.pdf}\caption{\label{fig:gmcdp_chassis_plus_motor}}
\end{figure}
...
\captionsideleft{\label{fig:gmcdp_chassis_plus_motor-1}}{\includegraphics[scale=0.33]{papers/arxiv_submission_v6/gmcdp_chassis_plus_motor2.pdf}}
...
\captionsideleft{\label{fig:mcb}}{\includegraphics[scale=0.33]{papers/arxiv_submission_v6/gmcdp_mcb.pdf}}
...
\captionsideleft{\label{fig:example-ba}}{\includegraphics[scale=0.33]{papers/arxiv_submission_v6/gmcdp_battery.pdf}} 
...
\captionsideleft{\label{fig:current_times_voltage}}{\includegraphics[scale=0.33]{papers/arxiv_submission_v6/gmcdp_voltage_current.pdf}}
...
\captionsideleft{\label{fig:connect}}{\includegraphics[scale=0.29]{papers/arxiv_submission_v6/gmcdp_MCB_PSU_2.pdf}}
...
\end{example}
\captionsideleft{\label{fig:progressive-1-1}}{\includegraphics[scale=0.33]{papers/arxiv_submission_v6/batteries_svorenova.pdf}}
...
evaluated.
\end{example}
\captionsideleft{}{\includegraphics[scale=0.33]{papers/arxiv_submission_v6/batteries_zia.pdf}}
...
\captionsideleft{\label{fig:robot-generic}}{\includegraphics[scale=0.33]{papers/arxiv_submission_v6/batteries_okane.pdf}}
