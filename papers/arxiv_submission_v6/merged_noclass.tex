...
of design~(\cref{intro}). For example, a battery provides power,
...
result in this paper (Theorem~\cref{thm:CDP-monotone}) is that the
...
contains a brief statement of results. \cref{threeoperators} describes
composition operators for design problems. \cref{Decomposition}
...
by the composition operators. \cref{Solution-of-Monotone} describes
solution algorithms for MCDPs. \cref{Numerical-examples} shows
numerical examples. \cref{Discussion-of-related} discusses related
work.
