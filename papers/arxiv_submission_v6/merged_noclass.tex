...
% (DPI) is a tuple $\left\langle \funsp,\ressp,\impsp,\prov,\req\right\rangle $
% where:
...
% \item the map~$\prov\colon\impsp\rightarrow\funsp$, mnemonics for ``execution'',
% maps an implementation to the functionality it provides;
% \item the map~$\req\colon\impsp\rightarrow\ressp$, mnemonics for ``evaluation'',
