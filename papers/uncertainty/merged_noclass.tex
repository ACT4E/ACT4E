...
\subsection{Design Problems\label{sec:Design-Problems}}
...
and~$\ftor_{2}$.
\begin{definition}[Product operator $\oppar$]
...
\begin{definition}[Loop operator $\oploop$]
...
\subsection{Uncertain Design Problems\label{sec:UDP}}
...
\begin{definition}[Partial order $\dpleq$]
...
\begin{definition}[Partial order $\udpleq$]
...
\subsection{Interconnection of Uncertain Design Problems\label{sec:UMCDP}}
...
\subsection{Approximation results\label{sec:Approximation-results}}
...
\begin{definition}[Partial order $\posleq_{V}$ on valuations]
...
\[
\begin{array}{ccc}
\dprob\doteq\udpsem\left\llbracket \left\langle \atoms,\atree,\val\right\rangle \right\rrbracket , &  & \dprob{}_{\alpha}\doteq\udpsem\left\llbracket \left\langle \atoms,\atree,\val_{\alpha}\right\rangle \right\rrbracket .\end{array}
\]
...
\begin{figure}[t]
\begin{centering}
\subfloat[\label{fig:notchain}Qualitative behavior for $S_{n}$]{\centering{}\includegraphics[scale=0.33]{unc_convergence_pyramid}}\subfloat[\label{fig:convergence_pyramid}Qualitative behavior for $V_{n}$]{\begin{centering}
\includegraphics[scale=0.33]{unc_convergence_pyramid2}
\par\end{centering}
}
\par\end{centering}
\begin{centering}
\subfloat[\label{fig:invplus1}Numerical results for $S_{n}$]{\begin{centering}
\adjustbox{max width=4.0cm}{\includegraphics[scale=0.33]{unc_convergence}}
\par\end{centering}
}\subfloat[\label{fig:invplus2}Numerical results for $V_{n}$]{\begin{centering}
