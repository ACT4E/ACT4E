...
To define the idea of ``\textbf{either} \transmuted{food} \textbf{or} \transmuted{drink}'' we can refer to the idea of disjoint union of sets (\cref{def:disjoint-union}). The disjoint union of sets $A$ and $B$ is a set, called $A + B$, that contains a distinct copy of $A$ and $B$ each. If an element is contained in both $A$ and $B$, then there will be two distinct copies of it in the disjoint union $A + B$.
