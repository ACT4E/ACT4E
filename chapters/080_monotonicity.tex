...
\todo[inline]{Use red dashed axes for resources, shade of pink.}}
\end{figure}
...
\todo[inline]{For describing lower sets, use green functionality axes. Do not do upper 
closure here (no clear semantics).}
