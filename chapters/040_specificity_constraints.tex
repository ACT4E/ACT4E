...
\begin{itemize}
    \item Not all products are isomotphic in rover, go down and not up-
    \item With finite sets, in Set permutations are isomorphic.
    \item Dynamical systems (open, d=0). Objects are sets, morphisms given by state update and readout. Can go back and forth. (category of processes in computer science)
\end{itemize}}
