...
\begin{example}The identity design problem~$\id_A\colon \F{A} \profto \R{A}$ is the companion (and the conjoint) of the identity map~$\id_A'\colon A \toinPos A$. This is easy to check, as
\begin{equation}
    \begin{aligned}
