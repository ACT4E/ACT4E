...
\todo{make separate tikz files for \figref{visiting_order_constraints}}
...
\todo{Move this later. Let's not climb too high the abstraction ladder. Also write it out,
too important to make an exercise.}
