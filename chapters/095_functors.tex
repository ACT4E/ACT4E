...
\todo{move poset as category up with poset}
...
\todo{Example of functors}
\todo{Profunctors can be an own chapter. We could talk about product categories when we talk about products, in CH.6}
\begin{lemma}
...
\end{remark} 
\end{shaded*}
\JL{The above remark is not quite correct I would say; we want boolian profunctors to live in the bool-enriched world...}
