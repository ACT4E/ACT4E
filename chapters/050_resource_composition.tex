...
\todo{Include here former example of coproduct which is good for product, now commented below here}
...
\GZ{I think this can be put somewhere else if needed? We need it for profunctors}
