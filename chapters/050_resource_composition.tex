...
From this we would like to conclude that we can obtain \transmuted{motion} from \textbf{either} \transmuted{gasoline} \textbf{or} \transmuted{electric energy} (\cref{fig:e16b}).
...
\GZ{still not convincing as a start}
