...
\subsection{Galois connections}\label{subsec:galois-connections}
...
Consider a boolean profunctor~$d\colon F\tickar R$. We can define the maps that work on single functionality and resources:
%
\begin{equation}
    \begin{aligned}
        \theta\colon F&\to \UR\\
