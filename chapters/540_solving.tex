...
By construction, $\ftor$ is monotone (\cref{def:monotone}), which
means that
\[
...
\begin{figure}
  \begin{centering}
    ...
    to~\cref{eq:drone_eq_first}\textendash~\cref{eq:drone_eq_last}.]{\centering{}\includegraphics[scale=0.38]{batteries_overall}}
