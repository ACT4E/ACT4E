...
\begin{example}
  ...
  V^* := \Hom_{\Vect}(V, \reals),
  \]
  \text{i.e.} the space of all linear maps from $V$ to $\reals$. Also, recall the if $f: V \rightarrow W$ is a linear map, then its dual is a linear map $f^*: W^* \rightarrow V^*$.
