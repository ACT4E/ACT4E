...
\begin{definition}[Functions as relations]\label{def:functions_as_relations}
...
\begin{definition}[Properties of a relation]\label{def:rel_properties}
...
\begin{definition}[Transpose of a relation]\label{def:relation-transpose}
...
\begin{definition}[Endorelation]\label{def:endorelation}
...
\begin{definition}[Properties of endorelations]\label{def:properties-endorelations}
...
\begin{definition}[$n$-ary relation]\label{def:n-ary-relation}
...
\begin{ctdefinition}[Free category on a graph]\label{def:free-category}
