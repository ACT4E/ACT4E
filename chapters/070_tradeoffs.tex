...
\end{figure}
\JL{The Figure \cref{fig:boolean} seems strange to me: either the notation should be of Hasse diagram type (no loops), or of category theory type (edges should be arrows).}
