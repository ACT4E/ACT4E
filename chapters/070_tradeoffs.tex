...
\begin{example}
Consider the posets~$\Obja=\tup{\dagger, \star}$ with~$\dagger \ordleq_\Obja \star$, and~$\Objb=\tup{\ast,\diamond,\star}$, with~$\ast \ordleq_\Objb \diamond$ and~$\diamond \ordleq_\Objb \star$. Their disjoint union can be represented as in \cref{fig:poset-coproduct}.
