...
A \emph{Hasse diagram} is an economical (in terms of arrows) way to visualize a poset. In a Hasse diagram elements are points, and if~$a \ordleq b$ then~$a$ is drawn lower than~$b$ and with an ege connected to it, if no other point is in between. Hasse diagrams are directed graphs.
...
\begin{equation}
        a \simeq b \quad \equiv \quad (a \ordleq b) \wedge (b \ordleq a).
\end{equation}
