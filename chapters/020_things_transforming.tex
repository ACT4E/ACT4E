...
\end{equation*}
with the semantics of ``a motor requires \electricpower to produce \rotationalmotion'', we could define a \emph{different} category, where the conventions are inverted.
