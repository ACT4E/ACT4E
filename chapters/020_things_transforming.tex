...
\todo{make separate tikz file for this \figref{e4bis}}
...
\todo{make separate tikz file for \figref{currencygraph}}
\begin{figure}[h]
\begin{center}
...
\subsection{Things that don't matter}
...
\todo{make separate tikz file for this \figref{inverted}}
...
\begin{figure}[h!]
    ...
    \end{tikzcd}\\[+15pt]
    \begin{tikzcd}
    \bullet\arrow[r,"\motor",blue] & \bullet\\[-15pt]
    \textcolor{custompink}{\electricpower}&\textcolor{custompurple}{\rotationalmotion}
    \end{tikzcd}
