...
\begin{figure}[h]
\begin{center}
    \includegraphics[scale=0.5]{gmcdp_setup}
\end{center}
...
\node[dp={2}{2}] (dc) {\begin{tabular}{c} DC motor \\ \includegraphics[width=2cm]{pics/dc_motor.png}\end{tabular}};
\draw[runconn, runame={\unit[max current]{[A]}}] (dc_res1){};
\draw[runconn, runame={\unit[max voltage]{[V]}}] (dc_res2){};
\draw[funconn, funame={\unit[max torque]{[Nm]}}] (dc_fun1){};
\draw[funconn, funame={\unit[max speed]{[rad/s]}}] (dc_fun2){};
\end{tikzpicture}
\end{center}
...
\begin{center}
\begin{tikzpicture}[DP]
\node[dp={2}{2}] (dc) {\begin{tabular}{c} Gearbox \\ \includegraphics[width=2cm]{pics/gearbox.png}\end{tabular}};
\draw[runconn, runame={\unit[input torque~$\tau_i$]{[Nm]}}] (dc_res1){};
\draw[runconn, runame={\unit[input speed~$\omega_i$]{[rad/s]}}] (dc_res2){};
\draw[funconn, funame={\unit[output speed~$\omega_o$]{[rad/s]}}] (dc_fun2){};
\draw[funconn, funame={\unit[output torque~$\tau_o$]{[Nm]}}] (dc_fun1){};
\end{tikzpicture}
\end{center}
...
\begin{center}
\begin{tikzpicture}[DP]
\node[dp={1}{2}] (dc) {\begin{tabular}{c} Propellers \\ \includegraphics[width=2cm]{pics/propellers.png}\end{tabular}};
\draw[runconn, runame={\unit[input torque]{[Nm]}}] (dc_res1){};
\draw[runconn, runame={\unit[input speed]{[rad/s]}}] (dc_res2){};
\draw[funconn, funame={\unit[thrust]{[N]}}] (dc_fun1){};
\end{tikzpicture}
\end{center}
...
\begin{figure}[h!] 
    \centering
    \includegraphics[scale=0.5]{reits2_crank_rocker}
    \caption{
        \label{fig:crack}}
    \end{figure}
...
\todo{Add picture of progressive stereo (see keynote)}
...
\begin{figure}[h]
    \begin{center}
    \includegraphics[scale=0.5]{reits2_cpu_simple}
    \caption{}
    \end{center}
    \end{figure}
