...
\begin{figure}[h!] 
    \centering
    \includegraphics[scale=0.4]{reits2_crank_rocker}
    \caption{
        \label{fig:crack}}
    \end{figure}
...
\begin{figure}[h]
\hfill{}\subfloat[\label{fig:Simple-DP}]{\centering{}\includegraphics[scale=0.33]{gmcdptro_nonconvex1b.pdf}}\hfill{}\subfloat[\label{fig:nonconvex3}]{\centering{}\includegraphics[scale=0.33]{gmcdptro_nonconvex3.pdf}}\hfill{}
