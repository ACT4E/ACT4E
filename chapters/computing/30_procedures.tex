...
\todo{Difference between functions and procedures. Model resources.}

\todo{We don't introduce type theory, say we are in FinSet.}

\subsection{Modeling execution time}

\todo{A procedure is a pair of function and of a non-negative integer. }
...
\todo{To finish. Define composition and identities the obvious way. Prove associativity. Nice pics.}
...
\end{eqnarray}
\todo{To finish. Define composition and identities the obvious way.}
