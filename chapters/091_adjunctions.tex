...
\begin{ctdefinition}[Adjunction]
  \label{def:cat-adjunction}
  Let \CatC and \CatD be categories. An \emph{\iindex{adjunction}} between \CatC and \CatD is given by the following data, satisfying the following conditions.
