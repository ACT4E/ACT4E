...
\todo{Use different color for links hyperrefs. Light green is to light.}
...
Suppose that we have a model with a functionality space~$\funsp$, a requirements space~$\ressp$,
and an implementation space~$\impsp$. 
