...
In the context of pizza recipes, consider the diagram reported in~\cref{fig:antichain}. The blue points represent an antichain of recipes~$\{\tup{\unit[1]{\USD},\unit[2]{h}},\tup{\unit[2]{\USD},\unit[1]{h}}\}$.
...
The red point represents a recipe which cannot be part of the antichain, since it is dominated by~$\tup{\unit[2]{\USD},\unit[1]{h}}$.
...
\end{definition}
\begin{remark}
    We call~$\lowersets P$ the set of lower sets of~$P$.
\end{remark}
