...
\subsubection{FinSet and Permutations}
\todo{FinSet permutations}

\todo{definition of FinSet}

\subsubection{Invertible functions are isomorphisms}
\todo{In R functions which are invertible}
\todo{Strictly monotone functions are invertible from R to R}

\subsubection{isomorphisms in 2D}
...
\subsection{Isomorphisms is not identity}

\todo{Examples: currency (USD and cents)}
