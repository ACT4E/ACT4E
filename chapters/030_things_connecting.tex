...
\item Let~$\tup{\obja_1, \objc_1}$,~$\tup{x_2,z_2} \in R \then S$. We need to show that if~$x_1 = x_2$, then~$z_1 = z_2$. So suppose~$x_1 = x_2$. Since~$\tup{x_1, z_1}$,~$\tup{x_2,z_2} \in R \then S$, there exist~$y_1, y_2 \in \Objb$ such that, respectively,
\begin{equation*}
