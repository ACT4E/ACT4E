...
\end{proof}
    ...
    \todotext{\JL{This opening bit seems confusing/misleading to me. I can edit/correct later; also I would move it to the section on monoidal products.}\AC{yes, move to the part on monoidal products, when talking about symmetry}}
