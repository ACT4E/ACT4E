...
\begin{center}
\begin{tikzpicture}
    \draw[draw=implementations, fill=implementations, rounded corners] (-1,-1) rectangle ++(2,2);
    \draw[draw=functionality, fill=functionality, rounded corners] (-4,-1) rectangle ++(2,2);
    \draw[draw=requirements, fill=requirements, rounded corners] (2,-1) rectangle ++(2,2);
    \coordinate (1) at (0,0);
