...
\begin{definition}[Design problem with implementation]
    ...
    \end{figure}
    \todographics{Redo figure with consistent style, change resources to requirements,
...
\begin{tikzpicture}
    ...
    \draw[->] (13) -- (16);
    \draw[->] (15) -- (14);
    \node at (0,-3) {\Icol{implementations}};
    \node at (-3,-3) {\Icol{functionality}};
    \node at (3,-3) {\Icol{requirements}};
\end{tikzpicture}
\end{center}
