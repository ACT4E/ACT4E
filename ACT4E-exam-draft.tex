...
\begin{gradedexercise}
About how the categorical product in Rel is disjoint union. 
\end{gradedexercise}
...
Prove that the direct sum of real vector spaces -- together with inclusion maps which are to be written down by you -- is ``the'' categorical coproduct in the category $\CatC$. 
\end{gradedexercise}
