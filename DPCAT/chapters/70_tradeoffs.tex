...
\noindent A \emph{Hasse diagram} is a way to visualize a poset by being economical about the arrows that one uses. In a Hasse diagram elements are points, and if $a \leq b$ then $a$ is drawn lower than $b$ and with an edge connected to it. 
...
\begin{figure}[h!]
    ...
    \caption{The cost of pizza ingredients can be represented through a poset.\label{fig:hassepizza}}
    \end{center}
\end{figure}
...
The theory of design problems can be easily generalized to preorders, i.e. posets without the antisymmetry property. his means that there could be two elements $a$ and $b$ such that $a\leq b$ and $a \geq b$ but $a \neq b$ (\cref{fig:preorder}).
