...
\end{figure}
\AC{Shouldnt we put also the arrows (engine and fuel)->engine and (engine and fuel)->fuel, to show it's a product? or maybe later.}
...
\AC{Come up with another cute example of product.}