...
% This is also called a \emph{homomorphism} between two posets.
\GZ{
\begin{remark}
...
\begin{example}
\GZ{In \cref{ex:hasseinclusion} we presented the poset arising from the power set of a set $A=\{a,b,c\}$ and ordered via subset inclusion. The map $\vert \cdot \vert \colon \powerset{A}\to \mathbb{N}$ (cardinality), is a monotone map:}
\begin{center}
