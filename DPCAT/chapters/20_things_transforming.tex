...
\begin{equation}
        ...
        p&\mapsto q \coloneqq a\cdot p -b,
        \end{aligned}
    \end{equation}
...
\GZ{assume inverse exchangers}
To see this, consider three currencies $\mathsf{A,B,C}$, a currency exchanger $\tup{a,b}$ from $\mathsf{A}$ to $\mathsf{B}$ , a currency exchanger $\tup{c,d}$ from $\mathsf{B}$ to $\mathsf{C}$ , and a currency exchanger $\tup{e,f}$ from $\mathsf{C}$ to $\mathsf{A}$. \JL{more pedagogical} The composition of the currency exchangers reads:
\begin{equation}
