...
Furthermore, consider the $\Cat{flight}$ category with $V_\mathrm{f}=\{\mathsf{SFO}_\mathrm{f}, \mathsf{SJC}, \mathsf{SBP}_\mathrm{f}, \mathsf{LAX}_\mathrm{f}\}$ and arrows as in~\cref{fig:flight}. The nodes represent airports in california and the arrows represent connections, offerend by specific flight companies.
