...
\end{equation}
where $\alpha$ represents the battery's specific cost, expressed in \unitfrac[]{J}{\$}. An example of the specifications of battery technologies is given in~\cite{censi2015}, and is reported in~\cref{tab:battery}.
