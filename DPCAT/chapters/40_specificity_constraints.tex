...
\begin{equation*}
\tilde f:  \longrightarrow \{ \varheartsuit, \mbox{\footnotesize $\skull$} \}, \qquad \tilde g: \longrightarrow \{ \varheartsuit, \mbox{\footnotesize $\skull$} \},
\end{equation*}
...
This may all seem unnecessarily complicated. The main point of this example is the following. There infinitely many two-element sets; commonly used ones might be, for example
\begin{equation*}
...
\subsection{Subobjects, subcategories}
