...
When two objects are isomorphic, in many contexts we will want to think of them as ``the same'' in a certain sense. 
In fact, in category theory, it is typical to think in terms of different granularities of ``sameness''. To illustrate this, let's look at some examples using sets. 
