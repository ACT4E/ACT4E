...
\begin{table}[h]
    ...
    \begin{tabular}{c|c|c|c|c|c}
        ...
        $\mathsf{NEMA2299}$&Company $\mathsf{B}$ & 50 x 50 x 16& 150.0 &5.9&59.95
    \end{tabular}
...
\begin{table}[h]
    ...
    \label{tab:currencycompanies}
\end{table}
\GZ{If you are ok with it, I can take real data to fill the table and make more `èngineer-friendly''}
...
\begin{example}[Context coherence]
