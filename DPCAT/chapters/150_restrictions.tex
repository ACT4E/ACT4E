...
\end{center}
\caption{\todo{Need to make this graphical notation better. Maybe put a $\wedge$  to divide the two compartements for the boxed? and likewise later $\vee$  and $\otimes$) }Diagrammatic representation of the intersection of design problems. \label{fig:intersectiondp}}
\end{figure}
\end{definition}
