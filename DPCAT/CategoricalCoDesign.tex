\documentclass[a4paper,onecolumn, superscriptaddress,10pt,accepted=2020-05-01,issue=1, volume=2, shorttitle=papers,draft]{compositionalityarticle}
 \pdfoutput=1
...
\homepage{http://math.mit.edu/~dspivak/}
...
\homepage{http://gzardini.github.io}
\maketitle
...
\clearpage
% Enrichment
\include{DPCAT/chapters/190_enrichments}
\clearpage
% Computability
