...
\tikzset{
   DP/.style={%everything after equals replaces "DP" in key.
      ...
      mark=at position .5 with
      {
              ...
              node[pos=\posres,\relres=\whereres mm,\dpred,opacity=1,fill=white,inner sep=1pt,outer sep=1pt]{\normalsize{\rcname}} (b);
      },
      mark= at position 1 with
      {
             \ifthenelse{\equal{\feedback}{1}}{\def\angleOut{0}\def\angleIn{0}}{\def\angleOut{180}\def\angleIn{0}}
              ...
              node[pos=\posfun,\relfun=\wherefun mm,\dpgreen,opacity=1,fill=white,inner sep=1pt,outer sep=1pt]{\normalsize{\fcname}} (b){}; %bend right
      ...
      mark= at position 1 with {
              \coordinate (a);
              \draw[\dpred,opacity=1.0,dashed] ($(a)+(0.05,0)$) --++ (0.5,0) node[\relres,pos=\posres]{\normalsize{\runame}};}
      }
      },
      ...
      mark= at position 0 with {
      \coordinate (a);
      \draw[\dpgreen] ($(a)+(-0.05,0)$) -- ($(a)+(-0.5,0)$) node[\relfun,pos=\posfun]{\normalsize{\funame}};}
      }
      },
