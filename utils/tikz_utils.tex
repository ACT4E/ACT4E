...
%      \mbox[0pt]{\texttt{dekodkeoko kok}}
  ...
  \ifthenelse{\boolean{cachepdf}}{%
    ...
    }{{{\bfseries \color{red}could not find \pdffile}} \input{\srcfile}}
  }{%
    \input{\srcfile}%
  }%
}
...
\newcommand{\brickcustom}[7]{%
  \setlength{\brickmultipliedx}{#1\brickwidth}
  \setlength{\brickmultipliedy}{#2\brickwidth}
  \filldraw[fill=#3,draw=black,thick] \startposcustom{#4}{#5}{#6}{#7\brickheight} -- ++(7:\brickmultipliedx) -- ++(0mm,#7\brickheight) -- ++(138:0.5\brickmultipliedy) -- ++(187:\brickmultipliedx) -- ++(0mm,-#7\brickheight) -- cycle;
  \draw[black,thick] \startposcustom{#4}{#5}{#6}{#7\brickheight} -- ++(0mm,#7\brickheight) -- ++(138:0.5\brickmultipliedy);
  \draw[black,thick] \startposplusheightcustom{#4}{#5}{#6}{#7\brickheight} -- ++(7:\brickmultipliedx);
...
%
      \pincustom{\pinposonecustom{#4+0.05*\weight}{#5+0.4+0.15*\weight}{#6}{\i}{\j}{#7\brickheight}}{\pinpostwocustom{#4+0.05*\weight}{#5+0.15*\weight}{#6}{\i}{\j}{#7\brickheight}}{#3}{#7\brickheight}
    }
  }
}
