...
\newcommand{\chaptersecond}[4]{
    ...
    \setchapterimage[12cm]{#2.cropped} % Optionally specify the height
    \chapter{#1}
    % \vfill
    \begin{quote}
        #4%
...
\renewpagestyle{scrheadings}{%
        ...
        {\hspace{-5cm}\footnotesize You are reading a draft compiled on \DTMnow}% left page
...
\renewcommand{\subseteq}{\mathrel{\oldsubseteq}\linebreak[1]}
\let\oldsupseteq\supseteq
\renewcommand{\supseteq}{\mathrel{\oldsupseteq}\linebreak[1]}
\let\oldsubset\subset
\renewcommand{\subset}{\mathrel{\oldsubset}\linebreak[1]}
\let\oldsupset\supset
\renewcommand{\supset}{\mathrel{\oldsupset}\linebreak[1]}

\newcommand{\setintersection}{\mathbin{\cap}}
\newcommand{\setunion}{\mathbin{\cup}}
