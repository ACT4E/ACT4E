...
\usepackage{lipsum}
\usepackage{xspace}
% For XeTeX, amsmath is loaded by unicode-math, amssymb should not be loaded
\ifXeTeX
\else
  \usepackage{amsmath}
\fi
...
% amssymb conflicts with unicode-math in XeTeX
\ifXeTeX
\else
...
%%%% FONTS
% For XeTeX, we use fontspec to load STIX Two fonts directly
% For pdfTeX, we would use \usepackage[notextcomp]{stix2}
\ifXeTeX
%   \setmainfont{STIX Two Text}
%   \setmathfont{STIX Two Math}
    \else
  % XeTeX - use fontspec (already loaded in preamble.tex)
  % pdfTeX
...
\graphicspath{
    {\rootdir/figures/},
    {\rootdir/pics/},{\rootdir/pics/plugs/},
    {\rootdir/slides/},
...
% Disable warning from including SAG (pdfTeX only)
\ifx\pdfsuppresswarningpagegroup\undefined
\else
  \pdfsuppresswarningpagegroup=1
\fi
% Speed up compilation by not compressing (pdfTeX only)
...
% \newcommand{\upitsymbol}{\text{%
%   \shadowoffset{0pt}%
%   \shadowcolor{upcolor}%
%   \shadowtext{\colUp$\uparrow$}%
% }}
% \newcommand{\downitsymbol}{\text{%
%   \shadowoffset{0pt}%
%   \shadowcolor{downcolor}%
%   \shadowtext{\colDown$\downarrow$}%
% }}
