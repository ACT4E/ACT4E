...
\AtBeginDocument{
    ...
    \renewcommand\section[2][]{
        ...
        \def\issueurl{%
            https://github.com/ACT4E/ACT4E/issues/new?labels=\currentchapter;body=Chapter: \currentchaptername\urlnl Section: \currentname\urlnl Version: \today \urlnl\urlnl Check all that apply:\urlnl\issuecheck Something incorrect\urlnl\issuecheck Something not clear\urlnl\issuecheck Something missing\urlnl\urlnl Please describe more in detail below. Feel free to change the title to something more informative.\urlnl;title=\currentchaptername\urlsp/\urlsp\currentname\urlsp/\urlsp\today}
    }
        \savebox{\urlbox}{\href{\issueurl}{Report issues on Github}.}
}
...
\newcommand{\linkgithub}{
    \ifdefempty{\currentchapter}{}{
        % \issueurl
        Something incorrect or unclear or missing? \usebox{\urlbox}% \currentchaptername \currentname
    }
}
