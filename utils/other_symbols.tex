...
\DeclareRobustCommand{\tup}[1]{%
        \@makelists{\left\langle}{\commaspace}{\right\rangle}{#1}%
}
...
\DeclareRobustCommand{\makesetBig}[1]{%
    \@makelists{{\color{formulasetcolor}\mathbf{\Big\{}}}{\commaspace}{{\color{formulasetcolor}\mathbf{\Big\}}}}{#1}%
}
...
\newcommand{\boldplus}{\mathbin{\text{\textbf{+}}}}
\newcommand{\boldtimes}{\mathbin{\text{\textbf{×}}}}
