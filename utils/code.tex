...
\newminted[console]{text}{fontsize=\footnotesize,bgcolor=output-code-bg,autogobble}
\newminted[consoleoutput]{console}{fontsize=\footnotesize,bgcolor=output-code-bg,autogobble}
