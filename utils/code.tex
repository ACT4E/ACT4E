...
\newminted[console]{text}{bgcolor=output-code-bg,autogobble=true,fontsize=\footnotesize,framesep=3mm}
\newminted[consoleoutput]{console}{bgcolor=output-code-bg,autogobble=true,fontsize=\footnotesize,framesep=3mm}
\newminted[syntaxspec]{console}{bgcolor=output-code-bg,autogobble=true,fontsize=\footnotesize}
...
% Only use txtt for pdfTeX; XeTeX uses fontspec-configured fonts
\ifXeTeX
  % Keep the fontspec-configured monospace font for XeTeX
\else
