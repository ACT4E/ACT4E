...
\newminted[console]{text}{bgcolor=output-code-bg,autogobble=false,fontsize=\footnotesize}
\newminted[consoleoutput]{console}{bgcolor=output-code-bg,autogobble=false,fontsize=\footnotesize}
