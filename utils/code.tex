...
\newminted[console]{text}{fontsize=\footnotesize,bgcolor=output-code-bg,autogobble=true}
\newminted[consoleoutput]{console}{fontsize=\footnotesize,bgcolor=output-code-bg,autogobble=true}
