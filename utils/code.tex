...
%  \begin{quote}%
  ...
  write_source_minted(#1.#2, nodec=False,reduce_space=True\ifstrempty{#3}{}{,#3})
  }%
%  \end{quote}
}
...
%  \begin{quote}%
  ...
  from act4e_interfaces import #1;
  write_source_minted(#1, nodec=False,reduce_space=True\ifstrempty{#2}{}{,#2})
  }%
%  \end{quote}
}
...
%  \begin{quote}%
  \py[\currfilebase-\detokenize{#1}]{%
    ...
    visualize_module('#1',nodec=False,reduce_space=True\ifstrempty{#2}{}{,#2})
  }%
%  \end{quote}
}
...
\newcommand{\classnamestyle}[1]{{\bfseries \normalsize \ttfamily \color{classname} #1}}
...
\newcommand{\margindatafile}[2]{%
%  \begin{quote}%
  \py[\currfilebase-#1]{from act4e_tex import visualize_data_file;%
  visualize_data_file('#2', min_size=10, max_size=30);
  }%
%  \end{quote}
}
