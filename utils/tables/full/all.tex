...
\begin{longtable}{lll}
 ...
 \hline
\hline
{\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash stylesets\{...\}}} &  & \\ 
  &  & {\setlength\fboxsep{1pt}%
\fbox{%
\color[rgb]{0.5,0.5,0.5}\begin{minipage}[]{5cm}%
$\stylesets{a}$\par%
{\footnotesize{\texttt{\$\textbackslash stylesets\{a\}\$}}}\end{minipage}%
}% fbox
}% setlength
\\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash styleelements\{...\}}} &  & \\ 
  &  & {\setlength\fboxsep{1pt}%
\fbox{%
\color[rgb]{0.5,0.5,0.5}\begin{minipage}[]{5cm}%
$\styleelements{a}$\par%
{\footnotesize{\texttt{\$\textbackslash styleelements\{a\}\$}}}\end{minipage}%
}% fbox
}% setlength
\\ 
  &  & \\ 
...
{\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash setA}} & $\setA$ & \\ 
 ...
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash stylemaps\{...\}}} &  & \\ 
  &  & {\setlength\fboxsep{1pt}%
\fbox{%
\color[rgb]{0.5,0.5,0.5}\begin{minipage}[]{5cm}%
$\stylemaps{a}$\par%
{\footnotesize{\texttt{\$\textbackslash stylemaps\{a\}\$}}}\end{minipage}%
}% fbox
}% setlength
\\ 
...
\\ 
 ...
 \hline
{\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash mapid}} & $\mapid$ &  Identity function\\ 
...
{\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash posA}} & $\posA$ & \\ 
 ...
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash posCel}} & $\posCel$ & \unused \\ 
...
\\ 
 ...
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash snack\{...\}}} &  & \unused \\ 
  &  & {\setlength\fboxsep{1pt}%
\fbox{%
\color[rgb]{0.5,0.5,0.5}\begin{minipage}[]{5cm}%
$\snack{a}$\par%
...
\\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash Rtext\{...\}}} &  & \\ 
  &  & {\setlength\fboxsep{1pt}%
\fbox{%
\color[rgb]{0.5,0.5,0.5}\begin{minipage}[]{5cm}%
$\Rtext{a}$\par%
{\footnotesize{\texttt{\$\textbackslash Rtext\{a\}\$}}}\end{minipage}%
}% fbox
}% setlength
\\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash Ftext\{...\}}} &  & \\ 
  &  & {\setlength\fboxsep{1pt}%
\fbox{%
\color[rgb]{0.5,0.5,0.5}\begin{minipage}[]{5cm}%
$\Ftext{a}$\par%
{\footnotesize{\texttt{\$\textbackslash Ftext\{a\}\$}}}\end{minipage}%
}% fbox
}% setlength
\\ 
...
{\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash sto}} & $\sto$ &  Set arrow\\ 
 ...
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash To\{...\}}} &  & \unused \\ 
  &  & {\setlength\fboxsep{1pt}%
\fbox{%
\color[rgb]{0.5,0.5,0.5}\begin{minipage}[]{5cm}%
$\To{a}$\par%
{\footnotesize{\texttt{\$\textbackslash To\{a\}\$}}}\end{minipage}%
}% fbox
}% setlength
\\ 
