...
\\ 
 ...
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash sgd}} & $\sgd$ & \unused \\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash CHF}} & $\CHF$ & \\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash chf}} & $\chf$ & \\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash EUR}} & $\EUR$ & \\ 
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash eur}} & $\eur$ & \unused \\ 
...
\\ 
 ...
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash exname\{...\}}} &  & \unused \\ 
  &  & {\setlength\fboxsep{1pt}%
\fbox{%
\color[rgb]{0.5,0.5,0.5}\begin{minipage}[]{5cm}%
$\exname{a}$\par%
{\footnotesize{\texttt{\$\textbackslash exname\{a\}\$}}}\end{minipage}%
}% fbox
}% setlength
\\ 
  &  & \\ 
