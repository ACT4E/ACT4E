...
\newcommand{\todographics}[1]{(Graphics)\todo[color=red!70]{(Graphics) #1}}
\newcommand{\todotext}[1]{\todo[color=red!50]{(Text) #1}}
\newcommand{\todostructure}[1]{\todo[color=red!10]{(Structure) #1}}
