...
\typeout{SYN: Initialization here}%
...
\newcommand{\SYDEFactual}[3]{%
    ...
    \typeout{SYN: Note: SYDEFactual received definition (#1)(#2)(#3)}%
    }%
}

\newcommand{\SYDEF}[3]{%
    \typeout{SYN: Note: SYDEF received (#1)(#2)(#3), writing to aux}%
    \protected@write\@auxout{}{%
        \string\SYDEFactual{#1}{#2}{#3}%
    }%
}
