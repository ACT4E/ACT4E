...
%     \advance\@tempcnta\@ne%
% }
% \def\@insertbreakingcprod{%
%     \ifnum\@tempcnta = 0\else\cprod\linebreak[0]\fi%
%     \advance\@tempcnta\@ne%
% }

% \def\@insertbreakingsemicolon{%
%     \ifnum\@tempcnta = 0\else;\linebreak[0]\fi%
%     \advance\@tempcnta\@ne%
% }
...
\newcommand{\opensetbracket}{{\color{formulasetcolor}\mathbf{\{}}}
\newcommand{\closesetbracket}{{\color{formulasetcolor}\mathbf{\}}}}
%
...
%     \@tempcnta=0%
%     \cleft[formulasetcolor]{\{}%
%     \@for\@ii:=#1\do{%
%         \@insertbreakingcomma%
%         \@ii%
%     }%
%     \cright[formulasetcolor]{\}}%
% }
%
...
% \DeclareRobustCommand{\makeTupcat}[1]{%
%     \@tempcnta=0%
%     \fatstart%
%     \@for\@ii:=#1\do{%
%         \@insertbreakingcomma%
...
\DeclareRobustCommand{\@makelists}[4]{%
    ...
    #1%
    \@for\@ii:=#4\do{%
        \ifnum\@tempcnta = 0\else#2\linebreak[0]\fi%
        \advance\@tempcnta\@ne%
        \@ii%
    }%
    #3%
...
\DeclareRobustCommand{\tupp}[1]{%
    \@makelists{\langle}{,}{\rangle}{#1}%
}

% \DeclareRobustCommand{\makeTupcat}[1]{%
%     \@makelists{\fatstart}{,}{\fatend}{#1}%
% }
...
\DeclareRobustCommand{\makesett}[1]{%
    \@makelists{\cleft[formulasetcolor]{\{}}{,}{\cright[formulasetcolor]{\}}}{#1}%
}
...
% \DeclareRobustCommand{\makesetBig}[1]{%
%     \@tempcnta=0%
%     {\color{formulasetcolor}\mathbf{\Big\{}}%
% % \{%
%     \@for\@ii:=#1\do{%
%         \@insertbreakingcomma%
%         \@ii%
