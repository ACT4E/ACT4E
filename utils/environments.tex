...
\AtBeginDocument{
    \ifthenelse{\boolean{devel}}{
        ...
        \def\XXX{
        \PackageError{ACT4E}{You have included XXX in a non-devel version (devel = \ifthenelse{\boolean{devel}}{TRUE}{FALSE}).}{We interrupt compilation.}
        }
    }
}
\AtBeginDocument{
