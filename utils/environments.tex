...
\DeclareRobustCommand{\SYN}[2]{%
    \pgfkeysifdefined{/mydefs/#1}{%
        \hyperref[\pgfkeysvalueof{/mydefs/#1}]{%
            \ifthenelse{\boolean{devel}}{%
                {\color{blue}#2}%
            }{%
                #2%
...
\newcommand{\SYDEF}[2]{%
    \pgfkeyssetvalue{/mydefs/#1}{#2}%
}

\SYDEF{semigroup}{def:semigroup}
\SYDEF{semigroups}{def:semigroup}
\SYDEF{monoid}{def:monoid}
\SYDEF{submonoid}{def:submonoid}
\SYDEF{monoids}{def:monoid}
\SYDEF{commutative group}{def:commutative-group}
\SYDEF{group}{def:group}
\SYDEF{groups}{def:group}
\SYDEF{injective}{sub:injective-and-surjective}
\SYDEF{surjective}{sub:injective-and-surjective}
\SYDEF{bijective}{sub:injective-and-surjective}
\SYDEF{monoid morphism}{def:monoid-mor}
\SYDEF{morphism of monoids}{def:monoid-mor}
\SYDEF{identity morphism}{def:identity-morphism}
