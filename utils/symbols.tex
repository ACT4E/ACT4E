...
%:example:-
%:nomenc-exclude:
\newcommand{\cCatLinkConcept}[2]{{\SYNinner{#2}{\EM{\cCatStyle{#1}}}}}
%:example:-
%:nomenc-exclude:
...
\newcommand{\Ptimes}{\mathbin{\color{colorposetsymbol}\pmb{\times}}} % Product of posets
\newcommand{\Ctimes}{\mathbin{\pmb{\times}}} % Product in a category
%:def:def:categorical-product

\newcommand{\Pplus}{\mathbin{\color{colorposetsymbol}\pmb{+}}} % Disjoint union of posets
