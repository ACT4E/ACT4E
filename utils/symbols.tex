...
\definecolor{naturaltransformations}{RGB}{0,0.5,0.7}
...
\newcommand{\stylefunctors}[1]{{\color{purple}#1}}
\newcommand{\stylenat}[1]{{\color{orange}#1}}
...
\newcommand{\disjointunion}{+} % Disjoint union
%:nomenc:\SetA\disjointunion\SetB:Disjoint union of two sets.
...
%:section:posets/operations:Operations
...
%:section:well-known-functions: Well-known functions
...
%:section:companion: Companion/conjoints
...
\newcommand{\SetA}{A}
%:nomenc:\SetA,\SetB:Generic names for sets.
\newcommand{\SetB}{B}
%:nomenc-exclude:
\newcommand{\ela}{x}
...
%:def:def:monoid
\newcommand{\monA}{M} % Generic monoid
%:def:def:monoid
\newcommand{\mtimes}{\mathbin{\pmb{\otimes}}} % Monoid operation

\newcommand{\mtimescat}{\mathbin{\stylefunctors{\pmb{\otimes}}}} % functor
%:nomenc:\mtimes_{\CatA}:Monoidal operation for category $\CatA$.
%:def:def:monoidal_cat
