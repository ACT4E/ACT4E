...
%:nomenc:\dcuppersets \posA: Downward-closed uppersets of $\posA$.
%:def:def:dcuppersets
\newcommand{\uclowersets}{\overline{\lowersets}} % closed upper sets
\newcommand{\fuppersets}{\overline{\uppersets}_\mathrm{f}} % finite antichains
\newcommand{\flowersets}{\overline{\lowersets}_\mathrm{f}} % finite antichains
