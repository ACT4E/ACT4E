...
\newcommand{\CatLinkConcept}[2]{{\SYNinner{#2}{\EM{\CatStyle{#1}}}}\xspace}

%:nomenc-exclude:
\newcommand{\cCatLinkConcept}[2]{\EM{{\SYNinner{#2}{\cCatStyle{#1}}}}}
%:nomenc-exclude:
...
%:def:def:UDP
\newcommand{\DPI}{\CatLinkConcept{DPI}{category of design problems with implementations}} % Semi-category $\DPI$
%:def:def:DPI
