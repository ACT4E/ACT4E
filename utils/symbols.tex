...
%:section:vol1/20_orders:\partrefplus{part:order}
...
\newcommand{\inj}{\stylemorph{\operatorname{in}}}
...
\newcommand{\proj}{\stylemorph{\operatorname{pr}}}
\newcommand{\projA}{\stylemorph{\operatorname{pr}}_1}
%:nomenc:\injA,\injB:Injections into $\setA \setdisunion \setB$.
%:def:def:disjoint-union
\newcommand{\projB}{\stylemorph{\operatorname{pr}}_2}
%:nomenc-exclude:
...
\definecolor{setcolor}{RGB}{244, 164, 96} % for background colors in pictures
\definecolor{setcolorbord}{RGB}{210, 107, 16 }
\definecolor{posetcolor}{rgb}{0.71, 0.87, 1.0} % for background colors in pictures
\definecolor{posetcolorbord}{RGB}{73, 170, 255} % for background colors in pictures
...
%:section:dp/codesign-spaces: Co-design spaces
...
\newcommand{\definemapcomma}[5]{%
  \defmapcomma{#1}{#2}{\stolong}{#3}{#4}{#5}%
}

\newcommand{\definemapperiod}[5]{%
  \defmapperiod{#1}{#2}{\stolong}{#3}{#4}{#5}%
}
