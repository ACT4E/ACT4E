...
\newcommand{\setH}{\stylesets{I}}
\newcommand{\setnor}[1]{\stylesets{S}_{#1}}
\newcommand{\setstrnor}[1]{\stylesets{T}_{#1}}
\newcommand{\norm}[1]{\vert #1 \vert}
\newcommand{\normset}[1]{[#1]}
%:nomenc-exclude:
...
%:def:def:poset
\newcommand{\posAset}{\stylesets{\posAlet}}
...
%:section:chapters/lagato: Lagato
