...
%:nomenc-exclude:
\newcommand{\posint}[1]{\text{Int}(#1)}
\newcommand{\posintbis}[1]{\text{Int'}(#1)}
...
\newcommand{\Hom}{\stylesets{\operatorname{Hom}}}
...
\newcommand{\adpa}{\mathbf{f}} % generic design problem as a profunctor
\newcommand{\adpb}{\mathbf{g}} % generic design problem as a profunctor
