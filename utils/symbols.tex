...
\newcommand{\powersetmap}{\SYNinner{powerset}{\stylesets{\aword{Pow}}}}
...
\newcommand{\cartprod}{\SYNinner{cartesian product}{\mathbin{\stylesets{\raisedtexttimes}}}} % cartesian product
...
\newcommand{\setdisunion}{\SYNinner{disjoint union of sets}{\mathbin{\stylesets{\raisedtextplus}}}} % Disjoint union
...
% \newcommand{\catprodob}{\SYNinner{categorical product}{\mathbin{\styleobj{\raisedtexttimes}}}}
% \let\oldcmd\catprodob
% \renewcommand{\catprodob}{\SYNinner{categorical product}{\oldcmd}}
\def\oldcmd{}
\newcommand{\wrapcmd}[2]{%
    \expandafter\let\expandafter\oldcmd\csname #1\endcsname%
    % \expandafter\expandafter\expandafter\let\csname oldcmd\endcsname\csname #1\endcsname%
    % \expandafter\let\expandafter\expandafter\csname old#1\endcsname\csname #1\endcsname%
    \expandafter\renewcommand\csname #1\endcsname{\SYNinner{#2}{1}}%
}

\wrapcmd{catprodob}{categorical product}
\wrapcmd{catprodmor}{categorical product}
