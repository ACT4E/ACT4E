...
\newcommand{\join}{\mathbin{\joinsymbol}} % Join
%:nomenc:\ela \join \elb: Join of two elements $\ela$, $\elb$
%:def:def:lattice
\newcommand{\meetsymbol}{\pmb{\wedge}}
\newcommand{\meet}{\mathbin{\meetsymbol}} % Meet
%:nomenc:\ela \meet \elb: Meet of two elements $\ela$, $\elb$
%:def:def:lattice
\newcommand{\meetof}[1]{\mathbin{{\meetsymbol}_{#1}}} % Meet
\newcommand{\joinof}[1]{\mathbin{{\joinsymbol}_{#1}}} % Meet
...
\newcommand{\Draw}{\CatSymbol{Draw}} % Category of drawings
%:def:def:Draw
