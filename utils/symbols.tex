...
\newcommand{\setOfUppersets}{\mathscr{UpperSets}}
\newcommand{\setOfLowersets}{\mathscr{LowerSets}}
...
%:no-inline:
%:nomenc-exclude:
\newcommand{\publictodomessage}{ \begin{publictodo} We are working on this section, and more content will appear. \end{publictodo}}
