...
\DeclareMathOperator{\upit}{{\colUp \pmb{\uparrow}}} % upper closure
%:nomenc:\upit \subA: Upper closure of $\subA$.
%:def:def:upperclosure

\DeclareMathOperator{\downit}{{\colDown \pmb{\downarrow}}} % lower closure
...
\newcommand{\More}{\CatSymbol{Mor}} % the Mor category
%:def:def:more
