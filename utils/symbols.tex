...
\definecolor{formulasetLcolor}{named}{violet} % for formulas
...
%:def:ex:Injset
\newcommand{\SetL}{\ensuremath{\Set^\star}} % Category of lists of sets
%:def:sec:SetL
\newcommand{\PosL}{\ensuremath{\Pos^\star}} % Category of lists of posets
%:def:sec:PosL
...
\newcommand{\listconcat}{\mathbin{\color{formulasetLcolor}\ast}}
