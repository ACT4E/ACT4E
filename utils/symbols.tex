...
%:example: \rname{f_1}
\newcommand{\kr}[1]{{\color{functionality}{\bfseries\str{#1}}}} % keyword requires
%:example: \kr{kr}
\newcommand{\kf}[1]{{\color{requirements}{\bfseries\str{#1}}}}
%:example: \kf{kf}
\newcommand{\kb}[1]{{\color{kbcolor}{\bfseries\str{#1}}}}
%:example:
\newcommand{\ko}[1]{{\color{orange}{\bfseries\str{#1}}}} % TODO: use real
%:example:
