...
\newcommand{\setOfUppersets}{\stylefunctors{\aword{USets}}\,}
%:nomenc:\setOfUppersets \posA: The set of upper sets of a poset $\posA$.
\newcommand{\setOfLowersets}{\stylefunctors{\aword{LSets}}\,}
...
%:example:-
%:nomenc-exclude:
\newcommand{\cCatLinkConcept}[2]{\SYNinner{#2}{\EM{\cCatStyle{#1}}}\xspace}
%:example:-
%:nomenc-exclude:
...
%:def:def:UDP
\newcommand{\DPI}{\CatLinkConcept{DPI}{semicategory of design problems with implementations}} % Semi-category $\DPI$
%:def:def:DPI
