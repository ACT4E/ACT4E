...
\newcommand{\relstyle}[1]{\mathbf{\color{blue} R}} % style for relation (temporary)
...
%:nomenc-exclude:
\newcommand{\strongmu}{\stylenat{\mu}}
%:def:def:strong-monoidal-functo
\newcommand{\strongeps}{\stylenat{\epsilon}}
%:def:def:strong-monoidal-functo
