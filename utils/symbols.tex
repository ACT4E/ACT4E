...
\newcommand{\downarrowcircle}{%
  \tikz[baseline=-0.60ex]{
    ...
    \draw[fill=white,line width=0.6pt] (0,0.55ex) circle (0.25ex);
  }%
}
...
\newcommand{\downarrowcirclefilled}{%
  \tikz[baseline=-0.60ex]{
    \node[inner sep=0pt, outer sep=0pt] at (0,0) {$\downarrow$};
    \draw[fill=.,line width=0.6pt] (0,0.55ex) circle (0.22ex);
  }%
}
...
\newcommand{\downarrowroundrect}{%
  \mathord{\tikz[baseline=-0.60ex]{
    ...
    \draw[fill=white,draw=downcolor,line width=0.6pt,rounded corners=0.15ex] 
      (-0.35ex,0.35ex) rectangle (0.35ex,0.75ex);
  }}%
}
...
% :nomenc-exclude:
\newcommand{\nthen}{\mathbin{\stylenat{\fthensymbol}}} % Composition for natural transformations
% :nomenc-exclude:
\newcommand{\nthenhor}{\mathbin{\stylenat{*}}}
...
% \newcommand{\llzero}{\mbfit{\llcolor 0}}%
% \newcommand{\llone}{\mbfit{\llcolor 1}}%
