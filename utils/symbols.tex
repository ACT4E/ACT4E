...
\newcommand{\alphanums}{\setstyle{\texttt{A}}}
\newcommand{\asciienc}{\functorstyle{\operatorname{ASCII}}}
...
\newcommand{\fieldnamestyle}[1]{{\smaller[1] \bfseries \ttfamily \color{fieldname} #1}} % Stylefor class names
%:example: \classnamestyle{Class}

%\newcommand{\funcname}[1]{{\funcnamestyle{#1()}}\xspace}
%:example: \funcname{function}
\newcommand{\fieldname}[1]{\fieldnamestyle{\detokenize{#1}}\xspace}
