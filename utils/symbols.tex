...
% \newcommand{\companion}[1]{\hat{#1}} % never used
% \newcommand{\comp}[1]{\widehat{#1}}
\newcommand{\comp}[1]{\stylefunctors{\aword{comp}}[#1]}
\newcommand{\conj}[1]{\stylefunctors{\aword{conj}}[#1]}

% \newcommand{\conjoint}[1]{\check{#1}} % never used
