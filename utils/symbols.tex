...
%:nomenc:\Objael, \Objbel, \Objcel: generic objects elements \XXX
...
\newcommand{\wdp}{\stylefunctors{\mathbf{w}}} % generic design problem for wirings
\newcommand{\cdp}{\stylefunctors{\mathbf{c}}} % generic fixed design problem as a profunctor
...
\newcommand{\Prof}{\mathbb{P}\Cat{rof}} % \XXX not used in the main text, maybe remove
