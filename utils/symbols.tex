...
\newcommand{\polyoba}{\bold{\styleobj{\Gamma}}} % a polycategory
\newcommand{\polyobae}{\styleobj{\Gamma}} % a polycategory
\newcommand{\polyobb}{\bold{\styleobj{\Delta}}} % a polycategory
\newcommand{\polyobbe}{\styleobj{\Delta}} % a polycategory
\newcommand{\polyobc}{\bold{\styleobj{\Lambda}}} % a polycategory
\newcommand{\polyobd}{\bold{\styleobj{\Sigma}}} % a polycategory
...
\newcommand{\mcdpposet}[1]{%
  ...
  \immediate\openout\fileWrite=\mcdplibdir/generic\thefileCounter.mcdp_poset%
  \immediate\write\fileWrite{\unexpanded{#1}}%
  \immediate\closeout\fileWrite%
  \py{from mcdp_report import render_mcdp_to_pdf; render_mcdp_to_pdf(PYSNIP_BASENAME,'\mcdplibdir/generic\thefileCounter.mcdp_poset', 'posets', inline=True)}%
  \xspace%
  }


\newcommand{\mcdpposetnp}[1]{%
  \stepcounter{fileCounter}%
  \immediate\openout\fileWrite=\mcdplibdir/generic\thefileCounter.mcdp_poset%
  \immediate\write\fileWrite{\unexpanded{#1}}%
  \immediate\closeout\fileWrite%
  \py{from mcdp_report import render_mcdp_to_pdf; render_mcdp_to_pdf(PYSNIP_BASENAME,'\mcdplibdir/generic\thefileCounter.mcdp_poset', 'posets', inline=True, noprettify=True)}%
  \xspace%
}



\newcommand{\mcdpvalue}[1]{%
  \stepcounter{fileCounter}%
  \immediate\openout\fileWrite=\mcdplibdir/generic\thefileCounter.mcdp_value%
  \immediate\write\fileWrite{\unexpanded{#1}}%
  \immediate\closeout\fileWrite%
  \py{from mcdp_report import render_mcdp_to_pdf; render_mcdp_to_pdf(PYSNIP_BASENAME,'\mcdplibdir/generic\thefileCounter.mcdp_value', 'values', inline=True)}%
  \xspace%
}


\newcommand{\mcdpvaluenp}[1]{%
  \stepcounter{fileCounter}%
  \immediate\openout\fileWrite=\mcdplibdir/generic\thefileCounter.mcdp_value%
  \immediate\write\fileWrite{\unexpanded{#1}}%
  \immediate\closeout\fileWrite%
  \py{from mcdp_report import render_mcdp_to_pdf; render_mcdp_to_pdf(PYSNIP_BASENAME,'\mcdplibdir/generic\thefileCounter.mcdp_value', 'values', inline=True, noprettify=True)}%
  \xspace%
}

\newcommand{\mcdpinline}[1]{%
    \hspace{-2.5pt}\raisebox{-3pt}{#1}\hspace{-2.5pt}%
}
