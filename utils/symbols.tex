...
%:nomenc-exclude:
\newcommand{\CatLink}[2]{\EM{{\index{#1@\textbf{#1}}\hyperref[#2]{\mathbf{#1}}}}}
%:nomenc-exclude:
...
%:def:def:monad
\newcommand{\monadfunction}[1]{\EM{\stylemorph{\aword{#1}}}}
...
\newcommand{\Free}{\CatLink{Free}{def:free-category}} % free construction
...
\newcommand{\Moncat}{\CatNoIndex{MonCat}}
...
\newcommand{\maincatdef}[1]{\index{#1@\textbf{#1}|textbf}}
