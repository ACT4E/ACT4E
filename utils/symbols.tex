...
\newcommand{\rope}[6]{
\begin{tikzpicture}
[n/.style={circle,draw,minimum size=2mm,inner sep=0, fill=#1}]
\draw[ultra thick, #1] #2 -- node[pos=#4, #1,n]{} node[pos=#5, #1,n] {} node[pos=0.5, above]{#6} #3{};
\end{tikzpicture}}
%node[pos=#4, #1] {$\bullet$} node[pos=#5, #1] {$\bullet$} node[pos=0.5, above]{#6}
...
\newcommand{\wnumbers}{\ensuremath{\mathbb{Z}}} % Natural numbers: $0, 1, 2, \dots$
...
\newcommand{\sgrpA}{S} % Generic semigroup
\newcommand{\sgrpB}{T} % Generic semigroup
\newcommand{\sgrpelAa}{s_1} % Generic semigroup element
\newcommand{\sgrpelAb}{s_2} % Generic semigroup element
\newcommand{\sgrpmorA}{f} % Generic semigroup morphism
\newcommand{\sgrpmorB}{g} % Generic semigroup morphism 
...
%:def:def:monoid
\newcommand{\monoidB}{N} % Generic monoid
%:def:def:monoid
\newcommand{\monelA}{m} % Generic monoid element
%:def:def:monoid
\newcommand{\monelAa}{m_1} % Generic monoid element
%:def:def:monoid
\newcommand{\monelAb}{m_2} % Generic monoid element
%:def:def:monoid
\newcommand{\monelB}{n} % Generic monoid element
%:def:def:monoid
\newcommand{\monelBa}{n_1} % Generic monoid element
%:def:def:monoid
\newcommand{\monelBb}{n_2} % Generic monoid element
%:def:def:monoid
...
\newcommand{\constit}{\underline{Consituents}}
