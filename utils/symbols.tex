...
\newcommand{\spiritN}{{\color{spirit}\mplane}\ \transmuter{Alitalia}\ \transmuter{N }}
%:nomenc-exclude:
\newcommand{\spiritS}{{\color{spirit}\mplane}\ \transmuter{Alitalia}\ \transmuter{S }}
%:nomenc-exclude:
\newcommand{\unitedN}{{\color{united}\mplane}\ \transmuter{Swiss}\ \transmuter{N }}
%:nomenc-exclude:
\newcommand{\unitedS}{{\color{united}\mplane}\ \transmuter{Swiss}\ \transmuter{S }}
%:nomenc-exclude:
\newcommand{\deltaN}{{\color{delta}\mplane}\ \transmuter{Ewings}\ \transmuter{N }}
%:nomenc-exclude:
\newcommand{\deltaS}{{\color{delta}\mplane}\ \transmuter{Ewings}\ \transmuter{S }}
%:nomenc-exclude:
