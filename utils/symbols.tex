...
\newcommand{\makesymbolset}[1]{\ensuremath{\stylesets{#1}}\xspace}
\newcommand{\makesymbolLset}[1]{\ensuremath{\styleLsets{#1}}\xspace}
...
\newcommand{\posReals}{\ensuremath{\reals_{>0}}\xspace} % Positive real numbers
\newcommand{\nonNegReals}{\ensuremath{\reals_{\geq0}}\xspace} % Non-negative real numbers
...
\newcommand{\makesymbolrel}[1]{\ensuremath{\relstyle{#1}}}
...
\newcommand{\makesymbolpos}[1]{\ensuremath{\stylepos{#1}}\xspace}
...
\newcommand{\funceil}{\ensuremath{\stylemorph{{\aword{ceil}}}}\xspace} % ceiling function
%:def:ex:rounding-functions
\newcommand{\funfloor}{\ensuremath{\stylemorph{\aword{floor}}}\xspace} % floor function
%:def:ex:rounding-functions
...
\newcommand{\morsedot}{\ensuremath{\bullet}\xspace} % Morse dot
\newcommand{\morsedash}{\ensuremath{\pmb{-}}\xspace} % Morse dash
\newcommand{\morsedsp}{\ensuremath{\,s_1\,}\xspace} % Silence between dots and dashes
\newcommand{\morselsp}{\ensuremath{\,s_3\,}\xspace} % Silence between letters
\newcommand{\morsewsp}{\ensuremath{\,s_7\,}\xspace} % Silence between words

\newcommand{\Morsedot}{\ensuremath{{\color{black}\rule{\mb}{\ml}}}\xspace} % Beep of $\ell$
\newcommand{\Morsedash}{\ensuremath{{\color{black}\rule{3\mb}{\ml}}}\xspace}% Beep of $3\ell$
\newcommand{\Morsedsp}{\ensuremath{{\color{gray}\rule{\mb}{\ml}}}\xspace}% Silence of $\ell$
\newcommand{\Morselsp}{\ensuremath{{\color{gray}\rule{3\mb}{\ml}}}\xspace}% Silence of $3\ell$
\newcommand{\Morsewsp}{\ensuremath{{\color{gray}\rule{7\mb}{\ml}}}\xspace}% Silence of $7\ell$
...
\newcommand{\mgOn}{\ensuremath{\mathrm{O}(n, \reals)}\xspace} % Orthogonal group
%:def:def:general-orthogonal-group
\newcommand{\mgSOn}{\ensuremath{\mathrm{SO}(n, \reals)}\xspace} % Special orthogonal group
%:def:def:special-orthogonal-group
\newcommand{\mgGLn}{\ensuremath{\mathrm{GL}(n, \reals)}\xspace} % General linear group
%:def:def:general-linear-group
\newcommand{\mgSLn}{\ensuremath{\mathrm{SL}(n, \reals)}\xspace} % Special linear group
%:def:def:special-linear-group
\newcommand{\mgEn}{\ensuremath{\mathrm{E}(n, \reals)}\xspace} % Euclidean group
%:def:def:general-euclidean-group
\newcommand{\mgSEn}{\ensuremath{\mathrm{SE}(n, \reals^n)}\xspace} % Special euclidean group
%:def:def:special-euclidean-group

\newcommand{\mgSOtwo}{\ensuremath{\mathrm{SO}(2, \reals)}\xspace}
%:nomenc-exclude:
\newcommand{\mgSOthree}{\ensuremath{\mathrm{SO}(3, \reals)}\xspace}
%:nomenc-exclude:
\newcommand{\mgSEtwo}{\ensuremath{\mathrm{SE}(2, \reals)}\xspace}
%:nomenc-exclude:
\newcommand{\mgSEthree}{\ensuremath{\mathrm{SE}(3, \reals)}\xspace}
%:nomenc-exclude:
