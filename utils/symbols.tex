...
\newcommand{\dpitodp}{\stylefunctors{P}}
\newcommand{\dpitodpmor}{\funmorspace{P}}
\newcommand{\dpitodpob}{\funobspace{P}}
...
%:nomenc:\TwistedArrow{\CatA}:Arrow construction on category $\CatA$.
...
\newcommand{\cCat}[1]{%
    \textbf{\fatstart#1\fatend}\xspace%
}
