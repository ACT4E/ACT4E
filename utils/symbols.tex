...
%:nomenc-exclude:
\newcommand{\mapd}{\stylemaps{i}}
%:nomenc-exclude:
\newcommand{\mape}{\stylemaps{k}}
%:nomenc-exclude:
\newcommand{\mapf}{\stylemaps{y}}
%:nomenc-exclude:
...
\newcommand{\cartprod}{\stylesets{\times}} % set product
%:nomenc:\setA\cartprod\setB:Cartesian product of two sets.
%:def:def:cartesian-product

\newcommand{\setdisunion}{\stylesets{+}} % Disjoint union
