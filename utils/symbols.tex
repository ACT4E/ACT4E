...
%:section:vol1: Volume 1

%:section:vol1/05_pluribus:\refplus{part:pluribus}

%:section:vol1/10_arrows:\refplus{part:first}

%:section:vol1/20_orders:\refplus{part:order}

%:section:vol1/22_operations:\refplus{part:combination}

%:section:vol1/25_translation:\refplus{part:thicker-arrows}

%:section:vol1/30_design:\refplus{part:co-design}

%:section:vol1/40_computation:\refplus{part:computation}

%:section:vol1/45_enrich:\refplus{part:enrichment}

%:section:vol1/50_opera:\refplus{part:opera}
...
\newcommand{\powerset}{\stylefunctors{\operatorname{Pow}}\,}
...
%:section:vol1/40_computation/30_monads: Monads - \refplus{chap:monads}
...
\newcommand{\booland}{\mathbin{\pmb{\wedge}}} % Boolean and
\newcommand{\boolor}{\mathbin{\pmb{\vee}}} % Boolean or
...
%:section:vol1/22_operations/40_sameness: \refplus{chap:sameness}
...
%:section:vol1/10_arrows/30_transmutation: \refplus{chap:transmutation}
...
%:section:vol1/10_arrows/50_connection: \refplus{chap:connection}
...
%:section:vol1/10_arrows/70_mapping: \refplus{chap:mapping}
...
%:section:vol1/22_perations/20_combinations: \refplus{chap:combination}
...
%:section:vol1/25_translations/functors: \refplus{chap:functors}
...
%:section:vol1/05_epluribus/misc:
...
%:section:vol1/05_epluribus/50_morphisms/morse:Morse code
...
%:section:vol1/05_epluribus/50_morphisms/morse/internal: internal
%:nomenc-exclude:
...
%:section:vol1/05_epluribus/ASCII:ASCII example
...
%:section:vol1/10_arrows/75_processes:\refplus{chap:processes}
...
%:section:vol1/05_epluribus/80_actions/matrix-groups:Matrix groups
...
%:section:vol1/05_epluribus/80_actions:\refplus{chap:actions}
...
\newcommand{\definemapcomma}[5]{%
  \defmapcomma{#1}{#2}{#3}[\sto]{#4}{#5}%
}

\newcommand{\definemapperiod}[5]{%
  \defmapperiod{#1}{#2}{#3}[\sto]{#4}{#5}%
}
...
\newcommand{\setconcat}{\mathbin{\color{formulasetcolor},}}
...
%:section:vol1/50_opera/operads:\refplus{chap:operads}
...
%:section:vol1/25_translations/specializations/drawings: drawings
