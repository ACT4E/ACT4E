...
%:nomenc-exclude:
\newcommand{\upperposet}[1]{\tup{\uppersets \stylesets{#1}, \supseteq}}
\newcommand{\upperposetpar}[1]{\tup{\uppersets (\stylesets{#1}), \supseteq}}
\newcommand{\upperposetop}[1]{\tup{\uppersets\stylesets{#1}\op, \supseteq}}
\newcommand{\lowerposet}[1]{\tup{\lowersets\stylesets{#1}, \subseteq}}
\newcommand{\lowerposetpar}[1]{\tup{\lowersets(\stylesets{#1}), \subseteq}}
\newcommand{\lowerposetop}[1]{\tup{\lowersets\stylesets{#1}\op, \subseteq}}
%:nomenc-exclude:
...
\newcommand{\transmuter}[1]{\text{\fontseries{sb}\colTransmuter #1}\xspace}
%:nomenc-exclude:
\newcommand{\transmuted}[1]{\text{\fontseries{sb}\colTransmuted #1}\xspace}
%:nomenc-exclude:
...
\newcommand{\booland}{\pmb{\wedge}} % Boolean and
\newcommand{\boolor}{\pmb{\vee}} % Boolean or
...
\newcommand{\toMonCat}{\to_\Moncat}
\newcommand{\toDP}{\mto_{\DP}}
\newcommand{\toDPres}[1]{\overset{#1}{\toDP}}
\newcommand{\toSet}{\mto_{\Set}}
\newcommand{\toRel}{\mto_{\Rel}}
...
\newcommand{\currency}[1]{\text{\fontseries{sb}\colTransmuted #1}\xspace}
...
\newcommand{\slimstart}{{\color{elementscolor}{[}}}
\newcommand{\slimend}{{\color{elementscolor}{]}}}
\newcommand{\elconcat}{\mathrel{\color{elementscolor};}}

\newcommand{\morstart}{{\color{morphisms}{[}}}
\newcommand{\morend}{{\color{morphisms}{]}}}
\newcommand{\morconcat}{\mathrel{\color{morphisms};}}

% could use \llbracket or \rrbracket
\newcommand{\fatstart}{{\color{formulasetcolor}[}}
\newcommand{\fatend}{{\color{formulasetcolor}]}}

\newcommand{\setconcat}{\mathrel{\color{formulasetcolor}\pmb{;}}}
...
\newcommand{\tupmorcat}[2]{%
    \morstart #1 \morconcat #2 \morend
}

\newcommand{\tupmorcatt}[3]{%
    \morstart #1 \morconcat #2 \morconcat #3 \morend
}
