...
\newcommand{\makesymbolpos}[1]{\EM{\stylepos{#1}}}
...
%:nomenc-exclude:
\newcommand{\CatNoIndex}[1]{\EM{\mathbf{#1}}}
%:nomenc-exclude:
...
\newcommand{\DP}{\CatLink{DP}{def:DP}} % Category of design problems
%:def:def:DP
...
\newcommand{\UDP}{\CatLink{UDP}{def:UDP}}
%:def:def:UDP
\newcommand{\DPI}{\CatLink{DPI}{def:DPI}} % Semi-category $\DPI$
%:def:def:DPI

\newcommand{\Bool}{\Cat{Bool}} % Posets/category of Booleans

\newcommand{\CatMon}{\Cat{Mon}} % Category of Monoids

\newcommand{\Category}{\CatLink{Cat}{def:Category}} % Category of small categories
%:def:def:Category
\newcommand{\Vect}{\CatLink{Vect}{ex:Vect}} % Category of vector spaces
%:def:ex:Vect
\newcommand{\FinVect}{\CatLink{FinVect}{sub:trace-linear}} % Category of finite-dimensional vector spaces
%:def:sub:trace-linear
\newcommand{\Rel}{\CatLink{Rel}{def:Rel}} % Category of sets and relations
%:def:def:Rel
\newcommand{\CatLink}[2]{\Cat{\hyperref[#2]{#1}}}

\newcommand{\inrel}[3]{#1\mkern 2mu #2 \mkern 2mu #3} % To be used xRy at the moment
%:def:def:inrel
\newcommand{\FinSet}{\CatLink{FinSet}{ex:FinSet}} % Category of finite sets and functions
%:def:ex:FinSet
\newcommand{\Set}{\CatLink{Set}{def:Set}} % Category of sets and functions
%:def:def:Set
\newcommand{\Injset}{\CatLink{InjSet}{ex:Injset}} % Category of sets and injective functions
%:def:ex:Injset
...
\newcommand{\Pos}{\CatLink{Pos}{def:Pos}} % Category of posets and monotone maps
%:def:def:Pos
\newcommand{\Lat}{\CatLink{Lat}{def:Lat}} % Category of lattices and lattice homomorphisms
%:def:def:Lat
\newcommand{\BoundedLat}{\CatLink{BoundedLat}{def:BoundedLat}} % Category of lattices and lattice homomorphisms
%:def:def:BoundedLat
\newcommand{\Grph}{{\CatLink{Grph}{def:Grph}}} % Category of directed graphs
%:def:def:Grph


\newcommand{\Effects}{\CatLink{Eff}{def:Effects}} % The effects category
%:def:def:Effects
...
\newcommand{\LTI}{\CatLink{LTI}{def:LTICat}}
%:def:def:LTICat
\newcommand{\Beh}{\CatLink{Beh}{def:Beh}}
%:def:def:Beh
\newcommand{\LBeh}{\CatLink{LBeh}{def:linear-io-behavior}}
%:def:def:linear-io-behavior

\newcommand{\RelL}{\cCatLink{Rel}{def:RelL}} % Category of lists of relations
%:def:def:RelL
\newcommand{\SetL}{\cCatLink{Set}{def:SetL}} % Category of lists of sets
%:def:def:SetL
\newcommand{\PosL}{\cCatLink{Pos}{def:PosL}} % Category of lists of posets
%:def:def:PosL
\newcommand{\DPL}{\cCatLink{DP}{def:DPL}} % Category of lists of DPs
%:def:def:DPL
...
\newcommand{\cCatLink}[2]{%
    \EM{{\fatstart\mathbf{\hyperref[#2]{#1}}\fatend}}%
}
