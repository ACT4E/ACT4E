...
\newcommand{\setin}{\mathbin{{\color{formulasetcolor}\in}}} % Belongs to
\newcommand{\notsetin}{\mathbin{{\color{formulasetcolor}\in}}} % Belongs to

%:section:gen/sets/known: Well-known sets.
\newcommand{\Emptyset}{\stylesets{\emptyset}}
...
\newcommand{\injA}{\stylemorph{\aword{in}}_1}
%:nomenc:\injA,\injB:Injections into $\setA \setdisunion \setB$.
%:def:def:disjoint-union
\newcommand{\injB}{\stylemorph{\aword{in}}_2}
%:nomenc-exclude:

\newcommand{\proj}{\stylemorph{\aword{pr}}}
\newcommand{\projA}{\stylemorph{\aword{pr}}_1}
%:nomenc:\injA,\injB:Injections into $\setA \setdisunion \setB$.
%:def:def:disjoint-union
\newcommand{\projB}{\stylemorph{\aword{pr}}_2}
%:nomenc-exclude:
...
\newcommand{\stylepos}[1]{{\textcolor{black}{\mathbf{#1}}}}
%:nomenc-exclude:
\newcommand{\posAlet}{P}
%:nomenc-exclude:
\newcommand{\posAeln}{p}
...
\newcommand{\setOfUppersets}{\aword{UpSets}\,}
%:nomenc:\setOfUppersets \posA: The set of upper sets of a poset $\posA$.
\newcommand{\setOfLowersets}{\aword{LowSets}\,}
...
\newcommand{\mthen}{\mathbin{\stylemorph{\fatsemi}}\linebreak[1]} % Composition for morphisms
%:nomenc:\mora \mthen \morb: Composition of morphisms
\newcommand{\mthenof}[1]{\mathbin{\stylemorph{\fatsemi}_{#1}}\linebreak[1]} % Composition for morphisms
%:nomenc-exclude:
...
%:nomenc:\Arrow{\CatA}:Twisted arrow construction on category $\CatA$.
...
\newcommand{\posleqopof}[1]{\mathrel{{\stylemorph{\preceq}}_{#1}\op}\linebreak[1]}
%:nomenc-exclude:
...
\newcommand{\genericlti}[1]{\tup{\prstart_{#1},\mat{A}_{#1},\mat{B}_{#1},\mat{C}_{#1},\mat{D}_{#1}}}
...
\newcommand{\globe}{\raisebox{-2pt}{\includegraphics[height=8pt]{globe}}}
...
\newcommand{\EfW}{\styleobj{\globe}} % the world object
%:def:def:effects
