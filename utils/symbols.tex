...
%:nomenc-exclude:
\newcommand{\setI}{\stylesets{I}}
%:nomenc-exclude:
\newcommand{\setIel}{\styleelements{i}}
%:nomenc-exclude:
\newcommand{\setJ}{\stylesets{J}}
%:nomenc-exclude:
\newcommand{\setJel}{\styleelements{j}}
%:nomenc-exclude:
\newcommand{\setK}{\stylesets{K}}
%:nomenc-exclude:
...
\newcommand{\setsupseteq}{\mathbin{\color{formulasetcolor}{\supseteq}}} % superset
...
\newcommand{\cnumbers}{\ensuremath{\stylesets{\mathbb{C}}}} % Complex numbers
\newcommand{\reals}{\ensuremath{\stylesets{\mathbb{R}}}\xspace} % Real numbers
\newcommand{\natnumbers}{\ensuremath{\stylesets{\mathbb{N}}}} % Natural numbers: $0, 1, 2, \dots$
\newcommand{\wnumbers}{\ensuremath{\stylesets{\mathbb{Z}}}} % Integers: $0, 1, -1, 2, -2, \dots$
\newcommand{\ratnumbers}{\ensuremath{\stylesets{\mathbb{Q}}}} % Rational numbers
...
\newcommand{\subposA}{\stylepos{\posDlet}}
...
\newcommand{\Cat}[1]{\text{{\index{#1@\textbf{#1}}}\textbf{#1}}\xspace}
%:nomenc-exclude:
\newcommand{\CatNoIndex}[1]{\text{\textbf{#1}}\xspace}
%:nomenc-exclude:
...
\newcommand{\CatA}{\CatNoIndex{A}}
%:nomenc:\CatA,\CatB,\CatC, \CatD, \dots: Symbols for categories
\newcommand{\CatB}{\CatNoIndex{B}}
%:nomenc-exclude:
\newcommand{\CatC}{\CatNoIndex{C}}
%:nomenc-exclude:
\newcommand{\CatD}{\CatNoIndex{D}}
%:nomenc-exclude:
\newcommand{\CatE}{\CatNoIndex{E}}
%:nomenc-exclude:
\newcommand{\CatV}{\CatNoIndex{V}}
%:nomenc:\CatV: Symbol for enrichment categories.
\newcommand{\CatI}{\CatNoIndex{I}}
%:nomenc:\CatI, \CatJ, \CatK: Symbol for a diagram shape category.
\newcommand{\CatJ}{\CatNoIndex{J}}
%:nomenc:\CatJ: Symbol for a diagram shape category.
%:nomenc-exclude:
\newcommand{\CatK}{\CatNoIndex{K}}
...
\newcommand{\funceil}{\ensuremath{\stylemorph{{\aword{ceil}}}}} % ceiling function
%:def:ex:rounding-functions
\newcommand{\funfloor}{\ensuremath{\stylemorph{\aword{floor}}}} % floor function
%:def:ex:rounding-functions
...
\newcommand{\sgrpA}{\CatNoIndex{S}} % Generic semigroup names
...
\newcommand{\sgrpB}{\CatNoIndex{T}} % Generic semigroup
%:nomenc-exclude:
\newcommand{\sgrpC}{\CatNoIndex{U}} % Generic semigroup
%:nomenc-exclude:
...
%:def:def:monoid
\newcommand{\monoidA}{\CatNoIndex{M}} % Generic monoid names
%:nomenc:\monoidA, \monoidB, \dots: Generic monoid names
%:def:def:monoid
\newcommand{\monoidB}{\CatNoIndex{N}} % Generic monoid
%:nomenc-exclude:
...
%:def:def:group
\newcommand{\grpA}{\CatNoIndex{G}} % Generic group names
%:nomenc:\grpA, \grpB: Generic group names
%:def:def:group
\newcommand{\grpB}{\CatNoIndex{H}}
%:nomenc-exclude:
...
\newcommand{\impn}[1]{\ensuremath{{\colI i_{#1}}}\xspace}
...
\newcommand{\funspn}[1]{\ensuremath{{\colF \mathbf{F}_{#1}}}\xspace} % Functionality space
...
\newcommand{\neutrc}{\ensuremath{\mathbf{C}}\xspace}
\newcommand{\neutrd}{\ensuremath{\mathbf{D}}\xspace}

\newcommand{\ressp}{\ensuremath{{\colR\mathbf{R}}}\xspace} % Requirements space
%:def:def:DPI
\newcommand{\resspn}[1]{\ensuremath{{\colR\mathbf{R}_{#1}}}\xspace}
...
\newcommand{\impspn}[1]{\ensuremath{{\colI\mathbf{I}_{#1}}}\xspace}
...
\newcommand{\DPfinite}{{\ensuremath{\Pos_{\fuppersets}}}\xspace}
...
\newcommand{\Prof}{\mathbb{P}\CatNoIndex{rof}} % Category of profunctors
...
\newcommand{\RelL}{\cCat{Rel}} % Category of lists of relations
%:def:sec:RelL
\newcommand{\SetL}{\cCat{Set}} % Category of lists of sets
%:def:sec:SetL
\newcommand{\PosL}{\cCat{Pos}} % Category of lists of posets
%:def:sec:PosL
\newcommand{\DPL}{\cCat{DP}} % Category of lists of DPs
%:def:sec:DPL
...
\newcommand{\TimeMonoidal}{\CatNoIndex{T}}
\newcommand{\SpaceMonoidal}{\CatNoIndex{S}}
...
\newcommand{\mgSEn}{\ensuremath{\mathrm{SE}(n, \reals^n)}} % Special euclidean group
...
\newcommand{\cCat}[1]{%
    \ensuremath{\fatstart\mathbf{#1}\fatend}\xspace%
}
...
\newcommand{\cardmap}{\stylemaps{\aword{card}}}
\newcommand{\cardof}[1]{\cardmap\left(#1\right)}
\newcommand{\absmap}{\stylemaps{\aword{abs}}}
\newcommand{\absvalueof}[1]{\absmap\left(#1\right)}
\newcommand{\normmap}{\stylemaps{\aword{norm}}}
\newcommand{\normof}[1]{\normmap\left(#1\right)}
